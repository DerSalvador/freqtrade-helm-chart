...
class MontrealStrategy(IStrategy):
    ...
    plot_config = {'main_plot': {}, 'subplots': {'RSI': {'rsi': {'color': 'red'}}}}
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        dataframe.loc[(dataframe['rsi'] > 30) & (dataframe['close'] < dataframe['bb2_lowerband']) & (dataframe['volume'] > 0), 'enter_long'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        :return: DataFrame with entry column
        """
        dataframe.loc[(dataframe['close'] > dataframe['bb2_upperband']) & (dataframe['volume'] > 0), 'exit_long'] = 1
        return dataframe