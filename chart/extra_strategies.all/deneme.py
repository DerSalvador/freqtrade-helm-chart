...
class Deneme(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[qtpylib.crossed_above(dataframe['rsi'], self.entry_rsi.value) & (dataframe['sma3'] <= dataframe['bb_middleband']) & (dataframe['sma5'] > dataframe['bb_upperband'].shift(1)) & (dataframe['volume'] > 0), 'enter_long'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Make sure Volume is not 0
        dataframe.loc[qtpylib.crossed_above(dataframe['rsi'], self.exit_rsi.value) & (dataframe['sma5'] > dataframe['bb_upperband']) & (dataframe['rsi'] > 50) & (dataframe['volume'] > 0), 'exit_long'] = 1
        return dataframe