...
class GodStraNew_SMAonly(IStrategy):
    ...
    entry_params = {'entry_crossed_indicator0': 'SMA-110', 'entry_crossed_indicator1': 'SMA-6', 'entry_crossed_indicator2': 'SMA-100', 'entry_indicator0': 'SMA-5', 'entry_indicator1': 'SMA-5', 'entry_indicator2': 'SMA-55', 'entry_operator0': '/<R', 'entry_operator1': '<R', 'entry_operator2': '/<R', 'entry_real_num0': 0.3, 'entry_real_num1': 0.5, 'entry_real_num2': 0.9}
    # Sell hyperspace params:
    exit_params = {'exit_crossed_indicator0': 'SMA-50', 'exit_crossed_indicator1': 'SMA-50', 'exit_crossed_indicator2': 'SMA-110', 'exit_indicator0': 'SMA-15', 'exit_indicator1': 'SMA-110', 'exit_indicator2': 'SMA-5', 'exit_operator0': '=', 'exit_operator1': 'CA', 'exit_operator2': '<', 'exit_real_num0': 0.9, 'exit_real_num1': 0.5, 'exit_real_num2': 0.8}
    # ROI table:
