...
# value loaded from strategy
# value loaded from strategy
entry_params = {'low_offset': 0.96, 'base_nb_candles_entry': 8, 'ewo_high': 3.553, 'ewo_high_2': -5.585, 'ewo_low': -14.378, 'lookback_candles': 32, 'low_offset_2': 0.942, 'profit_threshold': 1.037, 'rsi_entry': 78, 'rsi_fast_entry': 37}
# Sell hyperspace params:
# value loaded from strategy
# value loaded from strategy
# value loaded from strategy
exit_params = {'base_nb_candles_exit': 16, 'high_offset': 1.053, 'high_offset_2': 1.472}
...
class min5v5(IStrategy):
    INTERFACE_VERSION = 3
    # ROI table:
    minimal_roi = {'0': 0.225, '12': 0.032, '72': 0.022, '189': 0}
    # Stoploss:
    stoploss = -0.318
    # SMAOffset
