...
class FrostAuraM11hStrategy(IStrategy):
    ...
    minimal_roi = {'0': 0.31637, '467': 0.10191, '1143': 0.0253, '2368': 0}
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        #(dataframe['rsi'] > 28) &
        dataframe.loc[(dataframe['close'] < dataframe['bb_lowerband2']) & (dataframe['close'] > minimum_coin_price), 'enter_long'] = 1
        return dataframe

    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        dataframe.loc[(dataframe['rsi'] > 97) & (dataframe['close'] > dataframe['bb_upperband1']), 'exit_long'] = 1
        return dataframe