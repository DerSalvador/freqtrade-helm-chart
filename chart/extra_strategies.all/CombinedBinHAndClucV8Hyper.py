...
class CombinedBinHAndClucV8Hyper(IStrategy):
    ...
    entry_params = {'entry_bb20_close_bblowerband': 0.991, 'entry_bb20_volume': 34, 'entry_bb40_bbdelta_close': 0.029, 'entry_bb40_closedelta_close': 0.012, 'entry_bb40_tail_bbdelta': 0.212, 'entry_mfi': 57.29, 'entry_min_inc': 0.05, 'entry_rsi': 34.94, 'entry_rsi_1h': 42.66, 'entry_rsi_diff': 45.82}
    # Sell hyperspace params:
    exit_params = {'exit_rsi_main': 76.4}
    # ROI table:
    minimal_roi = {'0': 0.107, '15': 0.047, '75': 0.013, '106': 0}
    # Stoploss:
    stoploss = -0.274
    # Trailing stop:
    trailing_stop = True
