...
class TrixStrategy(IStrategy):
    ...
    plot_config = {'main_plot': {'trix': {}}, 'subplots': {'STOCH RSI': {'stoch_rsi': {}}, 'TRIX': {'trix_pct': {}, 'trix_signal': {}, 'trix_histo': {}}}}
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        dataframe.loc[(dataframe['trix_histo'] > 0) & (dataframe['stoch_rsi'] < self.entry_stoch_rsi.value) & (dataframe['volume'] > 0), 'enter_long'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        dataframe.loc[(dataframe['trix_histo'] < 0) & (dataframe['stoch_rsi'] > self.exit_stoch_rsi.value) & (dataframe['volume'] > 0), 'exit_long'] = 1
        return dataframe