 ...
 * ```
 */
export declare class ProjectCluster extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProjectClusterState, opts?: pulumi.CustomResourceOptions): ProjectCluster;
    /**
     * Returns true if the given object is an instance of ProjectCluster.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ProjectCluster;
    /**
     * Cluster type.
     */
     ...
     */
    readonly kubernetesNamespace: pulumi.Output<string | undefined>;
    /**
     * The token to authenticate against Kubernetes.
     */
    readonly kubernetesToken: pulumi.Output<string>;
    /**
     ...
     */
    readonly managementProjectId: pulumi.Output<string | undefined>;
    /**
     * The name of cluster.
     */
