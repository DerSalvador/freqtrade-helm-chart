 ...
 * ```
 */
export declare class UserCustomAttribute extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UserCustomAttributeState, opts?: pulumi.CustomResourceOptions): UserCustomAttribute;
    /**
     * Returns true if the given object is an instance of UserCustomAttribute.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is UserCustomAttribute;
    /**
