 ...
 * ```
 */
export declare class ServiceSlack extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServiceSlackState, opts?: pulumi.CustomResourceOptions): ServiceSlack;
    /**
     * Returns true if the given object is an instance of ServiceSlack.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ServiceSlack;
    /**
