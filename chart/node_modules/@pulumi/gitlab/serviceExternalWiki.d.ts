 ...
 * ```
 */
export declare class ServiceExternalWiki extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServiceExternalWikiState, opts?: pulumi.CustomResourceOptions): ServiceExternalWiki;
    /**
     * Returns true if the given object is an instance of ServiceExternalWiki.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ServiceExternalWiki;
    /**
