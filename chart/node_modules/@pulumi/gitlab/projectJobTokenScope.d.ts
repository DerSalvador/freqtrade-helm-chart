...
export declare class ProjectJobTokenScope extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProjectJobTokenScopeState, opts?: pulumi.CustomResourceOptions): ProjectJobTokenScope;
    /**
     * Returns true if the given object is an instance of ProjectJobTokenScope.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ProjectJobTokenScope;
    /**
     ...
     */
    readonly targetProjectId: pulumi.Output<number>;
    /**
