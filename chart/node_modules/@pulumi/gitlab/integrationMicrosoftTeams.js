...
class IntegrationMicrosoftTeams extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new IntegrationMicrosoftTeams(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
IntegrationMicrosoftTeams.__pulumiType = 'gitlab:index/integrationMicrosoftTeams:IntegrationMicrosoftTeams';
