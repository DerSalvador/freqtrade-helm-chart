 ...
 * ```
 */
class ServiceSlack extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ServiceSlack(name, state, Object.assign(Object.assign({}, opts), { id: id }));
    }
    /**
...
/** @internal */
ServiceSlack.__pulumiType = 'gitlab:index/serviceSlack:ServiceSlack';
//# sourceMappingURL=serviceSlack.js.map