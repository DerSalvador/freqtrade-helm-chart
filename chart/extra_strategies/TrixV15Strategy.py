...
class TrixV15Strategy(IStrategy):
    ...
    entry_params = {
      "entry_stoch_rsi_enabled": True,
      "entry_ema_multiplier": 0.85,
      "entry_ema_src": "open",
      "entry_ema_timeperiod": 10,
      "entry_ema_timeperiod_enabled": True,
      "entry_stoch_rsi": 0.901,
      "entry_trix_signal_timeperiod": 19,
      "entry_trix_signal_type": "trigger",
      "entry_trix_src": "low",
      "entry_trix_timeperiod": 8
    }

    exit_params = {
      "exit_stoch_rsi_enabled": True,
      "exit_stoch_rsi": 0.183,
      "exit_trix_signal_timeperiod": 19,
      "exit_trix_signal_type": "trailing",
      "exit_trix_src": "high",
      "exit_trix_timeperiod": 10
    }
    ...
    entry_ema_multiplier = DecimalParameter(0.8, 1.2, decimals=2, default=1.00, space="entry", optimize=True, load=True)
