...
class FrostAuraM315mStrategy(IStrategy):
    ...
    minimal_roi = {'0': 0.18418, '36': 0.10736, '91': 0.02998, '438': 0}
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        #(dataframe['slowd'] > 30) &
        #(dataframe['slowk'] > 30) &
        dataframe.loc[(dataframe['rsi'] > 22) & (dataframe['slowk'] < dataframe['slowd']) & (dataframe['close'] < dataframe['bb_lowerband3']) & (dataframe['close'] > minimum_coin_price), 'enter_long'] = 1
        return dataframe

    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        dataframe.loc[(dataframe['slowk'] < dataframe['slowd']) & (dataframe['rsi'] > 72) & (dataframe['close'] > dataframe['bb_middleband1']), 'exit_long'] = 1
        return dataframe