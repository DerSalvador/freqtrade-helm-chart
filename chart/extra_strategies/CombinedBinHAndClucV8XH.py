...
class CombinedBinHAndClucV8XH(IStrategy):
    ...
    # value loaded from strategy
    # value loaded from strategy
    entry_params = {'entry_bb20_close_bblowerband': 0.917, 'entry_bb20_volume': 32, 'entry_bb40_bbdelta_close': 0.039, 'entry_bb40_closedelta_close': 0.02, 'entry_bb40_tail_bbdelta': 0.239, 'entry_mfi': 37.77, 'entry_min_inc': 0.01, 'entry_rsi': 35.74, 'entry_rsi_1h': 66.97, 'entry_rsi_diff': 49.29, 'entry_dip_threshold_0': 0.015, 'entry_dip_threshold_1': 0.12, 'entry_dip_threshold_2': 0.28, 'entry_dip_threshold_3': 0.36, 'entry_ema_open_mult_1': 0.02, 'entry_volume_1': 2.0}
    ...
    # value loaded from strategy
    # value loaded from strategy
    exit_params = {'exit_rsi_main': 72.19, 'exit_rsi_parachute': 39.84, 'exit_custom_roi_profit_1': 0.01, 'exit_custom_roi_profit_2': 0.04, 'exit_custom_roi_profit_3': 0.08, 'exit_custom_roi_profit_4': 0.14, 'exit_custom_roi_profit_5': 0.04, 'exit_custom_roi_rsi_1': 50, 'exit_custom_roi_rsi_2': 50, 'exit_custom_roi_rsi_3': 56, 'exit_custom_roi_rsi_4': 58, 'exit_custom_stoploss_1': -0.05, 'exit_trail_down_1': 0.03, 'exit_trail_down_2': 0.015, 'exit_trail_profit_max_1': 0.4, 'exit_trail_profit_max_2': 0.1, 'exit_trail_profit_min_1': 0.1, 'exit_trail_profit_min_2': 0.02}
    minimal_roi = {'0': 10}
    ...
    exit_rsi_main = DecimalParameter(72.0, 90.0, default=80, space='exit', decimals=2, optimize=True, load=True)
    #X version additional RSI value
    exit_rsi_parachute = DecimalParameter(30.0, 55.0, default=40, space='exit', decimals=2, optimize=True, load=True)
