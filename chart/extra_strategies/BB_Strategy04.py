...
class BB_Strategy04(IStrategy):
    ...
    minimal_roi = {'0': 0.22597784040439192, '180': 0.06269048445164815, '613': 0.037662786960331776, '2004': 0}
    ...
    # 'ma': {'color': 'blue'}
    plot_config = {'main_plot': {'bb_lowerband2': {'color': 'red'}, 'bb_lowerband1': {'color': 'green'}, 'bb_middleband1': {'color': 'orange'}, 'bb_upperband1': {'color': 'green'}}}
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[(dataframe['close'] < dataframe['bb_lowerband2']) & (dataframe['close'] > dataframe['bb_lowerband2'] * (1 + self.stoploss)), 'enter_long'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # (dataframe['volume'] > self.config['stake_amount'])
        dataframe.loc[dataframe['close'] > dataframe['bb_upperband2'], 'exit_long'] = 1
        return dataframe