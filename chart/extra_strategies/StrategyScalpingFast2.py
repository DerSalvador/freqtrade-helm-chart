...
class StrategyScalpingFast2(IStrategy):
    ...
    exit_params = {
        ...
        "exit-adx-value": 86,
        "exit-cci-value": 157,
        "exit-mfi-enabled": True,
        "exit-fastd-enabled": True,
        "exit-adx-enabled": True,
        "exit-cci-enabled": False,
        "exit-fastk-enabled": False,
    }
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if self.exit_params['exit-fastd-enabled'] == True | self.exit_params['exit-fastk-enabled'] == True:
            conditions.append((qtpylib.crossed_above(dataframe['fastk'], self.exit_params['exit-fastk-value'])) |
                              (qtpylib.crossed_above(dataframe['fastd'], self.exit_params['exit-fastd-value'])))
