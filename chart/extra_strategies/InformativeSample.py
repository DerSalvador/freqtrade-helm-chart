...
class InformativeSample(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[(dataframe['ema20'] > dataframe['ema50']) & (dataframe['close_15m'] > dataframe['sma20_15m']), 'enter_long'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[(dataframe['ema20'] < dataframe['ema50']) & (dataframe['close_15m'] < dataframe['sma20_15m']), 'exit_long'] = 1
        return dataframe