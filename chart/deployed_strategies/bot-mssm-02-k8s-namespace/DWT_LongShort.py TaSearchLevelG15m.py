kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n bot-mssm-02 exec -it pod/freqtrade-bot-mssm-02-77b696b478-gkbpp -c freqtrade -- cat /freqtrade/user_data/strategies/DWT_LongShort.py TaSearchLevelG15m.py
import numpy as np
import scipy.fft
