kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n bot-mssm-02 exec -it pod/freqtrade-bot-mssm-02-6458f9f56b-q6g2s -c freqtrade -- cat /extra_strategies/NNPredictor_Transformer.py
