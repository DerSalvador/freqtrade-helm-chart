kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n bot-mssm-02 exec -it pod/freqtrade-bot-mssm-02-77b696b478-gkbpp -c freqtrade -- cat /extra_strategies/AdxSmasS_v7_Short.py TrendFollowingStrategyGpt.py
...
class AdxSmasS_v7_Short(IStrategy):
    ...
    def leverage(self, pair: str, current_time: datetime, current_rate: float,
        ...
        return 4
cat: TrendFollowingStrategyGpt.py: No such file or directory
