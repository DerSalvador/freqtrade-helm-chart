kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n bot-mssm-08 exec -it pod/freqtrade-bot-mssm-08-765d99b7b4-dl7gb -c freqtrade -- cat /extra_strategies/MacheteV8bHedged.py
...
class MacheteV8bHedged(IStrategy):
    ...
    def trend_hedge(self, pair: str, trade: Trade, current_time , current_rate, current_profit, **kwargs) -> float:
        ...
        if MacheteV8bHedged.existing_position  is None or MacheteV8bHedged.existing_position  == "": 
            if is_bullish:
                dsHedging.hedge_me(self, trade, pair, MacheteV8bHedged.existing_position )
            elif is_bearish:
                dsHedging.hedge_me(self, trade, pair, MacheteV8bHedged.existing_position )
    ...
    def custom_exit(self, pair: str, trade: Trade, current_time: datetime, current_rate: float,
        ...
        MacheteV8bHedged.existing_position = positionFetcher.get_futures_position_information(symbol)            
