...
class Chandem(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        dataframe.loc[qtpylib.crossed_above(dataframe['CMO'].shift(1), 0) & (dataframe['CMO'] >= 0), 'entry'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        :return: DataFrame with entry column
        """
        dataframe.loc[qtpylib.crossed_above(dataframe['close'], dataframe['bb_upperband']), 'exit'] = 1
        return dataframe