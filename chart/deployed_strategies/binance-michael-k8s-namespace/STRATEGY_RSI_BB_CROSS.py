...
class STRATEGY_RSI_BB_CROSS(IStrategy):
    ...
    #     'bb_below_rsi': {}
    # },
    plot_config = {'main_plot': {'tema': {}, 'sar': {'color': 'white'}}, 'subplots': {'BB': {'bb_percent': {'color': 'red'}, '1': {}, '0': {}}, 'RSI_Percent': {'rsi_percent': {'color': 'red'}, '1': {}, '0': {}}, 'bb_minus_rsi_percent': {'bb_minus_rsi_percent': {}, '0': {}}, 'bb_rsi_count': {'bb_above_rsi_count': {}, 'bb_below_rsi_count': {}}}}
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[qtpylib.crossed_above(dataframe['bb_percent'], dataframe['rsi_percent']) & (dataframe['bb_percent'] < 0.5) & (dataframe['rsi_percent'] < 0.5) & dataframe['bb_below_rsi_count'].shift(1), 'entry'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # (dataframe['volume'] > 0)  # Make sure Volume is not 0
        dataframe.loc[qtpylib.crossed_below(dataframe['bb_percent'], dataframe['rsi_percent']) & (dataframe['bb_percent'] > 0.5) & (dataframe['rsi_percent'] > 0.5) & dataframe['bb_above_rsi_count'].shift(1), 'exit'] = 1
        return dataframe