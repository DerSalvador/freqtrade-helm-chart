...
class CTIBS(IStrategy):
    ...
    maxdrawdown_allowed_drawdown = DecimalParameter(0.01, 0.1, default=0.0, space='protection', optimize=True)
    ### DCA ###
    # max_epa = CategoricalParameter([0, 1, 2, 3], default=0, space="entry", optimize=True)
    ...
    ts5 = DecimalParameter(low=0.04, high=0.06, default=0.05, decimals=2, space='exit', optimize=True, load=True)
    tsl_target4 = DecimalParameter(low=0.15, high=0.2, default=0.2, decimals=2, space='exit', optimize=True, load=True)
    ts4 = DecimalParameter(low=0.03, high=0.05, default=0.045, decimals=2, space='exit', optimize=True, load=True)
    tsl_target3 = DecimalParameter(low=0.1, high=0.15, default=0.15, decimals=2, space='exit', optimize=True, load=True)
    ts3 = DecimalParameter(low=0.025, high=0.04, default=0.035, decimals=3, space='exit', optimize=True, load=True)
    tsl_target2 = DecimalParameter(low=0.08, high=0.1, default=0.1, decimals=3, space='exit', optimize=True, load=True)
    ts2 = DecimalParameter(low=0.015, high=0.03, default=0.02, decimals=3, space='exit', optimize=True, load=True)
    tsl_target1 = DecimalParameter(low=0.05, high=0.08, default=0.06, decimals=3, space='exit', optimize=True, load=True)
    ts1 = DecimalParameter(low=0.01, high=0.016, default=0.013, decimals=3, space='exit', optimize=True, load=True)
    tsl_target0 = DecimalParameter(low=0.02, high=0.045, default=0.03, decimals=3, space='exit', optimize=True, load=True)
    ts0 = DecimalParameter(low=0.008, high=0.015, default=0.013, decimals=3, space='exit', optimize=True, load=True)
    ### indicators ###
    #entry
    reference_ma_length = IntParameter(185, 195, default=200, space='entry', optimize=True)
    smoothing_length = IntParameter(15, 30, default=30, space='entry', optimize=True)
    entry_offset1 = DecimalParameter(low=0.97, high=0.99, decimals=2, default=0.98, space='entry', optimize=True, load=True)
    entry_offset2 = DecimalParameter(low=0.92, high=0.97, decimals=2, default=0.96, space='entry', optimize=True, load=True)
    entry_change = DecimalParameter(1.2, 2.0, default=1.5, decimals=1, space='entry', optimize=True)
    exit_change = DecimalParameter(1.2, 2.0, default=1.5, decimals=1, space='exit', optimize=True)
    max_length = CategoricalParameter([24, 48, 72, 96, 144, 192, 240], default=48, space='entry')
    # exiting 
    filterlength = IntParameter(low=30, high=40, default=35, space='exit', optimize=True)
    exit_offset1 = DecimalParameter(low=1.01, high=1.05, decimals=2, default=1.03, space='exit', optimize=True, load=True)
    exit_change = DecimalParameter(1.2, 2.0, default=1.5, decimals=1, space='exit', optimize=True)
    ### entrying values ###
    entry_change = DecimalParameter(1.2, 2.0, default=1.5, decimals=1, space='entry', optimize=True)
    ### exiting values ###
    ...
    ref_bull = DecimalParameter(0.075, 0.125, default=0.01, decimals=3, space='entry', optimize=True)
    ref_up = DecimalParameter(0.01, 0.075, default=0.01, decimals=3, space='entry', optimize=True)
    ref_down = DecimalParameter(-0.075, -0.01, default=-0.01, decimals=3, space='entry', optimize=True)
    ref_bear = DecimalParameter(-0.125, -0.075, default=-0.1, decimals=3, space='entry', optimize=True)
    # Smooth Change Ma - Short Term Direction
    smooth_bull = DecimalParameter(0.075, 0.125, default=0.01, decimals=3, space='entry', optimize=True)
    smooth_up = DecimalParameter(0.01, 0.075, default=0.02, decimals=3, space='entry', optimize=True)
    smooth_down = DecimalParameter(-0.075, -0.01, default=-0.02, decimals=3, space='entry', optimize=True)
    smooth_bear = DecimalParameter(-0.125, -0.075, default=-0.1, decimals=3, space='entry', optimize=True)
    # Distance from Long Term High
    from_bull = DecimalParameter(-5, -1, default=-1, decimals=1, space='entry', optimize=True)
    from_up = DecimalParameter(-5, -2, default=-3.5, decimals=1, space='entry', optimize=True)
    from_ranging = DecimalParameter(-6.5, -2, default=-6.5, decimals=1, space='entry', optimize=True)
    from_down = DecimalParameter(-7.5, -5.0, default=-7.5, decimals=1, space='entry', optimize=True)
    from_bear = DecimalParameter(-12.5, -7.5, default=-10.0, decimals=1, space='entry', optimize=True)
    # Selecting what works
    entry01 = CategoricalParameter([True, False], default=True, space='entry')
    entry02 = CategoricalParameter([True, False], default=True, space='entry')
    entry03 = CategoricalParameter([True, False], default=True, space='entry')
    entry04 = CategoricalParameter([True, False], default=True, space='entry')
    entry05 = CategoricalParameter([True, False], default=True, space='entry')
    entry06 = CategoricalParameter([True, False], default=True, space='entry')
    entry07 = CategoricalParameter([True, False], default=True, space='entry')
    entry08 = CategoricalParameter([True, False], default=True, space='entry')
    entry09 = CategoricalParameter([True, False], default=True, space='entry')
    entry10 = CategoricalParameter([True, False], default=True, space='entry')
    entry11 = CategoricalParameter([True, False], default=True, space='entry')
    entry12 = CategoricalParameter([True, False], default=True, space='entry')
    entry13 = CategoricalParameter([True, False], default=True, space='entry')
    entry14 = CategoricalParameter([True, False], default=True, space='entry')
    entry15 = CategoricalParameter([True, False], default=True, space='entry')
    entry16 = CategoricalParameter([True, False], default=True, space='entry')
    entry17 = CategoricalParameter([True, False], default=True, space='entry')
    entry18 = CategoricalParameter([True, False], default=True, space='entry')
    entry19 = CategoricalParameter([True, False], default=True, space='entry')
    entry20 = CategoricalParameter([True, False], default=True, space='entry')
    entry21 = CategoricalParameter([True, False], default=True, space='entry')
    entry22 = CategoricalParameter([True, False], default=True, space='entry')
    entry23 = CategoricalParameter([True, False], default=True, space='entry')
    entry24 = CategoricalParameter([True, False], default=True, space='entry')
    entry25 = CategoricalParameter([True, False], default=True, space='entry')
    entry26 = CategoricalParameter([True, False], default=True, space='entry')
    entry27 = CategoricalParameter([True, False], default=True, space='entry')
    entry28 = CategoricalParameter([True, False], default=True, space='entry')
    entry29 = CategoricalParameter([True, False], default=True, space='entry')
    entry30 = CategoricalParameter([True, False], default=True, space='entry')
    ...
    def adjust_trade_position(self, trade: Trade, current_time: datetime, current_rate: float, current_profit: float, min_stake: Optional[float], max_stake: float, current_entry_rate: float, current_exit_rate: float, current_entry_profit: float, current_exit_profit: float, **kwargs) -> Optional[float]:
        ...
        # Initial entry is 1x
        # If that falls to -5% profit, we entry 1.25x more, average profit should increase to roughly -2.2%
        # If that falls down to -5% again, we entry 1.5x more
        # If that falls once again down to -5%, we entry 1.75x more
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['entry_offset1'] = dataframe[f'reference_ma_{valma}'] * self.entry_offset1.value
        dataframe['entry_offset2'] = dataframe[f'reference_ma_{valma}'] * self.entry_offset2.value
        dataframe['exit_offset1'] = dataframe[f'reference_ma_{valma}'] * self.exit_offset1.value
        ...
        dataframe['entry_offset3'] = dataframe[f'smooth_change_{valsma}'] - self.entry_change.value
        dataframe['exit_offset2'] = dataframe[f'smooth_change_{valsma}'] + self.exit_change.value
    ...
    def populate_entry_trend(self, df: DataFrame, metadata: dict) -> DataFrame:
        ...
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_bull.value) & (df['ref_slope_sma'] > self.ref_bull.value) & (df['from_max'] > self.from_bull.value) & (self.entry01.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '1 Smooth Bull - Ref Bull')
        #not using
        # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_up.value) & (df['smooth_slope_sma'] < self.smooth_bull.value) & (df['from_max'] < self.from_bull.value) & (df['ref_slope_sma'] > self.ref_bull.value) & (self.entry02.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '2 Smooth Up - Ref Bull')
        # (qtpylib.crossed_above(df['smooth_slope_sma'],  -self.smooth_ranging.value)) &
        # Make sure Volume is not 0
        df.loc[(df['smooth_slope_sma'] < self.smooth_up.value) & (df['smooth_slope_sma'] > self.smooth_down.value) & (df['from_max'] < self.from_ranging.value) & (df['ref_slope_sma'] > self.ref_bull.value) & (self.entry03.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '3 Smooth Range - Ref Bull')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_below(df['smooth_slope_sma'], self.smooth_down.value) & (df['smooth_slope_sma'] > self.smooth_bear.value) & (df['ref_slope_sma'] > self.ref_bull.value) & (df['from_max'] < self.from_down.value) & (self.entry04.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '4Smooth Down - Ref Bull')
        #not using
        # changed from 1 - 2
        # Make sure Volume is not 0
        df.loc[qtpylib.crossed_below(df['smooth_slope_sma'], self.smooth_bear.value) & (df['close'] < df['entry_offset2']) & (df['smooth_slope_sma'] < self.smooth_bear.value) & (df['ref_slope_sma'] > self.ref_bull.value) & (df['from_max'] < self.from_bear.value) & (self.entry05.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '5 Smooth Bear - Ref Bull')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_bull.value) & (df['ref_slope_sma'] < self.ref_bull.value) & (df['ref_slope_sma'] > self.ref_up.value) & (df['from_max'] < self.from_up.value) & (self.entry06.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '6 Smooth Bull - Ref Up')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_up.value) & (df['smooth_slope_sma'] < self.smooth_bull.value) & (df['ref_slope_sma'] < self.ref_bull.value) & (df['ref_slope_sma'] > self.ref_up.value) & (df['from_max'] < self.from_up.value) & (self.entry07.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '7 Smooth Up - Ref Up')
        # not using
        # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_down.value) & (df['smooth_slope_sma'] < self.smooth_up.value) & (df['smooth_slope_sma'] > self.smooth_down.value) & (df['ref_slope_sma'] < self.ref_bull.value) & (df['ref_slope_sma'] > self.ref_up.value) & (df['from_max'] < self.from_ranging.value) & (self.entry08.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '8 Smooth Range - Ref Up')
        # not using
        # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_down.value) & (df['smooth_slope_sma'] > self.smooth_bear.value) & (df['ref_slope_sma'] < self.ref_bull.value) & (df['ref_slope_sma'] > self.ref_up.value) & (df['from_max'] < self.from_down.value) & (self.entry09.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '9 Smooth Down - Ref Up')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_bear.value) & (df['close'] < df['entry_offset1']) & (df['smooth_slope_sma'] < self.smooth_bear.value) & (df['ref_slope_sma'] < self.ref_bull.value) & (df['ref_slope_sma'] > self.ref_up.value) & (df['from_max'] < self.from_bear.value) & (self.entry10.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '10 Smooth Bear - Ref Up')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_bull.value) & (df['ref_slope_sma'] < self.ref_up.value) & (df['ref_slope_sma'] > self.ref_down.value) & (df['from_max'] < self.from_ranging.value) & (self.entry11.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '11 Smooth Bull - Ref Range')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_up.value) & (df['smooth_slope_sma'] < self.smooth_bull.value) & (df['ref_slope_sma'] < self.ref_up.value) & (df['ref_slope_sma'] > self.ref_down.value) & (df['from_max'] < self.from_ranging.value) & (self.entry12.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '12 Smooth Up - Ref Range')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_down.value) & (df['smooth_slope_sma'] < self.smooth_up.value) & (df['smooth_slope_sma'] > self.smooth_down.value) & (df['ref_slope_sma'] < self.ref_up.value) & (df['ref_slope_sma'] > self.ref_down.value) & (df['from_max'] < self.from_ranging.value) & (self.entry13.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '13 Smooth Range - Ref Range')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_down.value) & (df['smooth_slope_sma'] > self.smooth_bear.value) & (df['ref_slope_sma'] < self.ref_up.value) & (df['ref_slope_sma'] > self.ref_down.value) & (df['from_max'] < self.from_down.value) & (self.entry14.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '14 Smooth Down - Ref Range')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_bear.value) & (df['close'] < df['entry_offset1']) & (df['smooth_slope_sma'] < self.smooth_bear.value) & (df['ref_slope_sma'] < self.ref_up.value) & (df['ref_slope_sma'] > self.ref_down.value) & (df['from_max'] < self.from_bear.value) & (self.entry15.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '15 Smooth Bear - Ref Range')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_bull.value) & (df['ref_slope_sma'] < self.ref_down.value) & (df['ref_slope_sma'] > self.ref_bear.value) & (df['from_max'] < self.from_down.value) & (self.entry16.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '16 Smooth Bull - Ref Down')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_up.value) & (df['smooth_slope_sma'] > self.smooth_bull.value) & (df['ref_slope_sma'] < self.ref_down.value) & (df['ref_slope_sma'] > self.ref_bear.value) & (df['from_max'] < self.from_down.value) & (self.entry17.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '17 Smooth Up - Ref Down')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['change'], df[f'smooth_change_{self.smoothing_length.value}']) & (df['close'] < df['entry_offset1']) & (df['smooth_slope_sma'] < self.smooth_up.value) & (df['smooth_slope_sma'] > self.smooth_down.value) & (df['ref_slope_sma'] < self.ref_down.value) & (df['ref_slope_sma'] > self.ref_bear.value) & (df['from_max'] < self.from_down.value) & (self.entry18.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '18 Smooth Range - Ref Down')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['change'], df[f'smooth_change_{self.smoothing_length.value}']) & (df['smooth_slope_sma'] > self.smooth_bear.value) & (df['ref_slope_sma'] < self.ref_down.value) & (df['ref_slope_sma'] > self.ref_bear.value) & (df['from_max'] < self.from_down.value) & (self.entry19.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '19 Smooth Down - Ref Down - % XO')  # Make sure Volume is not 0
        df.loc[(df['min'] > df['close']) & (df['smooth_slope_sma'] > self.smooth_bear.value) & (df['ref_slope_sma'] < self.ref_down.value) & (df['ref_slope_sma'] > self.ref_bear.value) & (df['from_max'] < self.from_down.value) & (self.entry20.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '20 Smooth Down - Ref Down - Open < Min')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_bear.value) & (df['smooth_slope_sma'] < self.smooth_bear.value) & (df['ref_slope_sma'] < self.ref_down.value) & (df['ref_slope_sma'] > self.ref_bear.value) & (df['from_max'] < self.from_down.value) & (self.entry21.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '21 Smooth Bear - Ref Down')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_bull.value) & (df['ref_slope_sma'] < self.ref_bear.value) & (df['from_max'] < self.from_bear.value) & (self.entry22.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '22 Smooth Bull - Ref Bear')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_up.value) & (df['smooth_slope_sma'] < self.smooth_bull.value) & (df['ref_slope_sma'] < self.ref_bear.value) & (df['from_max'] < self.from_bear.value) & (self.entry23.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '23 Smooth Up - Ref Bear')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_down.value) & (df['smooth_slope_sma'] < self.smooth_up.value) & (df['smooth_slope_sma'] > self.smooth_down.value) & (df['ref_slope_sma'] < self.ref_bear.value) & (df['from_max'] < self.from_bear.value) & (self.entry24.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '24 Smooth Range - Ref Bear')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_down.value) & (df['smooth_slope_sma'] > self.smooth_bear.value) & (df['ref_slope_sma'] < self.ref_bear.value) & (df['from_max'] < self.from_bear.value) & (self.entry25.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '25 Smooth Down - Ref Bear')
        # (df['close'] < df['entry_offset2']) &
        # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['smooth_slope_sma'], self.smooth_bear.value) & (df['smooth_slope_sma'] < self.smooth_bear.value) & (df['ref_slope_sma'] < self.ref_bear.value) & (df['from_max'] < self.from_bear.value) & (self.entry26.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '26 Smooth Bear - Ref Bear')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['change'], df['entry_offset3']) & (df['pivot'] < df['exit_offset1']) & (df['close'] < df['entry_offset1']) & (df['smooth_slope_sma'] > self.smooth_down.value) & (df['from_max'] < self.from_ranging.value) & (self.entry27.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '27 XO above entry_offset3 | Range - Bull')  # Make sure Volume is not 0
        df.loc[(df['min'] < df['entry_offset1']) & (df['from_max'] - df['from_max'].shift(8) < self.from_down.value) & (df['close'] < df['entry_offset1']) & (self.entry28.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '28 Low XB Min < entry_offset1')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df['change'], df['entry_offset3']) & (df['pivot'] < df['exit_offset1']) & (df['close'] < df['entry_offset1']) & (df['smooth_slope_sma'] < self.smooth_down.value) & (df['from_max'] < self.from_down.value) & (self.entry29.value == True) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, '29 XO above entry_offset3 | Down - Bear')
        # df.loc[
        #     (
        ...
        #         (df['ref_slope_sma'] > 0) &
        #         (self.entry30.value == True) &
        #         (df['volume'] > 0)  # Make sure Volume is not 0
        #     ),
        #     ['enter_long', 'enter_tag']] = (1, '30 Golden XO')
        # df.loc[
        #     (
        #         (qtpylib.crossed_above(df['change'], df['entry_offset3'])) &
        #         (df['smooth_ma_slope'] < 0) &
        #         (df['close'] < df[f'reference_ma_{self.reference_ma_length.value}']) &
        #         (df['volume'] > 0)  # Make sure Volume is not 0
        #     ),
        #     ['enter_long', 'enter_tag']] = (1, 'XO above entry_offset|slope down')
        # df.loc[
        #     (
        #         (qtpylib.crossed_above(df['change'], df['entry_offset3'])) &
        ...
        #         (df['volume'] > 0)  # Make sure Volume is not 0
        #     ),
        #     ['enter_long', 'enter_tag']] = (1, 'XO above entry_offset|slope up')
        # df.loc[
        #     (
        #         (df['min'] < df['entry_offset1']) &
        #         ((df['from_max'] - df['from_max'].shift(8)) < self.bear_from_max.value) &
        #         (df['close'] < df['entry_offset1']) &
        #         (df['volume'] > 0)  # Make sure Volume is not 0
        #     ),
        #     ['enter_long', 'enter_tag']] = (1, 'Low XB Min < entry_offset1')
        # df.loc[
        #     (
        #         (qtpylib.crossed_above(df['close'], df['entry_offset2'])) &
        #         (df['change'] < df['entry_offset3']) &
        #         (df['volume'] > 0)  # Make sure Volume is not 0
        #     ),
        #     ['enter_long', 'enter_tag']] = (1, 'XO above entry_offset2')
        # df.loc[
        #     (
    ...
    def populate_exit_trend(self, df: DataFrame, metadata: dict) -> DataFrame:  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_below(df[f'zema_{self.filterlength.value}'], df['r5']) & (df['close'] > df[f'reference_ma_{self.reference_ma_length.value}'] * self.exit_offset1.value) & (self.exit01.value == True) & (df['volume'] > 0), ['exit_long', 'exit_tag']] = (1, 'R5 - XO')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_below(df[f'zema_{self.filterlength.value}'], df['r3']) & (df['smooth_ma_slope'] < self.exit_slope.value) & (self.exit02.value == True) & (df['volume'] > 0), ['exit_long', 'exit_tag']] = (1, 'R3 - XO')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_below(df[f'zema_{self.filterlength.value}'], df['r2.75']) & (df['smooth_ma_slope'] < self.exit_slope.value) & (self.exit03.value == True) & (df['volume'] > 0), ['exit_long', 'exit_tag']] = (1, 'R2.75 - XO')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_below(df[f'zema_{self.filterlength.value}'], df['r2.50']) & (df['smooth_ma_slope'] < self.exit_slope.value) & (self.exit04.value == True) & (df['volume'] > 0), ['exit_long', 'exit_tag']] = (1, 'R2.5 - XO')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_below(df[f'zema_{self.filterlength.value}'], df['r2.25']) & (df['smooth_ma_slope'] < self.exit_slope.value) & (self.exit05.value == True) & (df['volume'] > 0), ['exit_long', 'exit_tag']] = (1, 'R2.25 - XO')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_below(df[f'zema_{self.filterlength.value}'], df['r2']) & (df['smooth_ma_slope'] < self.exit_slope.value) & (self.exit06.value == True) & (df['volume'] > 0), ['exit_long', 'exit_tag']] = (1, 'R2 - XO')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_below(df[f'zema_{self.filterlength.value}'], df['pivot']) & (df['smooth_ma_slope'] < self.exit_slope.value) & (self.exit07.value == True) & (df['volume'] > 0), ['exit_long', 'exit_tag']] = (1, 'Pivot - XO')
        return df
# Best result:
...
#     entry_params = {
#         "entry1": True,  # value loaded from strategy
#         "entry10": True,  # value loaded from strategy
#         "entry11": False,  # value loaded from strategy
#         "entry12": False,  # value loaded from strategy
#         "entry13": False,  # value loaded from strategy
#         "entry14": False,  # value loaded from strategy
#         "entry15": False,  # value loaded from strategy
#         "entry16": True,  # value loaded from strategy
#         "entry17": True,  # value loaded from strategy
#         "entry18": True,  # value loaded from strategy
#         "entry19": False,  # value loaded from strategy
#         "entry2": False,  # value loaded from strategy
#         "entry20": True,  # value loaded from strategy
#         "entry21": True,  # value loaded from strategy
#         "entry22": True,  # value loaded from strategy
#         "entry23": True,  # value loaded from strategy
#         "entry24": False,  # value loaded from strategy
#         "entry25": True,  # value loaded from strategy
#         "entry26": True,  # value loaded from strategy
#         "entry27": True,  # value loaded from strategy
#         "entry28": False,  # value loaded from strategy
#         "entry29": True,  # value loaded from strategy
#         "entry3": True,  # value loaded from strategy
#         "entry4": True,  # value loaded from strategy
#         "entry5": False,  # value loaded from strategy
#         "entry6": True,  # value loaded from strategy
#         "entry7": True,  # value loaded from strategy
#         "entry8": False,  # value loaded from strategy
#         "entry9": False,  # value loaded from strategy
#         "entry_change": 1.6,  # value loaded from strategy
#         "entry_offset1": 0.99,  # value loaded from strategy
#         "entry_offset2": 0.92,  # value loaded from strategy
...
# | 29 XO above entry_offset3 | Down - Bear |        77 |           1.05 |          80.76 |           252.870 |          25.29 | 2 days, 19:45:00 |    64     6     7  83.1 |
