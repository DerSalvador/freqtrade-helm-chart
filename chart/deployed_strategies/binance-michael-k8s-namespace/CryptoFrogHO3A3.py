...
class CryptoFrogHO3A3(IStrategy):
    ...
    exit_params = {'cstp_bail_how': 'roc', 'cstp_bail_roc': -0.01, 'cstp_bail_time': 1310, 'cstp_threshold': 0.0, 'droi_pullback': True, 'droi_pullback_amount': 0.009, 'droi_pullback_respect_table': False, 'droi_trend_type': 'rmi'}
    # ROI table - this strat REALLY benefits from roi and trailing hyperopt:
    minimal_roi = {'0': 0.143, '10': 0.022, '20': 0.011, '53': 0}
    # Trailing stop:
    trailing_stop = True
    ...
    custom_stop = {'decay-time': 53, 'decay-delay': 0, 'decay-start': -0.299, 'decay-end': -0.02, 'cur-min-diff': 0.03, 'cur-threshold': -0.02, 'roc-bail': -0.03, 'rmi-trend': 50, 'bail-how': 'immediate', 'pos-trail': True, 'pos-threshold': 0.005, 'pos-trail-dist': 0.015}
    # Dynamic ROI
