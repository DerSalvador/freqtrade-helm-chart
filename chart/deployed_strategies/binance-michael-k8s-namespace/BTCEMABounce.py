...
class BTCEMABounce(IStrategy):
    ...
    #buy_long_period = CategoricalParameter([20, 30, 30, 50, 60, 70, 80, 90, 100], default=50, space="buy")
    ...
    #buy_diff = DecimalParameter(0.01, 0.10, decimals=3, default=0.02, space="buy") # for testing
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # populate BTC dataframe (see main logic for comments)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # buy if price is far enough below EMA (note: NOT the BTC ema)
