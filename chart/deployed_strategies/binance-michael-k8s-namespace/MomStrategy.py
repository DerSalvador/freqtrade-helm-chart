...
class MomStrategy(IStrategy):
    ...
    plot_config = {'main_plot': {}, 'subplots': {'MOM': {'mom': {'color': 'red'}}}}
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['signal'] = 0  # Make sure Volume is not 0
        dataframe.loc[(dataframe['mom'] > 0) & (dataframe['volume'] > 0), 'signal'] = 1
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        dataframe.loc[dataframe['signal'] == 1, 'entry'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        :return: DataFrame with entry column
        """
        dataframe.loc[dataframe['signal'] == -1, 'exit'] = 1
        return dataframe