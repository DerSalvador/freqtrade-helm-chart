...
class TenderEnter(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        dataframe.loc[self.compareFields(dataframe, 'close', 1, 1017) & self.compareFields(dataframe, 'close', 2, 1017) & self.compareFields(dataframe, 'volume', 1, 65) & self.compareFields(dataframe, 'volume', 2, 65) & (dataframe['volume'] > 0), 'entry'] = 1
        return dataframe
