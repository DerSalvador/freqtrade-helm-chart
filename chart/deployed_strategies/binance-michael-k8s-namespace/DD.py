...
class DD(IStrategy):
    ...
    minimal_roi = {'0': 0.11078, '33': 0.06816, '68': 0.02844, '165': 0}
    # Trailing stop:
    trailing_stop = True
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        #   (dataframe['mfi'] < 16) &
        #  (dataframe['adx'] > 25) &
        dataframe.loc[(dataframe['close'] < dataframe['bb_lowerband']) & (dataframe['rsi'] < 40), 'entry'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        #      )) &
        #      (dataframe['fastd'] > 54)
        dataframe.loc[dataframe['close'] > dataframe['bb_upperband'], 'exit'] = 1
        return dataframe