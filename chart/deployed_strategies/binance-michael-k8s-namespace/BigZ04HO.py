...
class BigZ04HO(IStrategy):
    ...
    entry_params = {'entry_condition_0_enable': True, 'entry_condition_1_enable': True, 'entry_condition_2_enable': True, 'entry_condition_3_enable': True, 'entry_condition_4_enable': True, 'entry_condition_5_enable': True, 'entry_condition_6_enable': True, 'entry_condition_7_enable': True, 'entry_condition_8_enable': True, 'entry_condition_9_enable': True, 'entry_condition_10_enable': True, 'entry_condition_11_enable': True, 'entry_condition_12_enable': True, 'entry_condition_13_enable': True, 'entry_bb20_close_bblowerband_safe_1': 0.951, 'entry_bb20_close_bblowerband_safe_2': 0.981, 'entry_volume_drop_1': 8.3, 'entry_volume_pump_1': 0.4, 'entry_volume_drop_3': 4.1, 'entry_rsi_1h_1': 20.3, 'entry_rsi_1h_2': 17.6, 'entry_rsi_1h_3': 21.4, 'entry_rsi_1h_4': 36.2, 'entry_rsi_1h_5': 35.7, 'entry_macd_1': 0.01, 'entry_macd_2': 0.03}
    ############################################################################
    # Buy
