...
class YoyoActionZoneStrategy(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[dataframe['bearish'] & dataframe['close'] > dataframe['ema_fast'], 'green'] = True
        # Blue = bearish and mainSource>fast and mainSource>slow
        dataframe['blue'] = False
        dataframe.loc[dataframe['bearish'] & (dataframe['close'] > dataframe['ema_fast']) & (dataframe['close'] < dataframe['ema_slow']), 'blue'] = True
        # Yellow = bullish and mainSource<fast and mainSource>slow
        dataframe['yellow'] = False
        dataframe.loc[dataframe['bearish'] & (dataframe['close'] < dataframe['ema_fast']) & (dataframe['close'] > dataframe['ema_slow']), 'yellow'] = True
        # Brown = bullish and mainSource<fast and mainSource<slow
        dataframe['brown'] = False
        dataframe.loc[dataframe['bearish'] & (dataframe['close'] < dataframe['ema_fast']) & (dataframe['close'] < dataframe['ema_slow']), 'brown'] = True
        # Red = bearish and mainSource<fast
        dataframe['red'] = False
        dataframe.loc[dataframe['bearish'] & dataframe['close'] < dataframe['ema_fast'], 'red'] = True
        ...
        dataframe.loc[dataframe['greenLine'] & (dataframe['close'] > dataframe['trail2']), 'greenLine'] = True
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # later          
        dataframe.loc[dataframe['long'] | dataframe['green'] & dataframe['greenLine'] | dataframe['blue'] & dataframe['greenLine'], 'enter_long'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # later          
        dataframe.loc[dataframe['short'].shift(-1) == 1 & ((dataframe['greenLine_last'] & dataframe['greenLine'] == False) | dataframe['red']), 'exit_long'] = 1
        return dataframe