...
entry_params = {'base_nb_candles_entry': 17, 'ewo_high': 2.139, 'ewo_low': -19.767, 'low_offset': 0.98, 'rsi_entry': 65}
# Sell hyperspace params:
exit_params = {'base_nb_candles_exit': 17, 'high_offset': 0.99}
...
class SMAOffsetProtectOptV1HO1(IStrategy):
    INTERFACE_VERSION = 3
    # ROI table:
    minimal_roi = {'0': 0.114, '36': 0.063, '95': 0.037, '157': 0}
    # Stoploss:
    stoploss = -0.5
    # SMAOffset
