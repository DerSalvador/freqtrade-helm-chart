...
class BigZ07Next2(IStrategy):
    ...
    # I feel lucky!
    # We're going up?
    minimal_roi = {'0': 0.028, '10': 0.018, '40': 0.01, '180': 0.018}
    stoploss = -0.99
    # Trailing stoploss
    trailing_stop = False
