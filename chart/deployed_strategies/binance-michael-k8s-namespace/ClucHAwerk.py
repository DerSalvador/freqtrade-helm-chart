...
class ClucHAwerk_ETH(ClucHAwerk):
    ...
    ignore_roi_if_entry_signal = True
    # hyperopt --config user_data/config-backtest-ETH.json --hyperopt ClucHAwerkHyperopt_ETH --hyperopt-loss SortinoHyperOptLoss --strategy ClucHAwerk_ETH -e 500 --spaces entry --timeframe 1m --timerange 20210101-
    ...
    # Sell hyperspace params:
    exit_params = {'exit-bbmiddle-close': 1.02894, 'exit-rocr-1h': 0.94925}  # hyperopt --config user_data/config-backtest-ETH.json --hyperopt ClucHAwerkHyperopt_ETH --hyperopt-loss SharpeHyperOptLoss --strategy ClucHAwerk_ETH -e 250 --spaces roi --timeframe 1m --timerange 20210101-
    ...
    # ROI table:
    minimal_roi = {'0': 0.14414, '13': 0.10123, '20': 0.03256, '47': 0.0177, '132': 0.01016, '177': 0.00328, '277': 0}  # hyperopt --config user_data/config-backtest-ETH.json --hyperopt ClucHAwerkHyperopt_ETH --hyperopt-loss OnlyProfitHyperOptLoss --strategy ClucHAwerk_ETH -e 500 --spaces stoploss --timeframe 1m --timerange 20210101- 
    ...
    # Stoploss:
    stoploss = -0.02  # hyperopt --config user_data/config-backtest-ETH.json --hyperopt ClucHAwerkHyperopt_ETH --hyperopt-loss OnlyProfitHyperOptLoss --strategy ClucHAwerk_ETH -e 500 --spaces trailing --timeframe 1m --timerange 20210101- 
...
class ClucHAwerk_BTC(ClucHAwerk):  # hyperopt --config user_data/config-backtest-BTC.json --hyperopt ClucHAwerkHyperopt_BTC --hyperopt-loss SortinoHyperOptLoss --strategy ClucHAwerk_BTC -e 500 --spaces entry --timeframe 1m --timerange 20210101-
    ...
    # Sell hyperspace params:
    exit_params = {'exit-bbmiddle-close': 0.98016, 'exit-rocr-1h': 0.86823}  # hyperopt --config user_data/config-backtest-BTC.json --hyperopt ClucHAwerkHyperopt_BTC --hyperopt-loss OnlyProfitHyperOptLoss --strategy ClucHAwerk_BTC -e 500 --spaces roi --timeframe 1m --timerange 20210101- 
    ...
    # ROI table:
    minimal_roi = {'0': 0.18105, '9': 0.10391, '49': 0.0447, '53': 0.02747, '141': 0.01265, '312': 0.00499, '466': 0}  # hyperopt --config user_data/config-backtest-BTC.json --hyperopt ClucHAwerkHyperopt_BTC --hyperopt-loss SharpeHyperOptLoss --strategy ClucHAwerk_BTC -e 250 --spaces stoploss --timeframe 1m --timerange 20210101- 
    ...
    # Stoploss:
    stoploss = -0.11356  # hyperopt --config user_data/config-backtest-BTC.json --hyperopt ClucHAwerkHyperopt_BTC --hyperopt-loss OnlyProfitHyperOptLoss --strategy ClucHAwerk_BTC -e 500 --spaces trailing --timeframe 1m --timerange 20210101-
...
class ClucHAwerk_USD(ClucHAwerk):  # hyperopt --config user_data/config-backtest-USD.json --hyperopt ClucHAwerkHyperopt_USD --hyperopt-loss SharpeHyperOptLoss --strategy ClucHAwerk_USD -e 500 --spaces entry --timeframe 1m --timerange 20210101-
    ...
    # Buy hyperspace params:
    entry_params = {'bbdelta-close': 0.01806, 'bbdelta-tail': 0.85912, 'close-bblower': 0.01158, 'closedelta-close': 0.01466, 'rocr-1h': 0.51901, 'volume': 26}  # hyperopt --config user_data/config-backtest-USD.json --hyperopt ClucHAwerkHyperopt_USD --hyperopt-loss SortinoHyperOptLoss --strategy ClucHAwerk_USD -e 500 --spaces exit --timeframe 1m --timerange 20210101- 
    ...
    # Sell hyperspace params:
    exit_params = {'exit-bbmiddle-close': 1.06163, 'exit-rocr-1h': 0.63285}  # hyperopt --config user_data/config-backtest-USD.json --hyperopt ClucHAwerkHyperopt_USD --hyperopt-loss OnlyProfitHyperOptLoss --strategy ClucHAwerk_USD -e 500 --spaces roi --timeframe 1m --timerange 20210101- 
    ...
    # ROI table:
    minimal_roi = {'0': 0.19315, '13': 0.13189, '24': 0.08358, '103': 0.03894, '148': 0.0148, '201': 0.00506, '447': 0}  # hyperopt --config user_data/config-backtest-USD.json --hyperopt ClucHAwerkHyperopt_USD --hyperopt-loss SharpeHyperOptLoss --strategy ClucHAwerk_USD -e 500 --spaces stoploss --timeframe 1m --timerange 20210101- 
    ...
    # Stoploss:
    stoploss = -0.17725  # hyperopt --config user_data/config-backtest-USD.json --hyperopt ClucHAwerkHyperopt_USD --hyperopt-loss OnlyProfitHyperOptLoss --strategy ClucHAwerk_USD -e 500 --spaces trailing --timeframe 1m --timerange 20210101- 
