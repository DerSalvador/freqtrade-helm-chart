...
class NFI5MOHO2(IStrategy):
    ...
    stoploss = -0.99
    # Multi Offset
    entry_nb_candles_optimize = False
    ...
    base_nb_candles_entry = IntParameter(5, 80, default=20, load=True, space='entry', optimize=entry_nb_candles_optimize)
    base_nb_candles_exit = IntParameter(5, 80, default=20, load=True, space='exit', optimize=entry_nb_candles_optimize)
    ...
    # 48 hours loose
    entry_pump_pull_threshold_9 = DecimalParameter(1.5, 3.0, default=1.4, space='entry', decimals=2, optimize=False, load=True)
    entry_pump_threshold_9 = DecimalParameter(0.4, 1.8, default=1.3, space='entry', decimals=3, optimize=False, load=True)
    ...
    entry_mfi_1 = DecimalParameter(20.0, 40.0, default=26.0, space='entry', decimals=1, optimize=False, load=True)
    entry_volume_2 = DecimalParameter(1.0, 10.0, default=2.6, space='entry', decimals=1, optimize=False, load=True)
    ...
    entry_ema_open_mult_6 = DecimalParameter(0.02, 0.03, default=0.025, space='entry', decimals=3, optimize=False, load=True)
    ...
    entry_rsi_8 = DecimalParameter(36.0, 40.0, default=20.0, space='entry', decimals=1, optimize=False, load=True)
    entry_tail_diff_8 = DecimalParameter(3.0, 10.0, default=3.5, space='entry', decimals=1, optimize=False, load=True)
    entry_volume_9 = DecimalParameter(1.0, 4.0, default=1.0, space='entry', decimals=2, optimize=False, load=True)
    ...
    entry_mfi_9 = DecimalParameter(36.0, 65.0, default=30.0, space='entry', decimals=1, optimize=False, load=True)
    entry_volume_10 = DecimalParameter(1.0, 8.0, default=2.4, space='entry', decimals=1, optimize=False, load=True)
    ...
    entry_volume_12 = DecimalParameter(1.0, 10.0, default=1.7, space='entry', decimals=1, optimize=False, load=True)
    ...
    entry_volume_13 = DecimalParameter(1.0, 10.0, default=1.6, space='entry', decimals=1, optimize=False, load=True)
    ...
    entry_volume_14 = DecimalParameter(1.0, 10.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)
    ...
    entry_volume_15 = DecimalParameter(1.0, 10.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)
    entry_ema_open_mult_15 = DecimalParameter(0.02, 0.04, default=0.018, space='entry', decimals=3, optimize=False, load=True)
    entry_ma_offset_15 = DecimalParameter(0.93, 0.99, default=0.954, space='entry', decimals=3, optimize=False, load=True)
    entry_rsi_15 = DecimalParameter(30.0, 50.0, default=28.0, space='entry', decimals=1, optimize=False, load=True)
    entry_ema_rel_15 = DecimalParameter(0.97, 0.999, default=0.988, space='entry', decimals=3, optimize=False, load=True)
    entry_volume_16 = DecimalParameter(1.0, 10.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)
    ...
    entry_ewo_16 = DecimalParameter(4.0, 8.0, default=2.8, space='entry', decimals=1, optimize=False, load=True)
    entry_volume_17 = DecimalParameter(0.5, 8.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)
    ...
    entry_volume_18 = DecimalParameter(1.0, 6.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)
    ...
    entry_volume_20 = DecimalParameter(0.5, 6.0, default=1.2, space='entry', decimals=1, optimize=False, load=True)
    #entry_ema_rel_20 = DecimalParameter(0.97, 0.999, default=0.988, space='entry', decimals=3, optimize=False, load=True)
    entry_rsi_20 = DecimalParameter(20.0, 36.0, default=26.0, space='entry', decimals=1, optimize=False, load=True)
    entry_rsi_1h_20 = DecimalParameter(14.0, 30.0, default=20.0, space='entry', decimals=1, optimize=False, load=True)
    entry_volume_21 = DecimalParameter(0.5, 6.0, default=3.0, space='entry', decimals=1, optimize=False, load=True)
    #entry_ema_rel_21 = DecimalParameter(0.97, 0.999, default=0.988, space='entry', decimals=3, optimize=False, load=True)
    ...
    exit_custom_profit_4 = DecimalParameter(0.3, 0.6, default=0.25, space='exit', decimals=3, optimize=False, load=True)
    exit_custom_rsi_4 = DecimalParameter(40.0, 58.0, default=50.0, space='exit', decimals=2, optimize=False, load=True)
    ...
    exit_custom_under_profit_3 = DecimalParameter(0.01, 0.1, default=0.6, space='exit', decimals=3, optimize=False, load=True)
