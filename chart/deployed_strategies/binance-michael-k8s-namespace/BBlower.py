...
class BBlower(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # &
        dataframe.loc[(dataframe['RSI'] > dataframe['RSI'].shift(1)) & (dataframe['RSI'].shift(1) > dataframe['RSI'].shift(2)) & (dataframe['RSI'].shift(2) > dataframe['RSI'].shift(3)) & (dataframe['RSI'].shift(3) > dataframe['RSI'].shift(4)) & (dataframe['RSI'] < 50) & qtpylib.crossed_above(dataframe['TEMA'], dataframe['bb_lowerbandTA1']), 'entry'] = 1
        return dataframe
