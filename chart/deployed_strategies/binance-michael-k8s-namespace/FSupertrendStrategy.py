...
class FSupertrendStrategy(IStrategy):
    ...
    entry_m1 = IntParameter(1, 7, default=1)
    entry_m2 = IntParameter(1, 7, default=3)
    entry_m3 = IntParameter(1, 7, default=4)
    entry_p1 = IntParameter(7, 21, default=14)
    entry_p2 = IntParameter(7, 21, default=10)
    entry_p3 = IntParameter(7, 21, default=10)
    exit_m1 = IntParameter(1, 7, default=1)
    exit_m2 = IntParameter(1, 7, default=3)
    exit_m3 = IntParameter(1, 7, default=4)
    exit_p1 = IntParameter(7, 21, default=14)
    exit_p2 = IntParameter(7, 21, default=10)
    exit_p3 = IntParameter(7, 21, default=10)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:  # The three indicators are 'up' for the current candle
        dataframe.loc[(dataframe[f'supertrend_1_entry_{self.entry_m1.value}_{self.entry_p1.value}'] == 'up') & (dataframe[f'supertrend_2_entry_{self.entry_m2.value}_{self.entry_p2.value}'] == 'up') & (dataframe[f'supertrend_3_entry_{self.entry_m3.value}_{self.entry_p3.value}'] == 'up') & (dataframe['volume'] > 0), 'enter_long'] = 1  # The three indicators are 'down' for the current candle
        dataframe.loc[(dataframe[f'supertrend_1_exit_{self.exit_m1.value}_{self.exit_p1.value}'] == 'down') & (dataframe[f'supertrend_2_exit_{self.exit_m2.value}_{self.exit_p2.value}'] == 'down') & (dataframe[f'supertrend_3_exit_{self.exit_m3.value}_{self.exit_p3.value}'] == 'down') & (dataframe['volume'] > 0), 'enter_short'] = 1
        return dataframe

    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        dataframe.loc[dataframe[f'supertrend_2_exit_{self.exit_m2.value}_{self.exit_p2.value}'] == 'down', 'exit_long'] = 1
        dataframe.loc[dataframe[f'supertrend_2_entry_{self.entry_m2.value}_{self.entry_p2.value}'] == 'up', 'exit_short'] = 1
        return dataframe
