...
class BigZ0307HO(IStrategy):
    ...
    entry_params = {'entry_condition_0_enable': True, 'entry_condition_1_enable': True, 'entry_condition_2_enable': True, 'entry_condition_3_enable': True, 'entry_condition_4_enable': True, 'entry_condition_5_enable': True, 'entry_condition_6_enable': True, 'entry_condition_7_enable': True, 'entry_condition_8_enable': True, 'entry_condition_9_enable': True, 'entry_condition_10_enable': True, 'entry_condition_11_enable': True, 'entry_condition_12_enable': True, 'entry_bb20_close_bblowerband_safe_1': 0.957, 'entry_bb20_close_bblowerband_safe_2': 0.766, 'entry_volume_drop_1': 4.0, 'entry_volume_pump_1': 0.1, 'entry_volume_drop_2': 1.3, 'entry_volume_drop_3': 1.4, 'entry_rsi_1h_1': 38.2, 'entry_rsi_1h_2': 36.4, 'entry_rsi_1h_3': 19.1, 'entry_rsi_1h_4': 37.2, 'entry_rsi_1h_5': 51.0, 'entry_macd_1': 0.01, 'entry_macd_2': 0.01, 'entry_rsi_1': 16.0, 'entry_rsi_2': 14.8, 'entry_rsi_3': 10.8, 'entry_rsi_1h_1': 39.8, 'entry_rsi_1h_2': 37.9, 'entry_rsi_1h_3': 38.2, 'entry_rsi_1h_4': 38.1, 'entry_rsi_1h_5': 58.9, 'entry_macd_1': 0.07, 'entry_macd_2': 0.02}
    ############################################################################
    # Buy
    ...
    entry_condition_11_bb_middleband = DecimalParameter(1.001, 1.02, default=1.005, space='entry', decimals=3, optimize=entry_condition_11_optimize, load=True)
    entry_condition_11_rsi = DecimalParameter(60, 76, default=68, space='entry', decimals=2, optimize=entry_condition_11_optimize, load=True)
