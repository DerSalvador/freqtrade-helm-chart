...
class BBRSIS(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        dataframe.loc[(dataframe['close'] < dataframe['bb_lowerband']) & (dataframe['sma5'] >= dataframe['sma75']) & (dataframe['sma75'] >= dataframe['sma200']) & (dataframe['rsi'] < dataframe['resample_{}_rsi'.format(self.get_ticker_indicator() * 3)] - 5) & (dataframe['volume'] > 0), 'entry'] = 1
        return dataframe
