...
class ForexSignal(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """  # Onko nousutrendi
        dataframe.loc[(dataframe['ema8_1h'] > dataframe['ema21_1h']) & (dataframe['ema8'] > dataframe['ema13']) & (dataframe['ema13'] > dataframe['ema21']) & (dataframe['low'] < dataframe['ema8']), 'entry'] = 1
        return dataframe

    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        dataframe.loc[dataframe['ema8'] < dataframe['ema8'].shift(1), 'exit'] = 1
        return dataframe