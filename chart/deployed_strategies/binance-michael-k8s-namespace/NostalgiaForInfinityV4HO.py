...
class NostalgiaForInfinityV4HO(IStrategy):
    ...
    entry_params = {'entry_bb20_close_bblowerband_4': 0.933, 'entry_bb20_volume_4': 32, 'entry_bb40_bbdelta_close_3': 0.024, 'entry_bb40_closedelta_close_3': 0.022, 'entry_bb40_tail_bbdelta_3': 0.329, 'entry_bb_offset_10': 0.983, 'entry_bb_offset_14': 0.99, 'entry_bb_offset_2': 0.977, 'entry_bb_offset_5': 0.989, 'entry_bb_offset_6': 0.987, 'entry_bb_offset_9': 0.978, 'entry_condition_10_enable': False, 'entry_condition_11_enable': True, 'entry_condition_12_enable': True, 'entry_condition_13_enable': True, 'entry_condition_14_enable': True, 'entry_condition_15_enable': False, 'entry_condition_16_enable': True, 'entry_condition_17_enable': False, 'entry_condition_1_enable': True, 'entry_condition_2_enable': True, 'entry_condition_3_enable': True, 'entry_condition_4_enable': True, 'entry_condition_5_enable': False, 'entry_condition_6_enable': False, 'entry_condition_7_enable': True, 'entry_condition_8_enable': False, 'entry_condition_9_enable': True, 'entry_dip_threshold_1': 0.019, 'entry_dip_threshold_2': 0.12, 'entry_dip_threshold_3': 0.248, 'entry_dip_threshold_4': 0.392, 'entry_dip_threshold_5': 0.023, 'entry_dip_threshold_6': 0.2, 'entry_dip_threshold_7': 0.397, 'entry_dip_threshold_8': 0.295, 'entry_ema_open_mult_14': 0.011, 'entry_ema_open_mult_15': 0.021, 'entry_ema_open_mult_5': 0.023, 'entry_ema_open_mult_6': 0.035, 'entry_ema_open_mult_7': 0.038, 'entry_ema_rel_15': 0.987, 'entry_ema_rel_3': 0.979, 'entry_ema_rel_5': 0.994, 'entry_ema_rel_8': 0.979, 'entry_ewo_12': 2.8, 'entry_ewo_13': -8.0, 'entry_ewo_16': 5.1, 'entry_ewo_17': -17.9, 'entry_ma_offset_10': 0.965, 'entry_ma_offset_11': 0.948, 'entry_ma_offset_12': 0.941, 'entry_ma_offset_13': 0.971, 'entry_ma_offset_14': 0.957, 'entry_ma_offset_15': 0.99, 'entry_ma_offset_16': 0.96, 'entry_ma_offset_17': 0.97, 'entry_ma_offset_9': 0.977, 'entry_mfi_1': 21.7, 'entry_mfi_11': 53.7, 'entry_mfi_2': 36.5, 'entry_mfi_9': 40.7, 'entry_min_inc_1': 0.032, 'entry_min_inc_11': 0.036, 'entry_pump_pull_threshold_1': 1.56, 'entry_pump_pull_threshold_2': 2.88, 'entry_pump_pull_threshold_3': 2.88, 'entry_pump_pull_threshold_4': 2.42, 'entry_pump_pull_threshold_5': 2.21, 'entry_pump_pull_threshold_6': 2.35, 'entry_pump_threshold_1': 0.601, 'entry_pump_threshold_2': 0.886, 'entry_pump_threshold_3': 0.691, 'entry_pump_threshold_4': 0.599, 'entry_pump_threshold_5': 0.804, 'entry_pump_threshold_6': 0.512, 'entry_rsi_1': 23.4, 'entry_rsi_11': 42.0, 'entry_rsi_12': 39.8, 'entry_rsi_15': 33.1, 'entry_rsi_16': 40.1, 'entry_rsi_1h_10': 29.5, 'entry_rsi_1h_diff_2': 45.1, 'entry_rsi_1h_max_1': 88.9, 'entry_rsi_1h_max_11': 80.3, 'entry_rsi_1h_max_2': 88.2, 'entry_rsi_1h_max_9': 78.4, 'entry_rsi_1h_min_1': 25.2, 'entry_rsi_1h_min_11': 40.8, 'entry_rsi_1h_min_2': 31.8, 'entry_rsi_1h_min_9': 38.1, 'entry_rsi_7': 39.1, 'entry_rsi_8': 41.3, 'entry_volume_10': 13.3, 'entry_volume_12': 10.0, 'entry_volume_14': 7.3, 'entry_volume_16': 3.1, 'entry_volume_2': 8.3, 'entry_volume_5': 4.6, 'entry_volume_6': 1.5, 'entry_volume_7': 9.1, 'entry_volume_9': 3.93}
    # Sell hyperspace params:
    exit_params = {'exit_bb_relative_8': 1.293, 'exit_condition_1_enable': False, 'exit_condition_2_enable': False, 'exit_condition_3_enable': True, 'exit_condition_4_enable': False, 'exit_condition_5_enable': True, 'exit_condition_6_enable': False, 'exit_condition_7_enable': False, 'exit_condition_8_enable': True, 'exit_custom_profit_0': 0.04, 'exit_custom_profit_1': 0.012, 'exit_custom_profit_2': 0.083, 'exit_custom_profit_3': 0.067, 'exit_custom_profit_4': 0.587, 'exit_custom_rsi_0': 39.492, 'exit_custom_rsi_1': 48.33, 'exit_custom_rsi_2': 45.91, 'exit_custom_rsi_3': 47.92, 'exit_custom_rsi_4': 54.5, 'exit_custom_under_profit_1': 0.012, 'exit_custom_under_profit_2': 0.088, 'exit_custom_under_profit_3': 0.121, 'exit_dual_rsi_rsi_1h_4': 89.3, 'exit_dual_rsi_rsi_4': 78.9, 'exit_ema_relative_5': 0.015, 'exit_rsi_1h_7': 87.7, 'exit_rsi_bb_1': 65.4, 'exit_rsi_bb_2': 77.6, 'exit_rsi_diff_5': 3.116, 'exit_rsi_main_3': 81.1, 'exit_rsi_under_6': 81.1, 'exit_trail_down_1': 0.154, 'exit_trail_down_2': 0.089, 'exit_trail_profit_max_1': 0.5, 'exit_trail_profit_max_2': 0.13, 'exit_trail_profit_min_1': 0.193, 'exit_trail_profit_min_2': 0.046}
    #############################################################
    ...
    exit_rsi_diff_5 = DecimalParameter(0.0, 20.0, default=4.382, space='exit', optimize=True, load=True)
    ...
    exit_custom_rsi_0 = DecimalParameter(30.0, 40.0, default=30.0, space='exit', decimals=3, optimize=True, load=True)
    exit_custom_profit_1 = DecimalParameter(0.01, 0.1, default=0.03, space='exit', decimals=3, optimize=True, load=True)
    exit_custom_rsi_1 = DecimalParameter(30.0, 50.0, default=36.0, space='exit', decimals=2, optimize=True, load=True)
    ...
    exit_custom_under_profit_2 = DecimalParameter(0.01, 0.1, default=0.035, space='exit', decimals=3, optimize=True, load=True)
    exit_custom_under_profit_3 = DecimalParameter(0.05, 0.2, default=0.07, space='exit', decimals=3, optimize=True, load=True)
