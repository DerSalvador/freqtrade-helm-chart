...
class BinClucMadDevelop(IStrategy):
    ...
    # avg 0.41
    # avg 1.29
    entry_params = {'entry_minimum_conditions': 1, 'v6_entry_condition_0_enable': False, 'v6_entry_condition_1_enable': True, 'v6_entry_condition_2_enable': True, 'v6_entry_condition_3_enable': True, 'v8_entry_condition_0_enable': True, 'v8_entry_condition_1_enable': False, 'v8_entry_condition_2_enable': True, 'v8_entry_condition_3_enable': False, 'v8_entry_condition_4_enable': True, 'v9_entry_condition_0_enable': False, 'v9_entry_condition_1_enable': True, 'v9_entry_condition_2_enable': True, 'v9_entry_condition_3_enable': True, 'v9_entry_condition_4_enable': False, 'v9_entry_condition_5_enable': True, 'v9_entry_condition_6_enable': True, 'v9_entry_condition_7_enable': True, 'v9_entry_condition_8_enable': False, 'v9_entry_condition_9_enable': False, 'v9_entry_condition_10_enable': False}
    #############
    # Enable/Disable conditions
    exit_params = {'v9_exit_condition_0_enable': False, 'v8_exit_condition_0_enable': True, 'v8_exit_condition_1_enable': True}
    ...
    exit_custom_roi_profit_1 = DecimalParameter(0.01, 0.03, default=0.02, space='exit', decimals=2, optimize=True, load=True)
    ...
    exit_roi_profit_2 = DecimalParameter(0.02, 0.05, default=0.05, space='exit', decimals=2, optimize=False, load=True)
    exit_roi_rsi_2 = DecimalParameter(34.0, 44.0, default=38, space='exit', decimals=2, optimize=False, load=True)
    exit_roi_profit_3 = DecimalParameter(0.0, 0.0, default=0.03, space='exit', decimals=2, optimize=False, load=True)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[(dataframe['rsi_1h'] < self.entry_rsi_1h_3.value) & (dataframe['rsi'] < self.entry_rsi_1.value) & (dataframe['volume'] < dataframe['volume'].shift() * self.entry_volume_drop_1.value) & (dataframe['volume_mean_slow'] > dataframe['volume_mean_slow'].shift(30) * self.entry_volume_pump_1.value) & (self.v9_entry_condition_8_enable.value == True), 'v9_entry_condition_8_enable'] = 1
        dataframe.loc[(dataframe['rsi_1h'] < self.entry_rsi_1h_4.value) & (dataframe['rsi'] < self.entry_rsi_2.value) & (dataframe['volume'] < dataframe['volume'].shift() * self.entry_volume_drop_1.value) & (dataframe['volume_mean_slow'] > dataframe['volume_mean_slow'].shift(30) * self.entry_volume_pump_1.value) & (self.v9_entry_condition_9_enable.value == True), 'v9_entry_condition_9_enable'] = 1
        dataframe.loc[(dataframe['close'] < dataframe['sma_5']) & (dataframe['ssl_up_1h'] > dataframe['ssl_down_1h']) & (dataframe['ema_50_1h'] > dataframe['ema_200_1h']) & (dataframe['rsi'] < dataframe['rsi_1h'] - 43.276) & (self.v9_entry_condition_10_enable.value == True), 'v9_entry_condition_10_enable'] = 1
        ...
        if self.cust_log_verbose == True:
            for index, row in dataframe.iterrows():
                if row['entry'] == 1:
                    # entry_cond_details = f"count={int(row['conditions_count'])}/bin={int(row['entry_cond_bin'])}/cluc={int(row['entry_cond_cluc'])}/v9_={int(row['entry_cond_long'])}"
