...
class CBPete9(IStrategy):
    ...
    entry_params = {'entry_condition_0_enable': False, 'entry_condition_1_enable': True, 'entry_condition_2_enable': True, 'entry_condition_3_enable': True, 'entry_condition_4_enable': True, 'entry_condition_5_enable': True, 'entry_condition_6_enable': True, 'entry_condition_7_enable': True, 'entry_condition_8_enable': True, 'entry_condition_9_enable': True, 'entry_condition_10_enable': True}
    ############################################################################
    # Buy
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:  # Don't be gready, exit fast
        ...
        dataframe.loc[(dataframe['close'] > dataframe['bb_middleband'] * 1.01) & (dataframe['volume'] > 0), 'exit'] = 1
        return dataframe