...
NNTC_smooth_LSTM:
    ...
    This class trains the model based on smoothed trends

####################################################################################
"""


class NNTC_smooth_LSTM(NNTC):
    ...
    plot_config = {
        ...
        'subplots': {
            "Diff": {
                '%future_smooth': {'color': 'blue'},
                'dwt_smooth': {'color': 'green'},
    ...
    signal_type = TrainingSignals.SignalType.Smooth
