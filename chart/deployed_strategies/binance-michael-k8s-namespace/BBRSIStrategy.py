...
class BBRSIStrategy(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        dataframe.loc[(dataframe['rsi'] > 25) & (dataframe['close'] < dataframe['bb_lowerband_1sd']), 'entry'] = 1
        return dataframe

    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        dataframe.loc[(dataframe['rsi'] > 95) & (dataframe['close'] > dataframe['bb_upperband_1sd']), 'exit'] = 1
        return dataframe