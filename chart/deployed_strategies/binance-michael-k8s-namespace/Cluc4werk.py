...
class Cluc4werk(IStrategy):
    ...
    entry_params = {'bbdelta-close': 0.00793, 'bbdelta-tail': 0.83802, 'close-bblower': 0.0034, 'closedelta-close': 0.00613, 'rocr-1h': 0.64081, 'volume': 21}
    # Sell hyperspace params:
    exit_params = {'exit-bbmiddle-close': 0.97703}
    # ROI table:
    minimal_roi = {'0': 0.0155, '109': 0.01075, '393': 0.00771, '587': 0.00643, '711': 0.00377, '770': 0.00114, '1039': 0}
    # Stoploss:
    stoploss = -0.31742
    # Trailing stop:
    trailing_stop = True
    ...
    def informative_pairs(self):
        ...
        informative_pairs += [('ETH/USD', timeframe), ('BTC/USD', timeframe)]
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[qtpylib.crossed_above(dataframe['close'] * params['exit-bbmiddle-close'], dataframe['bb_middleband']) & (dataframe['volume'] > 0), 'exit'] = 1
        return dataframe