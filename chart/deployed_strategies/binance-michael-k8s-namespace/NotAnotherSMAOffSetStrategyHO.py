...
# # exit_params = {
# #     "base_nb_candles_exit": 17,
# #     "high_offset": 0.997,
# #     "high_offset_2": 1.01,
# # }
# # Sell hyperspace params:
# exit_params = {
#     "base_nb_candles_exit": 7,
#     "high_offset": 1.014,
#     "high_offset_2": 0.995,
# }
# # Buy hyperspace params:
...
#     "low_offset_2": 0.951,
#     "rsi_entry": 54,
#     "base_nb_candles_entry": 16,  # value loaded from strategy
...
# value loaded from strategy
# value loaded from strategy
entry_params = {'ewo_high_2': -4.58, 'low_offset_2': 0.951, 'rsi_entry': 52, 'base_nb_candles_entry': 16, 'ewo_high': 3.422, 'ewo_low': -8.562, 'low_offset': 0.966}
# Sell hyperspace params:
# value loaded from strategy
exit_params = {'base_nb_candles_exit': 10, 'high_offset_2': 1.002, 'high_offset': 1.014}
...
class NotAnotherSMAOffsetStrategyHO(IStrategy):
    INTERFACE_VERSION = 3
    # ROI table:
    minimal_roi = {'0': 0.289, '25': 0.105, '80': 0.038, '140': 0}
    # Stoploss:
    stoploss = -0.35
    # SMAOffset
    base_nb_candles_entry = IntParameter(5, 80, default=entry_params['base_nb_candles_entry'], space='entry', optimize=False)
