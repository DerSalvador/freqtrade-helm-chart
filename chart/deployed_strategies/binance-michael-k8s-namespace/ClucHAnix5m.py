...
class ClucHAnix5m(IStrategy):
    ...
    exit_params = {'pHSL': -0.23, 'pPF_1': 0.02, 'pPF_2': 0.047, 'pSL_1': 0.02, 'pSL_2': 0.046, 'exit-fisher': 0.38414, 'exit-bbmiddle-close': 1.07634}
    # ROI table:
    minimal_roi = {'0': 0.10347601757573865, '3': 0.050495605759981035, '5': 0.03350898081823659, '61': 0.0275218557571848, '125': 0.011112591523667215, '292': 0.005185372158403069, '399': 0}
    # Stoploss:
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        conditions.append(clucHA)  # broken?
        dataframe.loc[is_btc_safe & is_pump_safe & reduce(lambda x, y: x | y, conditions), 'entry'] = 1
        return dataframe
...
class ClucHAnix_BB_RPB_MOD2_ROI_DYNAMIC_TB(ClucHAnix5m):
    ...
    init_trailing_dict = {'trailing_entry_order_started': False, 'trailing_entry_order_uplimit': 0, 'start_trailing_price': 0, 'entry_tag': None, 'start_trailing_time': None, 'offset': 0, 'allow_trailing': True}
