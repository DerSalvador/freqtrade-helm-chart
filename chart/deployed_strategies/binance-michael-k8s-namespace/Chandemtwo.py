...
class Chandemtwo(IStrategy):
    ...
    # ROI table:
    minimal_roi = {'0': 0.75242, '827': 0.39114, '2168': 0.34123, '3527': 0}
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        dataframe.loc[qtpylib.crossed_above(dataframe['CMO'].shift(2), 0) & (dataframe['CMO'].shift(1) >= 0) & (dataframe['CMO'] >= 0), 'entry'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        :return: DataFrame with entry column
        """
        dataframe.loc[qtpylib.crossed_above(dataframe['close'], dataframe['bb_upperband']) | qtpylib.crossed_below(dataframe['CMO'], -35), 'exit'] = 1
        return dataframe