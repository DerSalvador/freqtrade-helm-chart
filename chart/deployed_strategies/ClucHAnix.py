...
class ClucHAnix(IStrategy):
    ...
    exit_params = {'pHSL': -0.178, 'pPF_1': 0.019, 'pPF_2': 0.065, 'pSL_1': 0.019, 'pSL_2': 0.062, 'exit-fisher': 0.38414, 'exit-bbmiddle-close': 1.07634}
    # ROI table:
    minimal_roi = {'0': 0.05, '18': 0.03, '36': 0.015, '72': 0.006, '140': 0}
    # Stoploss:
