kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n bot-ssc-02 exec -it pod/freqtrade-bot-ssc-02-dcb7fc589-9qw8q -c freqtrade -- cat /extra_strategies/utils/Transformer.py
import numpy as np
import pandas as pd
import os, datetime
