kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n bot-mssm-06 exec -it pod/freqtrade-bot-mssm-06-6956d6fbd8-9lpbg -c freqtrade -- cat /freqtrade/user_data/strategies/BB_RTR_dca.py Kalman.py
