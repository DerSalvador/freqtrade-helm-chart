kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n bot-mssm-01 exec -it pod/freqtrade-bot-mssm-01-79b68446b8-kdtsb -c freqtrade -- cat /freqtrade/user_data/strategies/BigTrader.py LSTMRegressor.py
