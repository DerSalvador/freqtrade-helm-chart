kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n binance-adriana-futures exec -it pod/freqtrade-binance-adriana-futures-669f5576b5-2wnwd -c freqtrade -- cat /freqtrade/user_data/strategies/DWT_LongShort.py TaSearchLevelG15m.py
import numpy as np
import scipy.fft
...
class DWT_LongShort(IStrategy):
    ...
    cexit_long_roi_type = CategoricalParameter(['static', 'decay', 'step'], default='decay', space='sell', load=True,
                                          optimize=True)
    cexit_long_roi_time = IntParameter(720, 1440, default=1440, space='sell', load=True, optimize=True)
    cexit_long_roi_start = DecimalParameter(0.09, 0.15, default=0.01, space='sell', load=True, optimize=True)
    cexit_long_roi_end = DecimalParameter(0.15, 0.3, default=0, space='sell', load=True, optimize=True)
    ...
    cexit_short_roi_time = IntParameter(720, 1440, default=1440, space='sell', load=True, optimize=True)
    cexit_short_roi_start = DecimalParameter(0.09, 0.15, default=0.01, space='sell', load=True, optimize=True)
    cexit_short_roi_end = DecimalParameter(0.15, 0.3, default=0, space='sell', load=True, optimize=True)
    ...
    def custom_exit_long(self, pair: str, trade: 'Trade', current_time: 'datetime', current_rate: float,
        ...
        print("Entering custom_exit_long")
        print("Pair:", pair)
    ...
    def custom_exit_short(self, pair: str, trade: 'Trade', current_time: 'datetime', current_rate: float,
        ...
        print("Entering custom_exit_short")
        print("Pair:", pair)
        print("Current Time:", current_time)
        print("Current Rate:", current_rate)
        print("Current Profit:", current_profit)
