kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n binance-adriana-futures exec -it pod/freqtrade-binance-adriana-futures-669f5576b5-2wnwd -c freqtrade -- cat /freqtrade/user_data/strategies/AdxSmasS_v7_Short.py FOttStrategy.py
...
class AdxSmasS_v7_Short(IStrategy):
    INTERFACE_VERSION = 3
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[(dataframe['adx'] < 25) & qtpylib.crossed_above(dataframe['long'], dataframe['short']), 'enter_long'] = 0
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[(dataframe['adx'] > 25) & qtpylib.crossed_above(dataframe['short'], dataframe['long']), 'exit_long'] = 0
        return dataframe
    ...
    def leverage(self, pair: str, current_time: datetime, current_rate: float,
        ...
        return 4
cat: FOttStrategy.py: No such file or directory
