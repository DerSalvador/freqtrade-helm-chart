kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n bot-mssm-03 exec -it pod/freqtrade-bot-mssm-03-7bcbf65bf7-hjf5x -c freqtrade -- cat /freqtrade/user_data/strategies/BB_RPB_TSLmeneguzzo.py Hajo.py
...
class BB_RPB_TSLmeneguzzo(IStrategy):
    ...
    ##
    ##
    entry_params = {'max_slip': 0.983, 'entry_bb_width_1h': 0.954, 'entry_roc_1h': 86, 'entry_threshold': 0.003, 'entry_bb_factor': 0.999, 'entry_bb_delta': 0.025, 'entry_bb_width': 0.095, 'entry_cci': -116, 'entry_cci_length': 25, 'entry_rmi': 49, 'entry_rmi_length': 17, 'entry_srsi_fk': 32, 'entry_closedelta': 17.922, 'entry_ema_diff': 0.026, 'entry_ema_high': 0.968, 'entry_ema_low': 0.935, 'entry_ewo': -5.001, 'entry_rsi': 23, 'entry_rsi_fast': 44, 'entry_ema_high_2': 1.087, 'entry_ema_low_2': 0.97, 'entry_ewo_high_2': 4.179, 'entry_rsi_ewo_2': 35, 'entry_rsi_fast_ewo_2': 45, 'entry_r_deadfish_bb_factor': 1.014, 'entry_r_deadfish_bb_width': 0.299, 'entry_r_deadfish_ema': 1.054, 'entry_r_deadfish_volume_factor': 1.59, 'entry_r_deadfish_cti': -0.115, 'entry_r_deadfish_r14': -44.34, 'entry_clucha_bbdelta_close': 0.049, 'entry_clucha_bbdelta_tail': 1.146, 'entry_clucha_close_bblower': 0.018, 'entry_clucha_closedelta_close': 0.017, 'entry_clucha_rocr_1h': 0.526, 'entry_adx': 13, 'entry_ewo_high': 8.594, 'entry_fastd': 28, 'entry_fastk': 39, 'entry_gumbo_ema': 1.121, 'entry_gumbo_ewo_low': -9.442, 'entry_gumbo_cti': -0.374, 'entry_gumbo_r14': -51.971, 'entry_sqzmom_ema': 0.981, 'entry_sqzmom_ewo': -3.966, 'entry_sqzmom_r14': -45.068, 'entry_nfix_49_cti': -0.105, 'entry_nfix_49_r14': -81.827}
    # exit space
    ##
    ##
    ##
...
def T3(dataframe, length=5):
    ...
    return df['T3Average']cat: Hajo.py: No such file or directory
