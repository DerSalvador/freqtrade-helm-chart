kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n bot-mssm-03 exec -it pod/freqtrade-bot-mssm-03-7bcbf65bf7-hjf5x -c freqtrade -- cat /freqtrade/user_data/strategies/BB_RPB_TSL_RNG_VWAP.py GodStraNew_SMAonly.py
...
class BB_RPB_TSL_RNG_VWAP(IStrategy):
    ...
    # exit space
    exit_params = {'pHSL': -0.25, 'pPF_1': 0.019, 'pPF_2': 0.065, 'pSL_1': 0.019, 'pSL_2': 0.062, 'exit_btc_safe': -389, 'base_nb_candles_exit': 24, 'high_offset': 0.991, 'high_offset_2': 0.997}
    ...
    def custom_stoploss(self, pair: str, trade: 'Trade', current_time: datetime, current_rate: float, current_profit: float, **kwargs) -> float:
        ...
        if len(entry_tags) == 1 and 'vwap' in entry_tags:
            PF_1 = 0.01
            SL_1 = 0.01
            PF_2 = 0.05
            SL_2 = 0.042
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # disabled ewo2 and cofi entry condition
        # is_ewo_2 = (
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        return dataframecat: GodStraNew_SMAonly.py: No such file or directory
