kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n bot-mssm-03 exec -it pod/freqtrade-bot-mssm-03-7bcbf65bf7-hjf5x -c freqtrade -- cat /freqtrade/user_data/strategies/BeastBoxXBLR6.py Kalman.py
...
#  backtesting: freqtrade backtesting -c config_test.json -s BeastBotXBLR6 --timerange 20210920-20220127 --breakdown day -v --enable-protections
#  119 days
# for each conditions
...
class BeastBotXBLR6(IStrategy):
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        return dataframecat: Kalman.py: No such file or directory
