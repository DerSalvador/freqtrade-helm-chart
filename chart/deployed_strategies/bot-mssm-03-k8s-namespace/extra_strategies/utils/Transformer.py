kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n bot-mssm-03 exec -it pod/freqtrade-bot-mssm-03-6dfb97c69f-qx96r -c freqtrade -- cat /extra_strategies/utils/Transformer.py
import numpy as np
import pandas as pd
import os, datetime
