kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n bot-mssm-10 exec -it pod/freqtrade-bot-mssm-10-69d7f8db6c-nlknk -c freqtrade -- cat /extra_strategies/MacheteV8bHedged.py
...
class MacheteV8bHedged(IStrategy):
    ...
    def get_market_condition_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        ssl =  MacheteV8b.SSLChannels_ATR(dataframe, 10)
    ...
    def get_custom_stoploss_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['rmi'] = MacheteV8b.RMI(dataframe, length=24, mom=5)
        ssldown, sslup = MacheteV8b.SSLChannels_ATR(dataframe, length=21)
        dataframe['sroc'] = MacheteV8b.SROC(dataframe, roclen=21, emalen=13, smooth=21)
    ...
    # Custom Stoploss
    #
    def trend_hedge(self, pair, trade, current_time , current_rate, current_profit, **kwargs) -> float:
    ...
    def custom_exit(self, pair: str, trade: Trade, current_time: 'datetime', current_rate: float,
        ...
        self.trend_hedge(self, pair,trade,current_time,current_rate,current_profit,kwargs) # type: ignore
        return None