kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n bot-ssc-05 exec -it pod/freqtrade-bot-ssc-05-8567c779fd-t948m -c freqtrade -- cat /freqtrade/user_data/strategies/AutoArimaTripleV1.py README_MACM1.md tft_model.py
...
class FixedScaler(object):
    ...
    def scale(self, value):
        ...
        return value_std * (self.max_in - self.min_in) + self.min_incat: README_MACM1.md: No such file or directory
cat: tft_model.py: No such file or directory
