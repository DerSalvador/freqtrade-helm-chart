kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n bot-ssc-05 exec -it pod/freqtrade-bot-ssc-05-8567c779fd-t948m -c freqtrade -- cat /freqtrade/user_data/strategies/ADX_15M_USDT2.py DWT_LongShort.py TaSearchLevelH15m.py
