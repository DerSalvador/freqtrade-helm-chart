kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n bot-ssc-05 exec -it pod/freqtrade-bot-ssc-05-8567c779fd-t948m -c freqtrade -- cat /freqtrade/user_data/strategies/Apollo11.py README_Anomaly.md tft_dataformatters_base.py
...
class Apollo11(IStrategy):
    ...
    def custom_stoploss(self, pair: str, trade: Trade, current_time: datetime, current_rate: float, current_profit: float, **kwargs) -> float:
        ...
        return -1cat: README_Anomaly.md: No such file or directory
cat: tft_dataformatters_base.py: No such file or directory
