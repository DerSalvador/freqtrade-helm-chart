kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n binance-juliano-futures exec -it pod/freqtrade-binance-juliano-futures-6f9c6d5f65-gmgmq -c freqtrade -- cat /freqtrade/user_data/strategies/DWT_LongShort_Short.py TaSearchLevelH15m.py
import numpy as np
import scipy.fft
...
class DWT_LongShort_Short(IStrategy):
    ...
    def custom_exit(self, pair: str, trade: 'Trade', current_time: 'datetime', current_rate: float,
        ...
        if trade.is_short:
            print(f'MSSM: Strong Female Character goes Short for {pair}, fine')
            ...
            print(f'MSSM: Strong Female Character tries to go Long for {pair}, No way... only short allowed here')
            return False
