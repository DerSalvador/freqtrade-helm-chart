kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n binance-juliano-futures exec -it pod/freqtrade-binance-juliano-futures-6f9c6d5f65-gmgmq -c freqtrade -- cat /freqtrade/user_data/strategies/AlligatorStrategy.py FSampleStrategy.py
...
class AlligatorStrategy(IStrategy):
    ...
    entry_stoch_rsi = DecimalParameter(0.5, 1, decimals=3, default=0.82, space='entry')
    ...
    plot_config = {'main_plot': {'ema7': {}, 'ema30': {}, 'ema50': {}, 'ema100': {}, 'ema121': {}, 'ema200': {}}, 'subplots': {'STOCH RSI': {'stoch_rsi': {}}}}
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        dataframe.loc[(dataframe['ema7'] > dataframe['ema30']) & (dataframe['ema30'] > dataframe['ema50']) & (dataframe['ema50'] > dataframe['ema100']) & (dataframe['ema100'] > dataframe['ema121']) & (dataframe['ema121'] > dataframe['ema200']) & (dataframe['stoch_rsi'] < self.entry_stoch_rsi.value) & (dataframe['volume'] > 0), 'enter_long'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        dataframe.loc[(dataframe['ema121'] > dataframe['ema7']) & (dataframe['stoch_rsi'] > self.exit_stoch_rsi.value) & (dataframe['volume'] > 0), 'exit_long'] = 1
        return dataframecat: FSampleStrategy.py: No such file or directory
