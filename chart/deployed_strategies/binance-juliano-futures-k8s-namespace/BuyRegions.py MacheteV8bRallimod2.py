kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n binance-juliano-futures exec -it pod/freqtrade-binance-juliano-futures-6f9c6d5f65-gmgmq -c freqtrade -- cat /freqtrade/user_data/strategies/BuyRegions.py MacheteV8bRallimod2.py
# pragma pylint: disable=W0105, C0103, C0114, C0115, C0116, C0301, C0302, C0303, C0325, C0411, C0413,  W1203, W291

"""
####################################################################################
BuyRegions - very simple strategy that just identifies buy/sell regions
...
class BuyRegions(IStrategy):
    ...
    buy_params = {
        ...
        "cexit_profit_nstd": 1.6,
        "entry_bb_factor": 0.97,
        "entry_bb_width": 0.026,
        "entry_guard_metric": -0.2,
        "enable_bb_check": True,  # value loaded from strategy
        "enable_guard_metric": False,  # value loaded from strategy
    ...
    sell_params = {
        "cexit_loss_nstd": 2.9,
        "cexit_metric_overbought": 0.84,
        "cexit_metric_take_profit": 0.88,
        "cexit_min_loss_th": -0.8,
        "exit_bb_factor": 0.78,
    ...
    def custom_exit(self, pair: str, trade: Trade, current_time: "datetime", current_rate: float,
        ...
        return None
cat: MacheteV8bRallimod2.py: No such file or directory
