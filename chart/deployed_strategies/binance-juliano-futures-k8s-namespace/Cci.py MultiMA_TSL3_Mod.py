kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n binance-juliano-futures exec -it pod/freqtrade-binance-juliano-futures-6f9c6d5f65-gmgmq -c freqtrade -- cat /freqtrade/user_data/strategies/Cci.py MultiMA_TSL3_Mod.py
...
class Cci(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        dataframe.loc[dataframe['cci'] < -198, 'entry'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        :return: DataFrame with entry column
        """
        dataframe.loc[dataframe['cci'] > 197, 'exit'] = 1
        return dataframe
    ...
    def resample(self, dataframe, interval, factor):
        ...
        return dataframecat: MultiMA_TSL3_Mod.py: No such file or directory
