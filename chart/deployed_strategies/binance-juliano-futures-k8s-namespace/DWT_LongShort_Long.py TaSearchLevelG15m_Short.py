kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n binance-juliano-futures exec -it pod/freqtrade-binance-juliano-futures-6f9c6d5f65-gmgmq -c freqtrade -- cat /freqtrade/user_data/strategies/DWT_LongShort_Long.py TaSearchLevelG15m_Short.py
import numpy as np
import scipy.fft
...
class DWT_LongShort_Long(IStrategy):
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Short Processing
        dataframe.loc[reduce(lambda x, y: x & y, short_conditions), 'exit_short'] = 0
...
cat: TaSearchLevelG15m_Short.py: No such file or directory
