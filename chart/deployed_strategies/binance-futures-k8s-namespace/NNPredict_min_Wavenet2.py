...
"""
####################################################################################
NNPredict_min_Wavenet2 - uses an Wavenet2 neural network to try and predict the future stock price
...
class NNPredict_min_Wavenet2(NNPredict):
    ...
    def add_indicators(self, dataframe: DataFrame) -> DataFrame:
        ...
        dataframe = self.dataframePopulator.add_indicators(dataframe, dataset_type=DatasetType.MINIMAL)
