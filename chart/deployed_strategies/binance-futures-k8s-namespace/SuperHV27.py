...
class SuperHV27(IStrategy):
    ...
    entry_params = {'adx1': 49, 'adx2': 36, 'adx3': 32, 'adx4': 24, 'emarsi1': 43, 'emarsi2': 27, 'emarsi3': 26, 'emarsi4': 50}
    # Sell hyperspace params:
    exit_params = {'adx2': 36, 'emarsi1': 43, 'emarsi2': 27, 'emarsi3': 26}
    # ROI table:
    minimal_roi = {'0': 0.1, '30': 0.05, '40': 0.025, '60': 0.015, '720': 0.01, '1440': 0}
    # Stoploss:
    stoploss = -0.4
    # connect will participate in hyperopted tables, other methods will not
    # linear, exponential, or connect
    # bigger is faster, recommended to graph f(t) = start-pct * e(-rate*t)      
    # amount of time to reach zero, only relevant for linear decay
    # starting percentage
    # ending percentage 
    dynamic_roi = {'enabled': True, 'type': 'connect', 'decay-rate': 0.015, 'decay-time': 1440, 'start': 0.1, 'end': 0}
