...
class stratfib(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[qtpylib.crossed_above(dataframe['rsi'], self.entry_rsi.value) & (dataframe['dema8'] > dataframe['dema21']) & (dataframe['dema8'] > dataframe['dema89']) & (dataframe['volume'] > 0), 'entry'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Make sure Volume is not 0
        dataframe.loc[qtpylib.crossed_above(dataframe['rsi'], self.exit_rsi.value) & (dataframe['dema8'] < dataframe['dema21']) & (dataframe['dema8'] < dataframe['dema89']) & (dataframe['volume'] > 0), 'exit'] = 1
        return dataframe