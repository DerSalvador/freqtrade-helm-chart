...
class NFI5MOHO_WIP_2(IStrategy):
    ...
    fast_ewo = IntParameter(10, 50, default=50, load=True, space='entry', optimize=True)
    slow_ewo = IntParameter(100, 200, default=200, load=True, space='entry', optimize=True)
    # MA list
    ...
    entry_dip_threshold_12 = DecimalParameter(0.2, 0.5, default=0.66, space='entry', decimals=3, optimize=True, load=True)
    # 24 hours
    entry_pump_pull_threshold_1 = DecimalParameter(1.5, 3.0, default=1.75, space='entry', decimals=2, optimize=True, load=True)
    entry_pump_threshold_1 = DecimalParameter(0.4, 1.0, default=0.5, space='entry', decimals=3, optimize=True, load=True)
    # 36 hours
    ...
    # 48 hours loose
    entry_pump_pull_threshold_9 = DecimalParameter(1.5, 3.0, default=1.4, space='entry', decimals=2, optimize=True, load=True)
    entry_pump_threshold_9 = DecimalParameter(0.4, 1.8, default=1.3, space='entry', decimals=3, optimize=True, load=True)
    ...
    entry_mfi_1 = DecimalParameter(20.0, 40.0, default=26.0, space='entry', decimals=1, optimize=True, load=True)
    entry_volume_2 = DecimalParameter(1.0, 10.0, default=2.6, space='entry', decimals=1, optimize=True, load=True)
    ...
    entry_ema_open_mult_6 = DecimalParameter(0.02, 0.03, default=0.025, space='entry', decimals=3, optimize=True, load=True)
    ...
    entry_ema_rel_7 = DecimalParameter(0.97, 0.999, default=0.986, space='entry', decimals=3, optimize=True, load=True)
    entry_volume_8 = DecimalParameter(1.0, 6.0, default=2.0, space='entry', decimals=1, optimize=True, load=True)
    entry_rsi_8 = DecimalParameter(36.0, 40.0, default=20.0, space='entry', decimals=1, optimize=True, load=True)
    entry_tail_diff_8 = DecimalParameter(3.0, 10.0, default=3.5, space='entry', decimals=1, optimize=True, load=True)
    entry_volume_9 = DecimalParameter(1.0, 4.0, default=1.0, space='entry', decimals=2, optimize=True, load=True)
    entry_ma_offset_9 = DecimalParameter(0.94, 0.99, default=0.97, space='entry', decimals=3, optimize=True, load=True)
    entry_bb_offset_9 = DecimalParameter(0.97, 0.99, default=0.985, space='entry', decimals=3, optimize=True, load=True)
    ...
    entry_mfi_9 = DecimalParameter(36.0, 65.0, default=30.0, space='entry', decimals=1, optimize=True, load=True)
    entry_volume_10 = DecimalParameter(1.0, 8.0, default=2.4, space='entry', decimals=1, optimize=True, load=True)
    entry_ma_offset_10 = DecimalParameter(0.93, 0.97, default=0.944, space='entry', decimals=3, optimize=True, load=True)
    ...
    entry_min_inc_11 = DecimalParameter(0.005, 0.05, default=0.022, space='entry', decimals=3, optimize=True, load=True)
    ...
    entry_rsi_11 = DecimalParameter(30.0, 48.0, default=48.0, space='entry', decimals=1, optimize=True, load=True)
    entry_mfi_11 = DecimalParameter(36.0, 56.0, default=38.0, space='entry', decimals=1, optimize=True, load=True)
    entry_volume_12 = DecimalParameter(1.0, 10.0, default=1.7, space='entry', decimals=1, optimize=True, load=True)
    ...
    entry_ewo_12 = DecimalParameter(2.0, 6.0, default=2.0, space='entry', decimals=1, optimize=True, load=True)
    entry_volume_13 = DecimalParameter(1.0, 10.0, default=1.6, space='entry', decimals=1, optimize=True, load=True)
    entry_ma_offset_13 = DecimalParameter(0.93, 0.98, default=0.978, space='entry', decimals=3, optimize=True, load=True)
    entry_ewo_13 = DecimalParameter(-14.0, -7.0, default=-10.4, space='entry', decimals=1, optimize=True, load=True)
    ...
    entry_bb_offset_14 = DecimalParameter(0.98, 1.0, default=0.986, space='entry', decimals=3, optimize=True, load=True)
    entry_ma_offset_14 = DecimalParameter(0.93, 0.99, default=0.97, space='entry', decimals=3, optimize=True, load=True)
    entry_volume_15 = DecimalParameter(1.0, 10.0, default=2.0, space='entry', decimals=1, optimize=True, load=True)
    entry_ema_open_mult_15 = DecimalParameter(0.02, 0.04, default=0.018, space='entry', decimals=3, optimize=True, load=True)
    entry_ma_offset_15 = DecimalParameter(0.93, 0.99, default=0.954, space='entry', decimals=3, optimize=True, load=True)
    entry_rsi_15 = DecimalParameter(30.0, 50.0, default=28.0, space='entry', decimals=1, optimize=True, load=True)
    ...
    entry_ewo_16 = DecimalParameter(4.0, 8.0, default=2.8, space='entry', decimals=1, optimize=True, load=True)
    entry_volume_17 = DecimalParameter(0.5, 8.0, default=2.0, space='entry', decimals=1, optimize=True, load=True)
    ...
    entry_volume_18 = DecimalParameter(1.0, 6.0, default=2.0, space='entry', decimals=1, optimize=True, load=True)
    ...
    entry_volume_20 = DecimalParameter(0.5, 6.0, default=1.2, space='entry', decimals=1, optimize=True, load=True)
    #entry_ema_rel_20 = DecimalParameter(0.97, 0.999, default=0.988, space='entry', decimals=3, optimize=True, load=True)
    entry_rsi_20 = DecimalParameter(20.0, 36.0, default=26.0, space='entry', decimals=1, optimize=True, load=True)
    entry_rsi_1h_20 = DecimalParameter(14.0, 30.0, default=20.0, space='entry', decimals=1, optimize=True, load=True)
    entry_volume_21 = DecimalParameter(0.5, 6.0, default=3.0, space='entry', decimals=1, optimize=True, load=True)
    #entry_ema_rel_21 = DecimalParameter(0.97, 0.999, default=0.988, space='entry', decimals=3, optimize=True, load=True)
    ...
    exit_custom_profit_1 = DecimalParameter(0.01, 0.1, default=0.03, space='exit', decimals=3, optimize=True, load=True)
    exit_custom_rsi_1 = DecimalParameter(30.0, 50.0, default=38.0, space='exit', decimals=2, optimize=True, load=True)
    exit_custom_profit_2 = DecimalParameter(0.01, 0.1, default=0.05, space='exit', decimals=3, optimize=True, load=True)
    exit_custom_rsi_2 = DecimalParameter(34.0, 50.0, default=43.0, space='exit', decimals=2, optimize=True, load=True)
    exit_custom_profit_3 = DecimalParameter(0.06, 0.3, default=0.08, space='exit', decimals=3, optimize=True, load=True)
    exit_custom_rsi_3 = DecimalParameter(38.0, 55.0, default=48.0, space='exit', decimals=2, optimize=True, load=True)
    exit_custom_profit_4 = DecimalParameter(0.3, 0.6, default=0.25, space='exit', decimals=3, optimize=True, load=True)
    exit_custom_rsi_4 = DecimalParameter(40.0, 58.0, default=50.0, space='exit', decimals=2, optimize=True, load=True)
    ...
    exit_custom_under_profit_2 = DecimalParameter(0.01, 0.1, default=0.04, space='exit', decimals=3, optimize=True, load=True)
    exit_custom_under_rsi_2 = DecimalParameter(46.0, 66.0, default=60.0, space='exit', decimals=1, optimize=True, load=True)
    exit_custom_under_profit_3 = DecimalParameter(0.01, 0.1, default=0.6, space='exit', decimals=3, optimize=True, load=True)
    exit_custom_under_rsi_3 = DecimalParameter(50.0, 68.0, default=62.0, space='exit', decimals=1, optimize=True, load=True)
    exit_custom_dec_profit_1 = DecimalParameter(0.01, 0.1, default=0.05, space='exit', decimals=3, optimize=True, load=True)
    exit_custom_dec_profit_2 = DecimalParameter(0.05, 0.2, default=0.07, space='exit', decimals=3, optimize=True, load=True)
    exit_trail_profit_min_1 = DecimalParameter(0.1, 0.25, default=0.15, space='exit', decimals=3, optimize=True, load=True)
    exit_trail_profit_max_1 = DecimalParameter(0.3, 0.5, default=0.46, space='exit', decimals=2, optimize=True, load=True)
    exit_trail_down_1 = DecimalParameter(0.04, 0.2, default=0.18, space='exit', decimals=3, optimize=True, load=True)
    exit_trail_profit_min_2 = DecimalParameter(0.01, 0.1, default=0.01, space='exit', decimals=3, optimize=True, load=True)
    exit_trail_profit_max_2 = DecimalParameter(0.08, 0.25, default=0.12, space='exit', decimals=2, optimize=True, load=True)
    exit_trail_down_2 = DecimalParameter(0.04, 0.2, default=0.14, space='exit', decimals=3, optimize=True, load=True)
    exit_trail_profit_min_3 = DecimalParameter(0.01, 0.1, default=0.05, space='exit', decimals=3, optimize=True, load=True)
    exit_trail_profit_max_3 = DecimalParameter(0.08, 0.16, default=0.1, space='exit', decimals=2, optimize=True, load=True)
    exit_trail_down_3 = DecimalParameter(0.01, 0.04, default=0.01, space='exit', decimals=3, optimize=True, load=True)
    ...
    def informative_1h_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        informative_1h['safe_pump_24_strict'] = ((informative_1h['open'].rolling(24).max() - informative_1h['close'].rolling(24).min()) / informative_1h['close'].rolling(24).min() < self.entry_pump_threshold_4.value) | ((informative_1h['open'].rolling(24).max() - informative_1h['close'].rolling(24).min()) / self.entry_pump_pull_threshold_4.value > informative_1h['close'] - informative_1h['close'].rolling(24).min())
        informative_1h['safe_pump_36_strict'] = ((informative_1h['open'].rolling(36).max() - informative_1h['close'].rolling(36).min()) / informative_1h['close'].rolling(36).min() < self.entry_pump_threshold_5.value) | ((informative_1h['open'].rolling(36).max() - informative_1h['close'].rolling(36).min()) / self.entry_pump_pull_threshold_5.value > informative_1h['close'] - informative_1h['close'].rolling(36).min())
        informative_1h['safe_pump_48_strict'] = ((informative_1h['open'].rolling(48).max() - informative_1h['close'].rolling(48).min()) / informative_1h['close'].rolling(48).min() < self.entry_pump_threshold_6.value) | ((informative_1h['open'].rolling(48).max() - informative_1h['close'].rolling(48).min()) / self.entry_pump_pull_threshold_6.value > informative_1h['close'] - informative_1h['close'].rolling(48).min())
        informative_1h['safe_pump_24_loose'] = ((informative_1h['open'].rolling(24).max() - informative_1h['close'].rolling(24).min()) / informative_1h['close'].rolling(24).min() < self.entry_pump_threshold_7.value) | ((informative_1h['open'].rolling(24).max() - informative_1h['close'].rolling(24).min()) / self.entry_pump_pull_threshold_7.value > informative_1h['close'] - informative_1h['close'].rolling(24).min())
        informative_1h['safe_pump_36_loose'] = ((informative_1h['open'].rolling(36).max() - informative_1h['close'].rolling(36).min()) / informative_1h['close'].rolling(36).min() < self.entry_pump_threshold_8.value) | ((informative_1h['open'].rolling(36).max() - informative_1h['close'].rolling(36).min()) / self.entry_pump_pull_threshold_8.value > informative_1h['close'] - informative_1h['close'].rolling(36).min())
        informative_1h['safe_pump_48_loose'] = ((informative_1h['open'].rolling(48).max() - informative_1h['close'].rolling(48).min()) / informative_1h['close'].rolling(48).min() < self.entry_pump_threshold_9.value) | ((informative_1h['open'].rolling(48).max() - informative_1h['close'].rolling(48).min()) / self.entry_pump_pull_threshold_9.value > informative_1h['close'] - informative_1h['close'].rolling(48).min())
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        conditions = []
        conditions.append(self.entry_condition_1_enable.value & (dataframe['ema_50_1h'] > dataframe['ema_200_1h']) & (dataframe['sma_200'] > dataframe['sma_200'].shift(50)) & dataframe['safe_dips_strict'] & dataframe['safe_pump_24_1h'] & ((dataframe['close'] - dataframe['open'].rolling(36).min()) / dataframe['open'].rolling(36).min() > self.entry_min_inc_1.value) & (dataframe['rsi_1h'] > self.entry_rsi_1h_min_1.value) & (dataframe['rsi_1h'] < self.entry_rsi_1h_max_1.value) & (dataframe['rsi'] < self.entry_rsi_1.value) & (dataframe['mfi'] < self.entry_mfi_1.value) & (dataframe['volume'] > 0))
        #(dataframe['rsi_1h'] > self.entry_rsi_1h_min_2.value) &
        #(dataframe['rsi_1h'] < self.entry_rsi_1h_max_2.value) &
        conditions.append(self.entry_condition_2_enable.value & (dataframe['sma_200_1h'] > dataframe['sma_200_1h'].shift(50)) & dataframe['safe_pump_24_strict_1h'] & (dataframe['volume_mean_4'] * self.entry_volume_2.value > dataframe['volume']) & (dataframe['rsi'] < dataframe['rsi_1h'] - self.entry_rsi_1h_diff_2.value) & (dataframe['mfi'] < self.entry_mfi_2.value) & (dataframe['close'] < dataframe['bb_lowerband'] * self.entry_bb_offset_2.value) & (dataframe['volume'] > 0))
        conditions.append(self.entry_condition_3_enable.value & (dataframe['close'] > dataframe['ema_200_1h'] * self.entry_ema_rel_3.value) & (dataframe['ema_100'] > dataframe['ema_200']) & (dataframe['ema_100_1h'] > dataframe['ema_200_1h']) & dataframe['safe_pump_36_strict_1h'] & dataframe['lower'].shift().gt(0) & dataframe['bbdelta'].gt(dataframe['close'] * self.entry_bb40_bbdelta_close_3.value) & dataframe['closedelta'].gt(dataframe['close'] * self.entry_bb40_closedelta_close_3.value) & dataframe['tail'].lt(dataframe['bbdelta'] * self.entry_bb40_tail_bbdelta_3.value) & dataframe['close'].lt(dataframe['lower'].shift()) & dataframe['close'].le(dataframe['close'].shift()) & (dataframe['volume'] > 0))
        ...
        conditions.append(self.entry_condition_17_enable.value & dataframe['safe_dips_strict'] & dataframe['safe_pump_24_loose_1h'] & (dataframe['volume_mean_4'] * self.entry_volume_17.value > dataframe['volume']) & (dataframe['close'] < dataframe['ema_20'] * self.entry_ma_offset_17.value) & (dataframe['ewo'] < self.entry_ewo_17.value) & (dataframe['volume'] > 0))
        conditions.append(self.entry_condition_18_enable.value & (dataframe['close'] > dataframe['ema_200_1h']) & (dataframe['ema_100'] > dataframe['ema_200']) & (dataframe['ema_50_1h'] > dataframe['ema_200_1h']) & (dataframe['sma_200'] > dataframe['sma_200'].shift(20)) & (dataframe['sma_200'] > dataframe['sma_200'].shift(44)) & (dataframe['sma_200_1h'] > dataframe['sma_200_1h'].shift(36)) & (dataframe['sma_200_1h'] > dataframe['sma_200_1h'].shift(72)) & dataframe['safe_dips'] & dataframe['safe_pump_24_strict_1h'] & (dataframe['volume_mean_4'] * self.entry_volume_18.value > dataframe['volume']) & (dataframe['rsi'] < self.entry_rsi_18.value) & (dataframe['close'] < dataframe['bb_lowerband'] * self.entry_bb_offset_18.value) & (dataframe['volume'] > 0))
        conditions.append(self.entry_condition_19_enable.value & (dataframe['ema_100_1h'] > dataframe['ema_200_1h']) & (dataframe['sma_200'] > dataframe['sma_200'].shift(36)) & (dataframe['ema_50_1h'] > dataframe['ema_200_1h']) & dataframe['safe_dips'] & dataframe['safe_pump_24_1h'] & (dataframe['close'].shift(1) > dataframe['ema_100_1h']) & (dataframe['low'] < dataframe['ema_100_1h']) & (dataframe['close'] > dataframe['ema_100_1h']) & (dataframe['rsi_1h'] > self.entry_rsi_1h_min_19.value) & (dataframe['chop'] < self.entry_chop_min_19.value) & (dataframe['volume'] > 0))
        conditions.append(self.entry_condition_20_enable.value & (dataframe['ema_50_1h'] > dataframe['ema_200_1h']) & dataframe['safe_dips'] & dataframe['safe_pump_24_loose_1h'] & (dataframe['volume_mean_4'] * self.entry_volume_20.value > dataframe['volume']) & (dataframe['rsi'] < self.entry_rsi_20.value) & (dataframe['rsi_1h'] < self.entry_rsi_1h_20.value) & (dataframe['volume'] > 0))
        conditions.append(self.entry_condition_21_enable.value & (dataframe['ema_50_1h'] > dataframe['ema_200_1h']) & dataframe['safe_dips_strict'] & (dataframe['volume_mean_4'] * self.entry_volume_21.value > dataframe['volume']) & (dataframe['rsi'] < self.entry_rsi_21.value) & (dataframe['rsi_1h'] < self.entry_rsi_1h_21.value) & (dataframe['volume'] > 0))
        for i in self.ma_types:
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if conditions:
            dataframe.loc[reduce(lambda x, y: x | y, conditions), 'exit'] = 0
        return dataframe
