...
class INSIDEUP(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Bullish
        dataframe.loc[((dataframe['close'] < dataframe['close'].shift(2)) | (dataframe['rsi_14'] < 50)) & (dataframe['adx'] > 13.0) & (dataframe['CDL3INSIDE'] >= 0).any(), ['entry', 'entry_tag']] = (1, 'entry_3_inside')
        return dataframe
