...
class TemaPureTwo(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[qtpylib.crossed_above(dataframe['TEMA'], dataframe['bb_lowerbandTA1']) & (dataframe['CMO'] > -0), 'entry'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[qtpylib.crossed_below(dataframe['CMO'], -25), 'exit'] = 1
        return dataframe