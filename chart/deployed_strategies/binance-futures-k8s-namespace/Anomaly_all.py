...
Anomaly_all:
    ...
    This class trains the model based on a combination of all of the available training signals

####################################################################################
"""


class Anomaly_all(Anomaly):
       
       signal_type = TrainingSignals.SignalType.ALL