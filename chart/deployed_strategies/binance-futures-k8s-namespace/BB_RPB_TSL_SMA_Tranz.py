...
def dump_warning(dataframe, entry_threshold):
    ...
    df_threshold = df_past_source * entry_threshold  # BTC dump n% in 5 min
...
def momdiv(dataframe: DataFrame, mom_length: int=10, bb_length: int=20, bb_dev: float=2.0, lookback: int=30) -> DataFrame:
    ...
    df = DataFrame({'momdiv_mom': mom, 'momdiv_upperb': upperband, 'momdiv_lowerb': lowerband, 'momdiv_entry': entry, 'momdiv_exit': exit, 'momdiv_coh': coh, 'momdiv_col': col}, index=dataframe['close'].index)
    return df
...
class BB_RPB_TSL_SMA_Tranz(IStrategy):
    ...
    ############################################################################
    lambo2_ema_14_factor = DecimalParameter(0.9, 0.99, default=entry_params['lambo2_ema_14_factor'], space='entry', optimize=True)
    lambo2_rsi_4_limit = IntParameter(2, 50, default=entry_params['lambo2_rsi_4_limit'], space='entry', optimize=True)
    lambo2_rsi_14_limit = IntParameter(2, 50, default=entry_params['lambo2_rsi_14_limit'], space='entry', optimize=True)
    # SMAOffset
    ...
    ewo_low2 = DecimalParameter(-20.0, -8.0, default=entry_params['ewo_low2'], space='entry', optimize=True)
    ewo_high2 = DecimalParameter(2.0, 12.0, default=entry_params['ewo_high2'], space='entry', optimize=True)
    ...
    rsi_entry2 = IntParameter(30, 70, default=entry_params['rsi_entry2'], space='entry', optimize=True)
    ...
    entry_nfix_39_ema = DecimalParameter(0.9, 1.2, default=0.97, optimize=is_optimize_nfix_39)
    ...
    entry_ema_open_mult_15 = DecimalParameter(0.01, 0.03, default=0.024, optimize=is_optimize_ctt15_protection)
    entry_ma_offset_15 = DecimalParameter(0.93, 0.99, default=0.958, optimize=is_optimize_ctt15_protection)
    entry_rsi_15 = DecimalParameter(20.0, 36.0, default=28.0, optimize=is_optimize_ctt15_protection)
    entry_ema_rel_15 = DecimalParameter(0.97, 0.999, default=0.974, optimize=is_optimize_ctt15_protection)
    is_optimize_ctt25_protection = False
    entry_25_ma_offset = DecimalParameter(0.9, 0.99, default=0.922, optimize=is_optimize_ctt25_protection)
    entry_25_rsi_4 = DecimalParameter(26.0, 40.0, default=38.0, optimize=is_optimize_ctt25_protection)
    entry_25_cti = DecimalParameter(-0.99, -0.4, default=-0.76, optimize=is_optimize_ctt25_protection)
    #NFI 7 SMA
    ...
    max_slip = DecimalParameter(0.33, 1.0, default=0.33, decimals=3, optimize=is_optimize_slip, space='entry', load=True)
    ...
    base_nb_candles_ema_exit = IntParameter(5, 80, default=20, space='exit', optimize=False)
    high_offset_exit_ema = DecimalParameter(0.99, 1.1, default=1.012, space='exit', optimize=False)
    optimize_entry_pump_protection_01 = True
    pump_protection_01_pct_change_timeframe = IntParameter(5, 10, default=8, space='entry', optimize=optimize_entry_pump_protection_01)
    pump_protection_01_pct_change_max = DecimalParameter(0.05, 0.35, default=0.15, space='entry', optimize=optimize_entry_pump_protection_01)
    pump_protection_01_pct_change_min = DecimalParameter(-0.35, -0.05, default=-0.15, space='entry', optimize=optimize_entry_pump_protection_01)
    pump_protection_01_pct_change_short_timeframe = IntParameter(5, 10, default=8, space='entry', optimize=optimize_entry_pump_protection_01)
    pump_protection_01_pct_change_short_max = DecimalParameter(0.05, 0.35, default=0.08, space='entry', optimize=optimize_entry_pump_protection_01)
    pump_protection_01_pct_change_short_min = DecimalParameter(-0.35, -0.05, default=-0.08, space='entry', optimize=optimize_entry_pump_protection_01)
    pump_protection_01_ispumping = DecimalParameter(0.05, 0.35, default=0.2, space='entry', optimize=optimize_entry_pump_protection_01)
    pump_protection_01_islongpumping = DecimalParameter(0.05, 0.35, default=0.24, space='entry', optimize=optimize_entry_pump_protection_01)
    pump_protection_01_isshortpumping = DecimalParameter(0.05, 0.35, default=0.12, space='entry', optimize=optimize_entry_pump_protection_01)
    #Protections
    ...
    def confirm_trade_entry(self, pair: str, order_type: str, amount: float, rate: float, time_in_force: str, **kwargs) -> bool:
        ...
        self.custom_info[pair][self.SELLMA] = dataframe['ema_exit']
        return True
    ...
    def normal_tf_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        dataframe = dump_warning(dataframe, self.entry_threshold.value)
        # pump detector
        dataframe['pump'] = pump_warning(dataframe, perc=int(self.max_change_pump))  #25% di pump
        dataframe['recentispumping'] = pump_warning2(dataframe, {'pct_change_timeframe': self.pump_protection_01_pct_change_timeframe.value, 'pct_change_max': self.pump_protection_01_pct_change_max.value, 'pct_change_min': self.pump_protection_01_pct_change_min.value, 'pct_change_short_timeframe': self.pump_protection_01_pct_change_short_timeframe.value, 'pct_change_short_max': self.pump_protection_01_pct_change_short_max.value, 'pct_change_short_min': self.pump_protection_01_pct_change_short_min.value, 'ispumping': self.pump_protection_01_ispumping.value, 'islongpumping': self.pump_protection_01_islongpumping.value, 'isshortpumping': self.pump_protection_01_isshortpumping.value, 'ispumping_rolling': 6, 'islongpumping_rolling': 12, 'isshortpumping_rolling': 3, 'recentispumping_rolling': 60})
        ...
        #TRIMA
        dataframe['trima_offset_entry'] = ta.TRIMA(dataframe, int(self.base_nb_candles_entry_trima.value)) * self.low_offset_trima.value
        dataframe['trima_offset_entry2'] = ta.TRIMA(dataframe, int(self.base_nb_candles_entry_trima2.value)) * self.low_offset_trima2.value
        #ZEMA
    ...
    def populate_btc_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        informative = dump_warning(informative, self.entry_threshold.value)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        entry_profit = dataframe['close_1h'].rolling(24).max() > dataframe['close'] * 1.03
        nfi7_sma_protection = (dataframe[f'ema_{self.entry_12_protection__ema_fast_len.value}'] > dataframe['ema_200']) & (dataframe[f'ema_{self.entry_12_protection__ema_slow_len.value}_1h'] > dataframe['ema_200_1h']) & (dataframe['close'] > dataframe[f'ema_{self.entry_12_protection__close_above_ema_fast_len.value}']) & (dataframe['close'] > dataframe[f'ema_{self.entry_12_protection__close_above_ema_slow_len.value}_1h']) & (dataframe['sma_200'] > dataframe['sma_200'].shift(int(self.entry_12_protection__sma200_rising_val.value))) & (dataframe['sma_200_1h'] > dataframe['sma_200_1h'].shift(int(self.entry_12_protection__sma200_1h_rising_val.value))) & dataframe[f'safe_dips_{self.entry_12_protection__safe_dips_type.value}'] & dataframe[f'safe_pump_{self.entry_12_protection__safe_pump_period.value}_{self.entry_12_protection__safe_pump_type.value}_1h']
        is_can_entry_smooth_ha = (dataframe['close'] < dataframe['Smooth_HA_L']) & (dataframe['Smooth_HA_O'].shift(1) < dataframe['Smooth_HA_H'].shift(1))
        is_can_entry_rsi = (dataframe['rsi_fast'] < self.entry_rsi_fast.value) & (dataframe['r_84'] < 60) & (dataframe['r_112'] < 60) & ((dataframe['close'] < dataframe['ema_offset_entry']) & (dataframe['pm'] <= dataframe['pmax_thresh']) & ((dataframe['EWO'] < self.ewo_low.value) | (dataframe['EWO'] > self.ewo_high.value) & (dataframe['rsi'] < self.rsi_entry.value)) | (dataframe['close'] < dataframe['ema_offset_entry2']) & (dataframe['pm'] > dataframe['pmax_thresh']) & ((dataframe['EWO'] < self.ewo_low2.value) | (dataframe['EWO'] > self.ewo_high2.value) & (dataframe['rsi'] < self.rsi_entry2.value)))
        ...
        is_btc_safe = dataframe['btc_5m_1d_diff'] > dataframe['btc_1d'] * self.entry_btc_safe_1d.value
        #(dataframe['btc_diff'] > self.entry_btc_safe.value) &
        is_btc_not_safe = dataframe['btc_5m_1d_diff'] < dataframe['btc_1d'] * self.entry_btc_safe_1d.value
        is_real_dip = dataframe['slice_low'].min() < dataframe['low'] * 1.05
        #is_real_no_pump = (
        #        (dataframe['slice_high'].shift(1).max() <= (dataframe['high'] * 1.1 ))
        #    )
        #is_real_dip &
        is_pair_safe = (dataframe['pair_diff'] > self.entry_btc_safe.value) & (dataframe['pair_5m_1d_diff'] > dataframe['pair_1d'] * self.entry_btc_safe_1d.value)
        is_MMA_prot = (dataframe['roc_1h'] < self.entry_roc_1h.value) & (dataframe['bb_width_1h'] < self.entry_bb_width_1h.value) & (dataframe['close_1h'].rolling(288).max() >= dataframe['close'] * 1.03) & (dataframe['close'] < dataframe['ema_exit'] * self.high_offset_exit_ema.value) & (dataframe['sqzmi'] == False) & (dataframe['volume'] > 0) & (dataframe['volume'] < dataframe['volume'].shift() * 4)
        ...
        is_r_deadfish = is_standart_prot & (dataframe['ema_100'] < dataframe['ema_200'] * self.entry_r_deadfish_ema.value) & (dataframe['bb_width'] > self.entry_r_deadfish_bb_width.value) & (dataframe['close'] < dataframe['bb_middleband2'] * self.entry_r_deadfish_bb_factor.value) & (dataframe['volume_mean_12'] > dataframe['volume_mean_24'] * self.entry_r_deadfish_volume_factor.value) & (dataframe['cti'] < self.entry_r_deadfish_cti.value) & (dataframe['r_14'] < self.entry_r_deadfish_r14.value)
        is_gumbo = is_standart_prot & (dataframe['EWO'] < self.entry_gumbo_ewo_low.value) & (dataframe['bb_middleband2_1h'] >= dataframe['T3_1h']) & (dataframe['T3'] <= dataframe['ema_8'] * self.entry_gumbo_ema.value) & (dataframe['cti'] < self.entry_gumbo_cti.value) & (dataframe['r_14'] < self.entry_gumbo_r14.value)
        is_sqzmom = is_standart_prot & is_sqzOff & (dataframe['linreg_val_20'].shift(2) > dataframe['linreg_val_20'].shift(1)) & (dataframe['linreg_val_20'].shift(1) < dataframe['linreg_val_20']) & (dataframe['linreg_val_20'] < 0) & (dataframe['close'] < dataframe['ema_13'] * self.entry_sqzmom_ema.value) & (dataframe['EWO'] < self.entry_sqzmom_ewo.value) & (dataframe['r_14'] < self.entry_sqzmom_r14.value)
        # NFI quick mode, credit goes to @iterativ
        is_nfi_13 = is_standart_prot & (dataframe['ema_50_1h'] > dataframe['ema_100_1h']) & (dataframe['close'] < dataframe['sma_30'] * 0.99) & (dataframe['cti'] < -0.92) & (dataframe['EWO'] < -5.585) & (dataframe['cti_1h'] < -0.88) & (dataframe['crsi_1h'] > 10.0)  # NFIX 26
        is_nfi_32 = is_standart_prot & (dataframe['rsi_slow'] < dataframe['rsi_slow'].shift(1)) & (dataframe['rsi_fast'] < 46) & (dataframe['rsi'] > 25.0) & (dataframe['close'] < dataframe['sma_15'] * 0.93) & (dataframe['cti'] < -0.9)
        is_nfi_33 = is_standart_prot & (dataframe['close'] < dataframe['ema_13'] * 0.978) & (dataframe['EWO'] > 8) & (dataframe['cti'] < -0.88) & (dataframe['rsi'] < 32) & (dataframe['r_14'] < -98.0) & (dataframe['volume'] < dataframe['volume_mean_4'] * 2.5)
        is_nfi_38 = is_standart_prot & (dataframe['pm'] > dataframe['pmax_thresh']) & (dataframe['close'] < dataframe['sma_75'] * 0.98) & (dataframe['EWO'] < -4.4) & (dataframe['cti'] < -0.95) & (dataframe['r_14'] < -97) & (dataframe['crsi_1h'] > 0.5)
        is_nfix_5 = is_standart_prot & (dataframe['ema_200_1h'] > dataframe['ema_200_1h'].shift(12)) & (dataframe['ema_200_1h'].shift(12) > dataframe['ema_200_1h'].shift(24)) & (dataframe['close'] < dataframe['sma_75'] * 0.932) & (dataframe['EWO'] > 3.6) & (dataframe['cti'] < -0.9) & (dataframe['r_14'] < -97.0)
        is_nfix_12 = is_standart_prot & (dataframe['close'] < dataframe['ema_20'] * 0.932) & (dataframe['EWO'] > 0.1) & (dataframe['rsi_14'] < 40.0) & (dataframe['cti'] < -0.9) & (dataframe['r_480_1h'] < -20.0)
        is_nfix_49 = is_standart_prot & (dataframe['ema_26'].shift(3) > dataframe['ema_12'].shift(3)) & (dataframe['ema_26'].shift(3) - dataframe['ema_12'].shift(3) > dataframe['open'].shift(3) * 0.032) & (dataframe['ema_26'].shift(9) - dataframe['ema_12'].shift(9) > dataframe['open'].shift(3) / 100) & (dataframe['close'].shift(3) < dataframe['ema_20'].shift(3) * 0.916) & (dataframe['rsi'].shift(3) < 32.5) & (dataframe['crsi'].shift(3) > 18.0) & (dataframe['cti'] < self.entry_nfix_49_cti.value) & (dataframe['r_14'] < self.entry_nfix_49_r14.value)
        is_nfi7_37 = is_standart_prot & (dataframe['pm'] > dataframe['pmax_thresh']) & (dataframe['close'] < dataframe['sma_75'] * 0.98) & (dataframe['EWO'] > 9.8) & (dataframe['rsi'] < 56.0) & (dataframe['cti'] < -0.7) & dataframe['safe_dump_50_1h']
        ## BB MODDED
        is_nfi_ctt35 = is_standart_prot & (dataframe['pm'] <= dataframe['pmax_thresh']) & (dataframe['close'] < dataframe['sma_75'] * 0.984) & (dataframe['EWO'] > 9.6) & (dataframe['rsi_14'] < 32.0) & (dataframe['cti'] < -0.5)
        is_nfi_ctt25 = is_standart_prot & (dataframe['rsi_20'] < dataframe['rsi_20'].shift()) & (dataframe['rsi_4'] < self.entry_25_rsi_4.value) & (dataframe['ema_20_1h'] > dataframe['ema_26_1h']) & (dataframe['close'] < dataframe['sma_20'] * self.entry_25_ma_offset.value) & (dataframe['open'] > dataframe['sma_20'] * self.entry_25_ma_offset.value) & ((dataframe['open'] < dataframe['ema_20_1h']) & (dataframe['low'] < dataframe['ema_20_1h']) | (dataframe['open'] > dataframe['ema_20_1h']) & (dataframe['low'] > dataframe['ema_20_1h'])) & (dataframe['cti'] < self.entry_25_cti.value)
        is_nfi_ctt15 = is_standart_prot & (dataframe['close'] > dataframe['ema_200_1h'] * self.entry_ema_rel_15.value) & (dataframe['ema_26'] > dataframe['ema_12']) & (dataframe['ema_26'] - dataframe['ema_12'] > dataframe['open'] * self.entry_ema_open_mult_15.value) & (dataframe['ema_26'].shift() - dataframe['ema_12'].shift() > dataframe['open'] / 100) & (dataframe['rsi_14'] < self.entry_rsi_15.value) & (dataframe['close'] < dataframe['ema_20'] * self.entry_ma_offset_15.value)
        is_nfi_9 = is_standart_prot & (dataframe['ema_50'] > dataframe['ema_200']) & (dataframe['close'] < dataframe['ema_20'] * 0.968) & (dataframe['close'] < dataframe['bb20_2_low'] * 0.982) & (dataframe['mfi'] < 50.0) & (dataframe['cti'] < -0.85) & (dataframe['r_14'] < -94.0) & (dataframe['rsi_14_1h'] > 20.0) & (dataframe['rsi_14_1h'] < 88.0) & (dataframe['crsi_1h'] > 21.0)
        is_nfi_26 = is_standart_prot & (dataframe['close'] < dataframe['zema_61'] * 0.9405) & (dataframe['cti'] < -0.72) & (dataframe['cci'] < -166.0) & (dataframe['r_14'] < -98.0) & (dataframe['cti_1h'] < 0.95) & (dataframe['volume'] < dataframe['volume_mean_4'] * 2.0)
        is_nfix_54 = is_standart_prot & (dataframe['ema_200'] > dataframe['ema_200'].shift(12) * 1.01) & (dataframe['ema_200'] > dataframe['ema_200'].shift(48) * 1.07) & dataframe['bb40_2_low'].shift().gt(0) & dataframe['bb40_2_delta'].gt(dataframe['close'] * 0.056) & dataframe['closedelta'].gt(dataframe['close'] * 0.01) & dataframe['tail'].lt(dataframe['bb40_2_delta'] * 0.5) & dataframe['close'].lt(dataframe['bb40_2_low'].shift()) & dataframe['close'].le(dataframe['close'].shift()) & (dataframe['close'] > dataframe['ema_50'] * 0.925)
        is_nfix_53 = is_standart_prot & (dataframe['ema_200_1h'] > dataframe['ema_200_1h'].shift(12)) & (dataframe['ema_200_1h'].shift(12) > dataframe['ema_200_1h'].shift(24)) & (dataframe['ema_200_1h'].shift(24) > dataframe['ema_200_1h'].shift(36)) & (dataframe['ema_26_15m'] > dataframe['ema_12_15m']) & (dataframe['ema_26_15m'] - dataframe['ema_12_15m'] > dataframe['open_15m'] * 0.02) & (dataframe['ema_26_15m'].shift(3) - dataframe['ema_12_15m'].shift(3) > dataframe['open_15m'] / 100) & (dataframe['close_15m'] < dataframe['bb20_2_low_15m'] * 0.99) & (dataframe['r_14'] < -90.0) & (dataframe['cti_1h'] > -0.7)
        is_nfix_52 = is_standart_prot & (dataframe['ema_26_15m'] > dataframe['ema_12_15m']) & (dataframe['ema_26_15m'] - dataframe['ema_12_15m'] > dataframe['open_15m'] * 0.032) & (dataframe['ema_26_15m'].shift(3) - dataframe['ema_12_15m'].shift(3) > dataframe['open_15m'] / 100) & (dataframe['close_15m'] < dataframe['bb20_2_low_15m'] * 0.998) & (dataframe['crsi_1h'] > 10.0)
        is_nfix_51 = is_standart_prot & (dataframe['close_15m'] < dataframe['ema_16_15m'] * 0.944) & (dataframe['ewo_15m'] < -1.0) & (dataframe['rsi_14_15m'] > 28.0) & (dataframe['cti_15m'] < -0.84) & (dataframe['r_14_15m'] < -94.0) & (dataframe['rsi_14'] > 30.0) & (dataframe['crsi_1h'] > 1.0)
        is_nfix_48 = is_standart_prot & (dataframe['close_15m'].shift(3) < dataframe['sma_15_15m'].shift(3) * 0.95) & (dataframe['close_15m'] > dataframe['open_15m'].shift(3)) & (dataframe['ewo_15m'] > 2.8) & (dataframe['cti_15m'] < -0.75) & (dataframe['r_14_15m'].shift(3) < -94.0) & (dataframe['cti'] < -0.5) & (dataframe['cti_1h'] < 0.1) & (dataframe['crsi_1h'] > 18.0)
        is_nfix_47 = is_standart_prot & (dataframe['rsi_14_15m'] < dataframe['rsi_14_15m'].shift(3)) & (dataframe['ema_20_1h'] > dataframe['ema_25_1h']) & (dataframe['close_15m'] < dataframe['sma_15_15m'] * 0.95) & ((dataframe['open_15m'] < dataframe['ema_20_1h']) & (dataframe['low_15m'] < dataframe['ema_20_1h']) | (dataframe['open_15m'] > dataframe['ema_20_1h']) & (dataframe['low_15m'] > dataframe['ema_20_1h'])) & (dataframe['cti_15m'] < -0.9) & (dataframe['r_14_15m'] < -90.0) & (dataframe['r_14'] < -97.0) & (dataframe['cti_1h'] < 0.1) & (dataframe['crsi_1h'] > 8.0)
        is_nfix_41 = is_standart_prot & (dataframe['ema_12_15m'] > dataframe['ema_200_1h']) & (dataframe['ema_26_15m'] > dataframe['ema_12_15m']) & (dataframe['ema_26_15m'] - dataframe['ema_12_15m'] > dataframe['open_15m'] * 0.03) & (dataframe['ema_26_15m'].shift(3) - dataframe['ema_12_15m'].shift(3) > dataframe['open_15m'] / 100) & (dataframe['close_15m'] < dataframe['bb20_2_low_15m'] * 0.99)
        is_nfix_36 = is_standart_prot & (dataframe['ema_200'] > dataframe['ema_200'].shift(36) * 1.035) & (dataframe['close'] < dataframe['ema_20'] * 0.956) & (dataframe['rsi_14'] < 34.0) & (dataframe['r_64'] < -80.0) & (dataframe['cti'] < -0.5) & (dataframe['r_480_1h'] < -30.0)
        is_nfix_204 = is_standart_prot & (dataframe['pm'] > dataframe['pmax_thresh']) & (dataframe['close'] < dataframe['sma_75'] * 0.98) & (dataframe['EWO'] < -4.4) & (dataframe['cti'] < -0.95) & (dataframe['r_14'] < -97.0) & (dataframe['crsi_1h'] > 0.5)
        is_nfix_203 = is_standart_prot & (dataframe['ema_50_1h'] > dataframe['ema_100_1h']) & (dataframe['close'] < dataframe['sma_30'] * 0.99) & (dataframe['cti'] < -0.92) & (dataframe['EWO'] < -6.0) & (dataframe['cti_1h'] < -0.88) & (dataframe['crsi_1h'] > 10.0)
        is_nfix_202 = is_standart_prot & (dataframe['close'] > dataframe['ema_200_1h'] * 0.84) & (dataframe['ema_26'] > dataframe['ema_12']) & (dataframe['ema_26'] - dataframe['ema_12'] > dataframe['open'] * 0.02) & (dataframe['ema_26'].shift() - dataframe['ema_12'].shift() > dataframe['open'] / 100) & (dataframe['close'] < dataframe['bb20_2_low'] * 0.999) & (dataframe['cti'] < -0.5) & (dataframe['rsi_14'] > 25.0) & (dataframe['mfi'] > 18.0) & (dataframe['r_14'] < -94.0) & (dataframe['r_14'].shift(1) < -94.0) & (dataframe['crsi_1h'] > 12.0) & (dataframe['volume'] < dataframe['volume_mean_4'] * 1.6)
        is_nfix_201 = is_standart_prot & (dataframe['rsi_20'] < dataframe['rsi_20'].shift()) & (dataframe['rsi_4'] < 30.0) & (dataframe['ema_20_1h'] > dataframe['ema_26_1h']) & (dataframe['close'] < dataframe['sma_15'] * 0.953) & (dataframe['cti'] < -0.78) & (dataframe['cci'] < -200.0)
        is_nfix_34 = is_standart_prot & (dataframe['close'] < dataframe['ema_50']) & (dataframe['close'] < dataframe['bb20_2_low'] * 0.972) & (dataframe['cti'] < -0.8) & (dataframe['rsi_14'] < 18.0)
        is_nfix_28 = is_standart_prot & (dataframe['close'] < dataframe['sma_75'] * 0.96) & (dataframe['EWO'] < -8.0) & (dataframe['cti'] < -0.9) & (dataframe['r_14'] < -97.0) & (dataframe['crsi_1h'] > 14.0)
        is_nfix_27 = is_standart_prot & (dataframe['close'] < dataframe['sma_75'] * 0.934) & (dataframe['EWO'] > 6.4) & (dataframe['rsi_14'] < 32.0) & (dataframe['cti'] < -0.8) & (dataframe['r_14'] < -96.0)
        is_nfix_19 = is_standart_prot & (dataframe['ema_200_1h'] > dataframe['ema_200_1h'].shift(12)) & (dataframe['ema_200_1h'].shift(12) > dataframe['ema_200_1h'].shift(24)) & dataframe['bb40_2_low'].shift().gt(0) & dataframe['bb40_2_delta'].gt(dataframe['close'] * 0.045) & dataframe['closedelta'].gt(dataframe['close'] * 0.02) & dataframe['tail'].lt(dataframe['bb40_2_delta'] * 0.28) & dataframe['close'].lt(dataframe['bb40_2_low'].shift()) & dataframe['close'].le(dataframe['close'].shift()) & (dataframe['cti'] < -0.9) & (dataframe['cti_1h'] > -0.75) & (dataframe['cti_1h'] < 0.25)
        is_nfix_11 = is_standart_prot & (dataframe['ema_26'] > dataframe['ema_12']) & (dataframe['ema_26'] - dataframe['ema_12'] > dataframe['open'] * 0.027) & (dataframe['ema_26'].shift() - dataframe['ema_12'].shift() > dataframe['open'] / 100) & (dataframe['close'] < dataframe['ema_20'] * 0.932) & (dataframe['rsi_14'] < 25.0)
        is_nfix_9 = is_standart_prot & (dataframe['ema_50_1h'] > dataframe['ema_100_1h']) & (dataframe['close'] < dataframe['sma_30'] * 0.99) & (dataframe['cti'] < -0.92) & (dataframe['EWO'] < -5.0) & (dataframe['cti_1h'] < -0.88) & (dataframe['crsi_1h'] > 20.0)
        is_nfix_36 = is_standart_prot & (dataframe['ema_200'] > dataframe['ema_200'].shift(36) * 1.035) & (dataframe['close'] < dataframe['ema_20'] * 0.956) & (dataframe['rsi_14'] < 34.0) & (dataframe['r_64'] < -80.0) & (dataframe['cti'] < -0.5) & (dataframe['r_480_1h'] < -30.0)
        is_nfi_sma_2 = is_standart_prot & (dataframe['rsi'] < dataframe['rsi_1h'] - self.entry_rsi_1h_diff_2.value) & (dataframe['mfi'] < self.entry_mfi_2.value) & (dataframe['close'] < dataframe['bb20_2_low'] * self.entry_bb_offset_2.value) & (dataframe['volume'] > 0)
        is_nfi_sma_3 = is_standart_prot & dataframe['bb40_2_low'].shift().gt(0) & dataframe['bb40_2_delta'].gt(dataframe['close'] * self.entry_bb40_bbdelta_close_3.value) & dataframe['closedelta'].gt(dataframe['close'] * self.entry_bb40_closedelta_close_3.value) & dataframe['tail'].lt(dataframe['bb40_2_delta'] * self.entry_bb40_tail_bbdelta_3.value) & dataframe['close'].lt(dataframe['bb40_2_low'].shift()) & dataframe['close'].le(dataframe['close'].shift()) & (dataframe['volume'] > 0)
        is_nfi_sma_4 = is_standart_prot & (dataframe['close'] < dataframe['ema_50']) & (dataframe['close'] < self.entry_bb20_close_bblowerband_4.value * dataframe['bb20_2_low']) & (dataframe['volume'] < dataframe['volume_mean_30'].shift(1) * self.entry_bb20_volume_4.value)
        is_nfi_sma_5 = is_standart_prot & (dataframe['ema_26'] > dataframe['ema_12']) & (dataframe['ema_26'] - dataframe['ema_12'] > dataframe['open'] * self.entry_ema_open_mult_5.value) & (dataframe['ema_26'].shift() - dataframe['ema_12'].shift() > dataframe['open'] / 100) & (dataframe['close'] < dataframe['bb20_2_low'] * self.entry_bb_offset_5.value) & (dataframe['volume'] > 0)
        is_nfi_sma_6 = is_standart_prot & (dataframe['ema_26'] > dataframe['ema_12']) & (dataframe['ema_26'] - dataframe['ema_12'] > dataframe['open'] * self.entry_ema_open_mult_6.value) & (dataframe['ema_26'].shift() - dataframe['ema_12'].shift() > dataframe['open'] / 100) & (dataframe['close'] < dataframe['bb20_2_low'] * self.entry_bb_offset_6.value) & (dataframe['volume'] > 0)
        is_nfi_sma_7 = is_standart_prot & (dataframe['ema_26'] > dataframe['ema_12']) & (dataframe['ema_26'] - dataframe['ema_12'] > dataframe['open'] * self.entry_ema_open_mult_7.value) & (dataframe['ema_26'].shift() - dataframe['ema_12'].shift() > dataframe['open'] / 100) & (dataframe['rsi'] < self.entry_rsi_7.value) & (dataframe['volume'] > 0)
        is_nfi_sma_9 = is_standart_prot & (dataframe['close'] < dataframe['ema_20'] * self.entry_ma_offset_9.value) & (dataframe['close'] < dataframe['bb20_2_low'] * self.entry_bb_offset_9.value) & (dataframe['rsi_1h'] > self.entry_rsi_1h_min_9.value) & (dataframe['rsi_1h'] < self.entry_rsi_1h_max_9.value) & (dataframe['mfi'] < self.entry_mfi_9.value) & (dataframe['volume'] > 0)
        is_nfi_sma_10 = is_standart_prot & (dataframe['close'] < dataframe['sma_30'] * self.entry_ma_offset_10.value) & (dataframe['close'] < dataframe['bb20_2_low'] * self.entry_bb_offset_10.value) & (dataframe['rsi_1h'] < self.entry_rsi_1h_10.value) & (dataframe['volume'] > 0)
        is_nfi_sma_12 = is_standart_prot & (dataframe['close'] < dataframe['sma_30'] * self.entry_ma_offset_12.value) & (dataframe['EWO'] > self.entry_ewo_12.value) & (dataframe['rsi'] < self.entry_rsi_12.value) & (dataframe['volume'] > 0)
        is_nfi_sma_15 = is_standart_prot & (dataframe['ema_26'] > dataframe['ema_12']) & (dataframe['ema_26'] - dataframe['ema_12'] > dataframe['open'] * self.entry_ema_open_mult_15.value) & (dataframe['ema_26'].shift() - dataframe['ema_12'].shift() > dataframe['open'] / 100) & (dataframe['rsi'] < self.entry_rsi_15.value) & (dataframe['close'] < dataframe['ema_20'] * self.entry_ma_offset_15.value) & (dataframe['volume'] > 0)
        is_nfi_sma_16 = is_standart_prot & (dataframe['close'] < dataframe['ema_20'] * self.entry_ma_offset_16.value) & (dataframe['EWO'] > self.entry_ewo_16.value) & (dataframe['rsi'] < self.entry_rsi_16.value) & (dataframe['volume'] > 0)
        is_nfi_sma_17 = is_standart_prot & (dataframe['close'] < dataframe['ema_20'] * self.entry_ma_offset_17.value) & (dataframe['EWO'] < self.entry_ewo_17.value) & (dataframe['volume'] > 0)
        ...
        is_nfi_sma_23 = is_standart_prot & (dataframe['close'] < dataframe['bb20_2_low'] * self.entry_bb_offset_23.value) & (dataframe['EWO'] > self.entry_ewo_23.value) & (dataframe['rsi'] < self.entry_rsi_23.value) & (dataframe['rsi_1h'] < self.entry_rsi_1h_23.value) & (dataframe['volume'] > 0)  # Make sure Volume is not 0
        is_btc_safe = (pct_change(dataframe['btc_1d'], dataframe['btc_5m']).fillna(0) > self.entry_btc_safe_1d.value) & (dataframe['volume'] > 0)
        is_nasos_1 = is_standart_prot & (dataframe['rsi_fast'] < self.rsi_fast_entry.value) & (dataframe['close'] < dataframe[f'ma_entry_{self.base_nb_candles_entry.value}'] * self.low_offset_2.value) & (dataframe['EWO2'] > self.ewo_high_2.value) & (dataframe['rsi'] < self.rsi_entry.value) & (dataframe['volume'] > 0) & (dataframe['close'] < dataframe[f'ma_exit_{self.base_nb_candles_exit.value}'] * self.high_offset.value) & (dataframe['rsi'] < 25)
        is_nasos_2 = is_standart_prot & (dataframe['rsi_fast2'] < self.rsi_fast_entry.value) & (dataframe['close'] < dataframe[f'ma_entry_{self.base_nb_candles_entry.value}'] * self.low_offset.value) & (dataframe['EWO2'] < self.ewo_low.value) & (dataframe['volume'] > 0) & (dataframe['close'] < dataframe[f'ma_exit_{self.base_nb_candles_exit.value}'] * self.high_offset.value)
        is_VWAP = is_standart_prot & (is_MMA_prot | nfi7_sma_protection) & (dataframe['close'] < dataframe['vwap_low']) & (dataframe['tcp_percent_4'] > 0.04) & (dataframe['cti'] < -0.8) & (dataframe['rsi'] < 35) & (dataframe['rsi_84'] < 60) & (dataframe['rsi_112'] < 60) & (dataframe['volume'] > 0)
        is_fama = is_btc_safe & is_pair_safe & is_can_entry_rsi & is_real_dip & nfi7_sma_protection & is_additional_check & is_can_entry_smooth_ha & entry_profit & (dataframe['close'].rolling(288).max() >= dataframe['close'] * 1.5) & qtpylib.crossed_above(dataframe['mama'], dataframe['fama']) & (dataframe['mama'].shift() > dataframe['mama'] * 0.99)
        is_hma = is_btc_safe & is_pair_safe & is_can_entry_rsi & is_real_dip & nfi7_sma_protection & is_additional_check & is_can_entry_smooth_ha & entry_profit & (((dataframe['close'] < dataframe['hma_offset_entry']) & (dataframe['pm'] <= dataframe['pmax_thresh']) & (dataframe['rsi'] < 35) | (dataframe['close'] < dataframe['hma_offset_entry2']) & (dataframe['pm'] > dataframe['pmax_thresh']) & (dataframe['rsi'] < 30)) & (dataframe['rsi_fast'] < 30))
        is_trima = is_btc_safe & is_pair_safe & is_can_entry_rsi & is_real_dip & nfi7_sma_protection & is_additional_check & is_can_entry_smooth_ha & entry_profit & ((dataframe['close'] < dataframe['trima_offset_entry']) & (dataframe['pm'] <= dataframe['pmax_thresh']) | (dataframe['close'] < dataframe['trima_offset_entry2']) & (dataframe['pm'] > dataframe['pmax_thresh']))
        is_zema = is_btc_safe & is_pair_safe & is_can_entry_rsi & is_real_dip & nfi7_sma_protection & is_additional_check & is_can_entry_smooth_ha & entry_profit & ((dataframe['close'] < dataframe['zema_offset_entry']) & (dataframe['pm'] <= dataframe['pmax_thresh']) | (dataframe['close'] < dataframe['zema_offset_entry2']) & (dataframe['pm'] > dataframe['pmax_thresh']))
        is_clucHA = is_btc_safe & is_pair_safe & is_can_entry_rsi & is_real_dip & (is_MMA_prot | nfi7_sma_protection) & (dataframe['rocr_1h'] > self.entry_clucha_rocr_1h.value) & ((dataframe['bb_lowerband2_40'].shift() > 0) & (dataframe['bb_delta_cluc'] > dataframe['ha_close'] * self.entry_clucha_bbdelta_close.value) & (dataframe['ha_closedelta'] > dataframe['ha_close'] * self.entry_clucha_closedelta_close.value) & (dataframe['tail'] < dataframe['bb_delta_cluc'] * self.entry_clucha_bbdelta_tail.value) & (dataframe['ha_close'] < dataframe['bb_lowerband2_40'].shift()) & (dataframe['ha_close'] < dataframe['ha_close'].shift()))
        ## Condition Append
        ...
        dataframe.loc[is_local_dip, 'entry_tag'] += 'local_dip '
        ...
        dataframe.loc[is_nfix_3, 'entry_tag'] += 'is_nfix_3 '
        conditions.append(is_VWAP)  # ~2.86 / 91.5% / 33.31%     D
        dataframe.loc[is_VWAP, 'entry_tag'] += 'is_VWAP '
        ...
        dataframe.loc[is_nfix_5, 'entry_tag'] += 'nfix_5 '
        conditions.append(is_nfix_12)  # ~5.33 / 91.8% / 58.57%      D
        dataframe.loc[is_nfix_12, 'entry_tag'] += 'nfix_2 '
        ...
        dataframe.loc[is_nfi_ctt35, 'entry_tag'] += 'nfi_ctt35 '
        conditions.append(is_nfi_ctt25)  # ~3.28 / 92.4% / 69.72%
        dataframe.loc[is_nfi_ctt25, 'entry_tag'] += 'nfi_ctt25 '
        conditions.append(is_nfi_ctt15)  # ~0.76 / 91.1% / 15.54%
        dataframe.loc[is_nfi_ctt15, 'entry_tag'] += 'nfi_ctt15 '
        conditions.append(is_nfix_54)  # ~0.99 / 86.9% / 21.93%      D
        dataframe.loc[is_nfix_54, 'entry_tag'] += 'nfix_54 '
        conditions.append(is_nfix_53)  # ~7.2 / 92.5% / 97.98%       D
        dataframe.loc[is_nfix_53, 'entry_tag'] += 'nfix_53 '
        conditions.append(is_nfix_52)  # ~0.4 / 94.4% / 9.59%        D
        dataframe.loc[is_nfix_52, 'entry_tag'] += 'nfix_52 '
        conditions.append(is_nfix_51)  # ~2.63 / 90.6% / 41.49%      D
        dataframe.loc[is_nfix_51, 'entry_tag'] += 'nfix_51 '
        conditions.append(is_nfix_48)  # ~3.14 / 92.4% / 64.14%      D
        dataframe.loc[is_nfix_48, 'entry_tag'] += 'nfix_48 '
        conditions.append(is_nfix_47)  # ~0.4 / 100%                 D
        dataframe.loc[is_nfix_47, 'entry_tag'] += 'nfix_47 '
        conditions.append(is_nfix_41)  # ~0.78 / 92.0 % / 37.41%     D
        dataframe.loc[is_nfix_41, 'entry_tag'] += 'nfix_41 '
        conditions.append(is_nfix_36)  # ~1.13 / 88.5% / 31.34%      D
        dataframe.loc[is_nfix_36, 'entry_tag'] += 'nfix_36 '
        conditions.append(is_nfix_204)  # ~0.25 / 97.7% / 6.53%       D
        dataframe.loc[is_nfix_204, 'entry_tag'] += 'nfix_204 '
        conditions.append(is_nfix_203)  # ~5.33 / 91.8% / 58.57%      D
        dataframe.loc[is_nfix_203, 'entry_tag'] += 'nfix_203 '
        conditions.append(is_nfix_202)  # ~0.33 / 100% / 0%           D
        dataframe.loc[is_nfix_202, 'entry_tag'] += 'nfix_202 '
        conditions.append(is_nfix_201)  # ~0.71 / 91.3% / 28.94%      D
        dataframe.loc[is_nfix_201, 'entry_tag'] += 'nfix_201 '
        conditions.append(is_nfix_34)  # ~0.46 / 92.6% / 17.05%      D
        dataframe.loc[is_nfix_34, 'entry_tag'] += 'nfix_34 '
        conditions.append(is_nfix_28)  # ~0.25 / 97.7% / 6.53%       D
        dataframe.loc[is_nfix_28, 'entry_tag'] += 'nfix_28 '
        conditions.append(is_nfix_27)  # ~5.33 / 91.8% / 58.57%      D
        dataframe.loc[is_nfix_27, 'entry_tag'] += 'nfix_27 '
        conditions.append(is_nfix_19)  # ~0.33 / 100% / 0%           D
        dataframe.loc[is_nfix_19, 'entry_tag'] += 'nfix_19 '
        conditions.append(is_nfix_11)  # ~0.71 / 91.3% / 28.94%      D
        dataframe.loc[is_nfix_11, 'entry_tag'] += 'nfix_11 '
        conditions.append(is_nfix_9)  # ~0.46 / 92.6% / 17.05%      D
        dataframe.loc[is_nfix_9, 'entry_tag'] += 'nfix_9 '
        conditions.append(is_nfix_36)  # ~0.46 / 92.6% / 17.05%      D
        dataframe.loc[is_nfix_36, 'entry_tag'] += 'nfix_36 '
        conditions.append(is_nfi_sma_2)
        dataframe.loc[is_nfi_sma_2, 'entry_tag'] += 'is_nfi_sma_2 '
        conditions.append(is_nfi_sma_3)
        dataframe.loc[is_nfi_sma_3, 'entry_tag'] += 'is_nfi_sma_3 '
        conditions.append(is_nfi_sma_4)
        dataframe.loc[is_nfi_sma_4, 'entry_tag'] += 'is_nfi_sma_4 '
        conditions.append(is_nfi_sma_5)
        dataframe.loc[is_nfi_sma_5, 'entry_tag'] += 'is_nfi_sma_5 '
        conditions.append(is_nfi_sma_6)
        dataframe.loc[is_nfi_sma_6, 'entry_tag'] += 'is_nfi_sma_6 '
        conditions.append(is_nfi_sma_7)
        dataframe.loc[is_nfi_sma_7, 'entry_tag'] += 'is_nfi_sma_7 '
        conditions.append(is_nfi_sma_9)
        dataframe.loc[is_nfi_sma_9, 'entry_tag'] += 'is_nfi_sma_9 '
        conditions.append(is_nfi_sma_10)
        dataframe.loc[is_nfi_sma_10, 'entry_tag'] += 'is_nfi_sma_10 '
        conditions.append(is_nfi_sma_12)
        dataframe.loc[is_nfi_sma_12, 'entry_tag'] += 'is_nfi_sma_12 '
        conditions.append(is_nfi_sma_15)
        dataframe.loc[is_nfi_sma_15, 'entry_tag'] += 'is_nfi_sma_15 '
        conditions.append(is_nfi_sma_16)
        dataframe.loc[is_nfi_sma_16, 'entry_tag'] += 'is_nfi_sma_16 '
        conditions.append(is_nfi_sma_17)
        dataframe.loc[is_nfi_sma_17, 'entry_tag'] += 'is_nfi_sma_17 '
        conditions.append(is_nfi_sma_22)
        dataframe.loc[is_nfi_sma_22, 'entry_tag'] += 'is_nfi_sma_22 '
        conditions.append(is_nfi_sma_23)
        dataframe.loc[is_nfi_sma_23, 'entry_tag'] += 'is_nfi_sma_23 '
        conditions.append(is_nasos_1)  #     -
        dataframe.loc[is_nasos_1, 'entry_tag'] += 'is_nasos_1 '
        dataframe.loc[is_clucHA, 'entry_tag'] += 'is_clucHA '  #     ---
        conditions.append(is_clucHA)
        dataframe.loc[is_nasos_2, 'entry_tag'] += 'is_nasos_2 '  #     ---
        conditions.append(is_nasos_2)
        conditions.append(is_hma)
        dataframe.loc[is_hma, 'entry_tag'] += 'is_hma '
        conditions.append(is_zema)
        dataframe.loc[is_zema, 'entry_tag'] += 'is_zema '
        conditions.append(is_trima)  #     -
        dataframe.loc[is_trima, 'entry_tag'] += 'is_trima '
        dataframe.loc[is_fama, 'entry_tag'] += 'is_fama '  #     ---
...
class UziChanTB2(BB_RPB_TSL_SMA_Tranz):
                    ...
                    if trailing_entry['allow_trailing']:
                        if not trailing_entry['trailing_entry_order_started'] and last_candle['entry'] == 1:
                            ...
                            if trailing_entry_offset == 'forceentry':
                                ...
                                val = True
                                ratio = '%.2f' % (self.current_trailing_entry_profit_ratio(pair, current_price) * 100)
                                self.trailing_entry_info(pair, current_price)
    ...
    def confirm_trade_exit(self, pair: str, trade: Trade, order_type: str, amount: float, rate: float, time_in_force: str, exit_reason: str, **kwargs) -> bool:
                ...
                if len(dataframe) >= 1:
                    ...
                    if trailing_exit['allow_exit_trailing']:
                        if not trailing_exit['trailing_exit_order_started'] and last_candle['exit'] != 0:
                            ...
                            logger.info(f"start trailing exit for {pair} at {last_candle['close']}")
        ...
        #if (exit_reason != 'exit_signal') | (exit_reason!='force_exit'):
