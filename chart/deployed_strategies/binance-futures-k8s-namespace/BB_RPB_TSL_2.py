...
class BB_RPB_TSL_2(IStrategy):
    ...
    exit_deadfish_profit = DecimalParameter(-0.15, -0.05, default=-0.05, optimize=True)
    ...
    def informative_5m_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        informative_5m['momdiv_entry'] = mom['momdiv_entry']
        informative_5m['momdiv_exit'] = mom['momdiv_exit']
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # --------------------
        is_dip_5m = (dataframe[f'rmi_length_{self.entry_rmi_length.value}_5m'] < self.entry_rmi.value) & (dataframe[f'cci_length_{self.entry_cci_length.value}_5m'] <= self.entry_cci.value) & (dataframe['srsi_fk_5m'] < self.entry_srsi_fk.value)  # from BinH
        is_break_5m = (dataframe['bb_delta_5m'] > self.entry_bb_delta.value) & (dataframe['bb_width_5m'] > self.entry_bb_width.value) & (dataframe['closedelta_5m'] > dataframe['close'] * self.entry_closedelta.value / 1000) & (dataframe['close'] < dataframe['bb_lowerband3_5m'] * self.entry_bb_factor.value)  # from NFI next gen
        is_local_uptrend_5m = (dataframe['ema_26_5m'] > dataframe['ema_12_5m']) & (dataframe['ema_26_5m'] - dataframe['ema_12_5m'] > dataframe['open'] * self.entry_ema_diff.value) & (dataframe['ema_26_5m'].shift() - dataframe['ema_12_5m'].shift() > dataframe['open'] / 100) & (dataframe['close'] < dataframe['bb_lowerband2_5m'] * self.entry_bb_factor.value) & (dataframe['closedelta_5m'] > dataframe['close'] * self.entry_closedelta.value / 1000)
        is_local_dip_5m = (dataframe['ema_26_5m'] > dataframe['ema_12_5m']) & (dataframe['ema_26_5m'] - dataframe['ema_12'] > dataframe['open'] * self.entry_ema_diff_local_dip.value) & (dataframe['ema_26_5m'].shift() - dataframe['ema_12_5m'].shift() > dataframe['open'] / 100) & (dataframe['close_5m'] < dataframe['ema_20'] * self.entry_ema_high_local_dip.value) & (dataframe['rsi_5m'] < self.entry_rsi_local_dip.value) & (dataframe['crsi_5m'] > self.entry_crsi_local_dip.value) & (dataframe['closedelta_5m'] > dataframe['close'] * self.entry_closedelta_local_dip.value / 1000)  # from SMA offset
        is_ewo_5m = (dataframe['rsi_fast_5m'] < self.entry_rsi_fast.value) & (dataframe['close'] < dataframe['ema_8_5m'] * self.entry_ema_low.value) & (dataframe['EWO_5m'] > self.entry_ewo.value) & (dataframe['close'] < dataframe['ema_16_5m'] * self.entry_ema_high.value) & (dataframe['rsi_5m'] < self.entry_rsi.value)
        is_ewo_2_5m = (dataframe['ema_200_1h'] > dataframe['ema_200_1h'].shift(12)) & (dataframe['ema_200_1h'].shift(12) > dataframe['ema_200_1h'].shift(24)) & (dataframe['rsi_fast_5m'] < self.entry_rsi_fast_ewo_2.value) & (dataframe['close'] < dataframe['ema_8_5m'] * self.entry_ema_low_2.value) & (dataframe['EWO_5m'] > self.entry_ewo_high_2.value) & (dataframe['close'] < dataframe['ema_16_5m'] * self.entry_ema_high_2.value) & (dataframe['rsi_5m'] < self.entry_rsi_ewo_2.value)  # reverse deadfish
        is_r_deadfish_5m = (dataframe['ema_100_5m'] < dataframe['ema_200_5m'] * self.entry_r_deadfish_ema.value) & (dataframe['bb_width_5m'] > self.entry_r_deadfish_bb_width.value) & (dataframe['close'] < dataframe['bb_middleband2_5m'] * self.entry_r_deadfish_bb_factor.value) & (dataframe['volume_mean_12_5m'] > dataframe['volume_mean_24_5m'] * self.entry_r_deadfish_volume_factor.value) & (dataframe['cti_5m'] < self.entry_r_deadfish_cti.value) & (dataframe['r_14_5m'] < self.entry_r_deadfish_r14.value)
        is_clucHA_5m = (dataframe['rocr_1h'] > self.entry_clucha_rocr_1h.value) & ((dataframe['bb_lowerband2_40_5m'].shift() > 0) & (dataframe['bb_delta_cluc_5m'] > dataframe['ha_close_5m'] * self.entry_clucha_bbdelta_close.value) & (dataframe['ha_closedelta_5m'] > dataframe['ha_close_5m'] * self.entry_clucha_closedelta_close.value) & (dataframe['tail'] < dataframe['bb_delta_cluc_5m'] * self.entry_clucha_bbdelta_tail.value) & (dataframe['ha_close_5m'] < dataframe['bb_lowerband2_40_5m'].shift()) & (dataframe['ha_close_5m'] < dataframe['ha_close_5m'].shift()) | (dataframe['ha_close_5m'] < dataframe['ema_slow_5m']) & (dataframe['ha_close_5m'] < self.entry_clucha_close_bblower.value * dataframe['bb_lowerband2_5m']))
        is_cofi_5m = (dataframe['open'] < dataframe['ema_8_5m'] * self.entry_ema_cofi.value) & qtpylib.crossed_above(dataframe['fastk_5m'], dataframe['fastd_5m']) & (dataframe['fastk_5m'] < self.entry_fastk.value) & (dataframe['fastd_5m'] < self.entry_fastd.value) & (dataframe['adx_5m'] > self.entry_adx.value) & (dataframe['EWO_5m'] > self.entry_ewo_high.value) & (dataframe['cti_5m'] < self.entry_cofi_cti.value) & (dataframe['r_14_5m'] < self.entry_cofi_39_r14.value)
        # NFI quick mode
        is_nfi_13_5m = (dataframe['ema_50_1h'] > dataframe['ema_100_1h']) & (dataframe['close'] < dataframe['sma_30_5m'] * 0.99) & (dataframe['cti_5m'] < -0.92) & (dataframe['EWO_5m'] < -5.585) & (dataframe['cti_1h'] < -0.88) & (dataframe['crsi_1h'] > 10.0)  # NFIX 26
        is_nfi_32_5m = (dataframe['rsi_slow_5m'] < dataframe['rsi_slow_5m'].shift(1)) & (dataframe['rsi_fast_5m'] < 46) & (dataframe['rsi_5m'] > 25.0) & (dataframe['close'] < dataframe['sma_15_5m'] * 0.93) & (dataframe['cti_5m'] < -0.9)
        is_nfi_33_5m = (dataframe['close'] < dataframe['ema_13_5m'] * 0.978) & (dataframe['EWO_5m'] > 8) & (dataframe['cti_5m'] < -0.88) & (dataframe['rsi_5m'] < 32) & (dataframe['r_14_5m'] < -98.0) & (dataframe['volume'] < dataframe['volume_mean_4_5m'] * 2.5)
        is_nfi_38_5m = (dataframe['pm_5m'] > dataframe['pmax_thresh_5m']) & (dataframe['close'] < dataframe['sma_75_5m'] * 0.98) & (dataframe['EWO_5m'] < -4.4) & (dataframe['cti_5m'] < -0.95) & (dataframe['r_14_5m'] < -97) & (dataframe['crsi_1h'] > 0.5)
        is_nfix_5_5m = (dataframe['ema_200_1h'] > dataframe['ema_200_1h'].shift(12)) & (dataframe['ema_200_1h'].shift(12) > dataframe['ema_200_1h'].shift(24)) & (dataframe['close'] < dataframe['sma_75_5m'] * 0.932) & (dataframe['EWO_5m'] > 3.6) & (dataframe['cti_5m'] < -0.9) & (dataframe['r_14_5m'] < -97.0)
        is_nfix_49_5m = (dataframe['ema_26_5m'].shift(3) > dataframe['ema_12_5m'].shift(3)) & (dataframe['ema_26_5m'].shift(3) - dataframe['ema_12_5m'].shift(3) > dataframe['open'].shift(3) * 0.032) & (dataframe['ema_26_5m'].shift(9) - dataframe['ema_12_5m'].shift(9) > dataframe['open'].shift(3) / 100) & (dataframe['close'].shift(3) < dataframe['ema_20_5m'].shift(3) * 0.916) & (dataframe['rsi_5m'].shift(3) < 32.5) & (dataframe['crsi_5m'].shift(3) > 18.0) & (dataframe['cti_5m'] < self.entry_nfix_39_cti.value) & (dataframe['r_14_5m'] < self.entry_nfix_39_r14.value)
        # --------------------
        ...
        dataframe.loc[is_BB_checked_5m, 'entry_tag'] += 'bb '
        conditions.append(is_local_uptrend_5m)  # ~3.28 / 92.4% / 69.72%
        dataframe.loc[is_local_uptrend_5m, 'entry_tag'] += 'local_uptrend '
        conditions.append(is_local_dip_5m)  # ~0.76 / 91.1% / 15.54%
        dataframe.loc[is_local_dip_5m, 'entry_tag'] += 'local_dip '
        conditions.append(is_ewo_5m)  # ~0.92 / 92.0% / 43.74%      D
        dataframe.loc[is_ewo_5m, 'entry_tag'] += 'ewo '
        conditions.append(is_ewo_2_5m)  # ~2.5 / 89.6% / 33.31%       D
        dataframe.loc[is_ewo_2_5m, 'entry_tag'] += 'ewo2 '
        conditions.append(is_r_deadfish_5m)  # ~0.99 / 86.9% / 21.93%      D
        dataframe.loc[is_r_deadfish_5m, 'entry_tag'] += 'r_deadfish '
        conditions.append(is_clucHA_5m)  # ~7.34 / 86.6% / 100.11%     F
        dataframe.loc[is_clucHA_5m, 'entry_tag'] += 'clucHA '
        conditions.append(is_cofi_5m)  # ~0.4 / 94.4% / 9.59%        D
        dataframe.loc[is_cofi_5m, 'entry_tag'] += 'cofi '
        conditions.append(is_nfi_13_5m)  # ~0.4 / 100%                 D
        dataframe.loc[is_nfi_13_5m, 'entry_tag'] += 'nfi_13 '
        conditions.append(is_nfi_32_5m)  # ~0.78 / 92.0 % / 37.41%     D
        dataframe.loc[is_nfi_32_5m, 'entry_tag'] += 'nfi_32 '
        conditions.append(is_nfi_33_5m)  # ~0.11 / 100%                D
        dataframe.loc[is_nfi_33_5m, 'entry_tag'] += 'nfi_33 '
        conditions.append(is_nfi_38_5m)  # ~1.07 / 83.2% / 70.22%      F
        dataframe.loc[is_nfi_38_5m, 'entry_tag'] += 'nfi_38 '
        conditions.append(is_nfix_5_5m)  # ~0.25 / 97.7% / 6.53%       D
        dataframe.loc[is_nfix_5_5m, 'entry_tag'] += 'nfix_5 '
        conditions.append(is_nfix_49_5m)  # ~0.33 / 100% / 0%           D
        dataframe.loc[is_nfix_49_5m, 'entry_tag'] += 'nfix_49 '
        # ----------
        if conditions:
