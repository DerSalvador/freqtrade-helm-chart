...
class mark_strat_opt(IStrategy):
    ...
    #     "1039": 0
    #     }
    minimal_roi = {'0': 0.06965, '8': 0.01125, '19': 0.00498, '34': 0}
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        dataframe.loc[(dataframe['adx'] > 49) & (dataframe['fastd'] < 30) & (dataframe['mfi'] < 23) & (dataframe['rsi'] < 34) & (dataframe['close'] < dataframe['bb_lowerband4']), 'entry'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        :return: DataFrame with entry column
        """
        dataframe.loc[(dataframe['adx'] < 95) & (dataframe['fastd'] > 70) & (dataframe['rsi'] > 94) & qtpylib.crossed_above(dataframe['sar'], dataframe['close']), 'exit'] = 1
        return dataframe