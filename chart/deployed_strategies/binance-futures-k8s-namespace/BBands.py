...
class BBands(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Guard: tema is rising
        # Make sure Volume is not 0
        dataframe.loc[(dataframe['tema'] > dataframe['tema'].shift(1)) & (dataframe['volume'] > 0), 'entry'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Make sure Volume is not 0
        dataframe.loc[(dataframe['tema'] < dataframe['tema'].shift(1)) & (dataframe['volume'] > 0), 'exit'] = 1
        return dataframe