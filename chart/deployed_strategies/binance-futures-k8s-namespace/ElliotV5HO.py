...
# exit_params = {
#     "base_nb_candles_exit": 26,
#     "high_offset": 0.994,
# }
# Buy hyperspace params:
entry_params = {'base_nb_candles_entry': 11, 'ewo_high': 2.337, 'ewo_low': -15.87, 'low_offset': 0.979, 'rsi_entry': 55}
# Sell hyperspace params:
exit_params = {'base_nb_candles_exit': 17, 'high_offset': 0.997}
...
class ElliotV5HO(IStrategy):
    ...
    # }
    # ROI table:
    minimal_roi = {'0': 0.051, '20': 0.032, '45': 0.016, '70': 0}
    # Stoploss:
    stoploss = -0.302
    # # Trailing stop:
    # trailing_stop = True
    ...
    def custom_stoploss(self, pair: str, trade: Trade, current_time: datetime, current_rate: float, current_profit: float, **kwargs) -> float:
        ...
        if current_profit > 0.2:
            return stoploss_from_open(+0.1, current_profit)
        # 5% profit guaranteed.
