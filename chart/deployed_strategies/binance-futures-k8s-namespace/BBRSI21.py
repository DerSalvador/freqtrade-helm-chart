...
class BBRSI21(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        #   (dataframe['mfi'] > 16) &
        #  (dataframe['adx'] > 25) &
        dataframe.loc[(dataframe['close'] < dataframe['bb_lowerband']) & (dataframe['rsi'] < 21), 'entry'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        #      )) &
        #      (dataframe['fastd'] > 54)
        dataframe.loc[(dataframe['close'] > dataframe['bb_upperband']) & (dataframe['rsi'] > 99), 'exit'] = 1
        return dataframe