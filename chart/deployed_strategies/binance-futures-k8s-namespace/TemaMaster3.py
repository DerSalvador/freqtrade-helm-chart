...
class TemaMaster3(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        dataframe.loc[qtpylib.crossed_above(dataframe['TEMA'], dataframe['bb_lowerband']) & (dataframe['CMO'] > -3), 'entry'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        :return: DataFrame with entry column
        """
        dataframe.loc[qtpylib.crossed_below(dataframe['CMO'], -22) | qtpylib.crossed_below(dataframe['CMO'], 25), 'exit'] = 1
        return dataframe