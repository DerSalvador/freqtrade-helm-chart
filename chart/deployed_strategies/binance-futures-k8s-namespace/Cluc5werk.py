...
class Cluc5werk_ETH(Cluc5werk):
    # hyperopt --config user_data/config-backtest-USD.json --hyperopt Cluc5werkHyperopt --hyperopt-loss OnlyProfitHyperOptLoss --strategy Cluc5werk_USD -e 1000 --spaces entry --timeframe 1m --timerange 20210101- 
...
class Cluc5werk_USD(Cluc5werk):
    ...
    # Buy hyperspace params:
    entry_params = {'bbdelta-close': 0.00902, 'bbdelta-tail': 0.91508, 'close-bblower': 0.00603, 'closedelta-close': 0.00424, 'rocr-1h': 0.93725, 'volume': 38}
    # hyperopt --config user_data/config-backtest-USD.json --hyperopt Cluc5werkHyperopt --hyperopt-loss OnlyProfitHyperOptLoss --strategy Cluc5werk_USD -e 250 --spaces exit --timeframe 1m --timerange 20210101- 
