...
class NFI47V2(IStrategy):
    ...
    #############################################################
    entry_params = {'entry_condition_10_enable': True, 'entry_condition_11_enable': True, 'entry_condition_12_enable': True, 'entry_condition_13_enable': True, 'entry_condition_14_enable': True, 'entry_condition_15_enable': True, 'entry_condition_16_enable': True, 'entry_condition_17_enable': True, 'entry_condition_1_enable': True, 'entry_condition_2_enable': True, 'entry_condition_3_enable': True, 'entry_condition_4_enable': True, 'entry_condition_5_enable': True, 'entry_condition_6_enable': True, 'entry_condition_7_enable': True, 'entry_condition_8_enable': True, 'entry_condition_9_enable': True, 'entry_dip_threshold_1': 0.017, 'entry_dip_threshold_2': 0.058, 'entry_dip_threshold_3': 0.32, 'entry_dip_threshold_4': 0.278, 'entry_dip_threshold_5': 0.006, 'entry_dip_threshold_6': 0.126, 'entry_dip_threshold_7': 0.146, 'entry_dip_threshold_8': 0.341, 'entry_dip_threshold_10': 0.022, 'entry_dip_threshold_11': 0.313, 'entry_dip_threshold_12': 0.29, 'entry_dip_threshold_9': 0.05, 'entry_pump_pull_threshold_1': 1.7, 'entry_pump_pull_threshold_2': 2.35, 'entry_pump_threshold_1': 0.98, 'entry_pump_threshold_2': 0.994, 'entry_pump_pull_threshold_3': 2.85, 'entry_pump_pull_threshold_4': 2.86, 'entry_pump_threshold_3': 0.442, 'entry_pump_threshold_4': 0.484, 'entry_pump_pull_threshold_5': 2.65, 'entry_pump_pull_threshold_6': 2.11, 'entry_pump_threshold_5': 0.864, 'entry_pump_threshold_6': 0.809, 'entry_pump_pull_threshold_7': 2.65, 'entry_pump_pull_threshold_8': 2.4, 'entry_pump_pull_threshold_9': 1.53, 'entry_pump_threshold_7': 0.437, 'entry_pump_threshold_8': 0.412, 'entry_pump_threshold_9': 1.264, 'entry_mfi_1': 33.4, 'entry_min_inc_1': 0.046, 'entry_rsi_1': 39.8, 'entry_rsi_1h_max_1': 85.4, 'entry_rsi_1h_min_1': 39.0, 'entry_bb_offset_2': 0.975, 'entry_mfi_2': 34.1, 'entry_rsi_1h_diff_2': 32.0, 'entry_rsi_1h_max_2': 74.7, 'entry_rsi_1h_min_2': 30.5, 'entry_volume_2': 3.2, 'entry_bb40_bbdelta_close_3': 0.028, 'entry_bb40_closedelta_close_3': 0.025, 'entry_bb40_tail_bbdelta_3': 0.442, 'entry_ema_rel_3': 0.973, 'entry_bb20_close_bblowerband_4': 0.988, 'entry_bb20_volume_4': 33, 'entry_bb_offset_5': 1.0, 'entry_ema_open_mult_5': 0.018, 'entry_ema_rel_5': 0.981, 'entry_volume_5': 3.5, 'entry_bb_offset_6': 0.998, 'entry_ema_open_mult_6': 0.03, 'entry_volume_6': 5.8, 'entry_ema_open_mult_7': 0.024, 'entry_rsi_7': 46.3, 'entry_volume_7': 7.8, 'entry_ema_rel_8': 0.997, 'entry_rsi_8': 35.5, 'entry_bb_offset_9': 0.985, 'entry_ma_offset_9': 0.978, 'entry_mfi_9': 38.7, 'entry_rsi_1h_max_9': 79.0, 'entry_rsi_1h_min_9': 31.4, 'entry_volume_9': 3.52, 'entry_bb_offset_10': 0.989, 'entry_ma_offset_10': 0.966, 'entry_rsi_1h_10': 39.5, 'entry_volume_10': 23.5, 'entry_ma_offset_11': 0.947, 'entry_mfi_11': 44.6, 'entry_min_inc_11': 0.008, 'entry_rsi_11': 32.9, 'entry_rsi_1h_max_11': 72.1, 'entry_rsi_1h_min_11': 59.2, 'entry_ewo_12': 2.2, 'entry_ma_offset_12': 0.943, 'entry_rsi_12': 30.3, 'entry_volume_12': 1.5, 'entry_bb_offset_14': 1.0, 'entry_ema_open_mult_14': 0.01, 'entry_ma_offset_14': 0.979, 'entry_volume_14': 5.9, 'entry_ema_open_mult_15': 0.023, 'entry_ema_rel_15': 0.989, 'entry_ma_offset_15': 0.959, 'entry_rsi_15': 30.5, 'entry_ewo_16': 7.3, 'entry_ma_offset_16': 0.939, 'entry_rsi_16': 46.7, 'entry_volume_16': 7.5}
    exit_params = {'exit_condition_1_enable': True, 'exit_condition_2_enable': True, 'exit_condition_3_enable': True, 'exit_condition_4_enable': True, 'exit_condition_5_enable': True, 'exit_condition_6_enable': True, 'exit_condition_7_enable': True, 'exit_condition_8_enable': True, 'exit_custom_profit_0': 0.016, 'exit_custom_profit_1': 0.044, 'exit_custom_rsi_0': 36.733, 'exit_custom_rsi_1': 45.61, 'exit_custom_profit_2': 0.036, 'exit_custom_profit_3': 0.083, 'exit_custom_rsi_2': 49.15, 'exit_custom_rsi_3': 46.41, 'exit_custom_profit_4': 0.062, 'exit_custom_profit_5': 0.045, 'exit_custom_rsi_4': 48.68, 'exit_custom_rsi_5': 49.84, 'exit_custom_profit_6': 0.047, 'exit_custom_profit_7': 0.056, 'exit_custom_rsi_6': 51.82, 'exit_custom_rsi_7': 56.54, 'exit_custom_profit_8': 0.087, 'exit_custom_profit_9': 0.071, 'exit_custom_rsi_8': 48.51, 'exit_custom_rsi_9': 58.66, 'exit_custom_profit_10': 0.11, 'exit_custom_profit_11': 0.216, 'exit_custom_rsi_10': 45.16, 'exit_custom_rsi_11': 33.15, 'exit_custom_under_profit_4': 0.03, 'exit_custom_under_profit_5': 0.08, 'exit_custom_under_rsi_4': 56.4, 'exit_custom_under_rsi_5': 54.7}
    #############################################################
    ...
    entry_pump_threshold_1 = DecimalParameter(0.4, 1.0, default=0.46, space='entry', decimals=3, optimize=False, load=True)
    # 36 hours
    entry_pump_pull_threshold_2 = DecimalParameter(1.5, 3.0, default=1.75, space='entry', decimals=2, optimize=False, load=True)
    entry_pump_threshold_2 = DecimalParameter(0.4, 1.0, default=0.56, space='entry', decimals=3, optimize=False, load=True)
    # 48 hours
    ...
    entry_pump_threshold_4 = DecimalParameter(0.4, 1.0, default=0.4, space='entry', decimals=3, optimize=False, load=True)
    # 36 hours strict
    entry_pump_pull_threshold_5 = DecimalParameter(1.5, 3.0, default=2.0, space='entry', decimals=2, optimize=False, load=True)
    entry_pump_threshold_5 = DecimalParameter(0.4, 1.0, default=0.56, space='entry', decimals=3, optimize=False, load=True)
    # 48 hours strict
    entry_pump_pull_threshold_6 = DecimalParameter(1.5, 3.0, default=2.0, space='entry', decimals=2, optimize=False, load=True)
    entry_pump_threshold_6 = DecimalParameter(0.4, 1.0, default=0.68, space='entry', decimals=3, optimize=False, load=True)
    # 24 hours loose
    ...
    entry_rsi_1h_max_1 = DecimalParameter(70.0, 90.0, default=80.0, space='entry', decimals=1, optimize=False, load=True)
    entry_rsi_1 = DecimalParameter(20.0, 40.0, default=36.0, space='entry', decimals=1, optimize=False, load=True)
    entry_mfi_1 = DecimalParameter(20.0, 56.0, default=26.0, space='entry', decimals=1, optimize=False, load=True)
    entry_volume_2 = DecimalParameter(1.0, 10.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)
    entry_rsi_1h_min_2 = DecimalParameter(30.0, 40.0, default=36.0, space='entry', decimals=1, optimize=False, load=True)
    entry_rsi_1h_max_2 = DecimalParameter(70.0, 95.0, default=90.0, space='entry', decimals=1, optimize=False, load=True)
    entry_rsi_1h_diff_2 = DecimalParameter(30.0, 50.0, default=34.0, space='entry', decimals=1, optimize=False, load=True)
    entry_mfi_2 = DecimalParameter(30.0, 65.0, default=56.0, space='entry', decimals=1, optimize=False, load=True)
    entry_bb_offset_2 = DecimalParameter(0.97, 0.99, default=0.983, space='entry', decimals=3, optimize=False, load=True)
    ...
    entry_ema_rel_3 = DecimalParameter(0.97, 0.999, default=0.988, space='entry', decimals=3, optimize=False, load=True)
    entry_bb20_close_bblowerband_4 = DecimalParameter(0.9, 0.99, default=0.979, space='entry', optimize=False, load=True)
    entry_bb20_volume_4 = IntParameter(16, 35, default=18, space='entry', optimize=False, load=True)
    entry_volume_5 = DecimalParameter(1.0, 10.0, default=6.0, space='entry', decimals=1, optimize=False, load=True)
    entry_ema_open_mult_5 = DecimalParameter(0.016, 0.03, default=0.019, space='entry', decimals=3, optimize=False, load=True)
    entry_bb_offset_5 = DecimalParameter(0.98, 1.0, default=0.999, space='entry', decimals=3, optimize=False, load=True)
    entry_ema_rel_5 = DecimalParameter(0.97, 0.999, default=0.988, space='entry', decimals=3, optimize=False, load=True)
    entry_volume_6 = DecimalParameter(1.0, 10.0, default=1.5, space='entry', decimals=1, optimize=False, load=True)
    entry_ema_open_mult_6 = DecimalParameter(0.03, 0.04, default=0.025, space='entry', decimals=3, optimize=False, load=True)
    entry_bb_offset_6 = DecimalParameter(0.98, 0.999, default=0.995, space='entry', decimals=3, optimize=False, load=True)
    entry_volume_7 = DecimalParameter(1.0, 10.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)
    ...
    entry_ema_rel_8 = DecimalParameter(0.97, 0.999, default=0.988, space='entry', decimals=3, optimize=False, load=True)
    entry_params_9_optimize = False
    entry_volume_9 = DecimalParameter(1.0, 4.0, default=2.0, space='entry', decimals=2, optimize=entry_params_9_optimize, load=True)
    entry_ma_offset_9 = DecimalParameter(0.94, 0.99, default=0.958, space='entry', decimals=3, optimize=entry_params_9_optimize, load=True)
    entry_bb_offset_9 = DecimalParameter(0.97, 0.99, default=0.984, space='entry', decimals=3, optimize=entry_params_9_optimize, load=True)
    entry_rsi_1h_min_9 = DecimalParameter(26.0, 40.0, default=30.0, space='entry', decimals=1, optimize=entry_params_9_optimize, load=True)
    entry_rsi_1h_max_9 = DecimalParameter(70.0, 90.0, default=80.0, space='entry', decimals=1, optimize=entry_params_9_optimize, load=True)
    entry_mfi_9 = DecimalParameter(36.0, 65.0, default=56.0, space='entry', decimals=1, optimize=entry_params_9_optimize, load=True)
    entry_params_10_optimize = False
    entry_volume_10 = DecimalParameter(1.0, 26.0, default=23.0, space='entry', decimals=1, optimize=entry_params_10_optimize, load=True)
    entry_ma_offset_10 = DecimalParameter(0.93, 0.97, default=0.94, space='entry', decimals=3, optimize=entry_params_10_optimize, load=True)
    entry_bb_offset_10 = DecimalParameter(0.97, 0.99, default=0.994, space='entry', decimals=3, optimize=entry_params_10_optimize, load=True)
    entry_rsi_1h_10 = DecimalParameter(20.0, 40.0, default=39.0, space='entry', decimals=1, optimize=entry_params_10_optimize, load=True)
    entry_params_11_optimize = False
    entry_ma_offset_11 = DecimalParameter(0.93, 0.99, default=0.938, space='entry', decimals=3, optimize=entry_params_11_optimize, load=True)
    entry_min_inc_11 = DecimalParameter(0.005, 0.05, default=0.01, space='entry', decimals=3, optimize=entry_params_11_optimize, load=True)
    entry_rsi_1h_min_11 = DecimalParameter(40.0, 60.0, default=55.0, space='entry', decimals=1, optimize=entry_params_11_optimize, load=True)
    entry_rsi_1h_max_11 = DecimalParameter(70.0, 90.0, default=82.0, space='entry', decimals=1, optimize=entry_params_11_optimize, load=True)
    entry_rsi_11 = DecimalParameter(30.0, 48.0, default=46.0, space='entry', decimals=1, optimize=entry_params_11_optimize, load=True)
    entry_mfi_11 = DecimalParameter(36.0, 56.0, default=38.0, space='entry', decimals=1, optimize=entry_params_11_optimize, load=True)
    entry_params_12_optimize = False
    entry_volume_12 = DecimalParameter(1.0, 10.0, default=2.0, space='entry', decimals=1, optimize=entry_params_12_optimize, load=True)
    entry_ma_offset_12 = DecimalParameter(0.93, 0.97, default=0.936, space='entry', decimals=3, optimize=entry_params_12_optimize, load=True)
    entry_rsi_12 = DecimalParameter(26.0, 40.0, default=30.0, space='entry', decimals=1, optimize=entry_params_12_optimize, load=True)
    entry_ewo_12 = DecimalParameter(2.0, 6.0, default=2.8, space='entry', decimals=1, optimize=entry_params_12_optimize, load=True)
    entry_ma_offset_13 = DecimalParameter(0.93, 0.98, default=0.952, space='entry', decimals=3, optimize=False, load=True)
    entry_ewo_13 = DecimalParameter(-14.0, -7.0, default=-7.9, space='entry', decimals=1, optimize=False, load=True)
    entry_params_14_optimize = False
    entry_volume_14 = DecimalParameter(1.0, 10.0, default=2.0, space='entry', decimals=1, optimize=entry_params_14_optimize, load=True)
    entry_ema_open_mult_14 = DecimalParameter(0.01, 0.03, default=0.014, space='entry', decimals=3, optimize=entry_params_14_optimize, load=True)
    entry_bb_offset_14 = DecimalParameter(0.98, 1.0, default=0.992, space='entry', decimals=3, optimize=entry_params_14_optimize, load=True)
    entry_ma_offset_14 = DecimalParameter(0.93, 0.99, default=0.998, space='entry', decimals=3, optimize=entry_params_14_optimize, load=True)
    entry_params_15_optimize = False
    entry_ema_open_mult_15 = DecimalParameter(0.02, 0.04, default=0.026, space='entry', decimals=3, optimize=entry_params_15_optimize, load=True)
    entry_ma_offset_15 = DecimalParameter(0.93, 0.99, default=0.985, space='entry', decimals=3, optimize=entry_params_15_optimize, load=True)
    entry_rsi_15 = DecimalParameter(30.0, 50.0, default=32.0, space='entry', decimals=1, optimize=entry_params_15_optimize, load=True)
    entry_ema_rel_15 = DecimalParameter(0.97, 0.999, default=0.988, space='entry', decimals=3, optimize=entry_params_15_optimize, load=True)
    entry_params_16_optimize = False
    entry_volume_16 = DecimalParameter(1.0, 10.0, default=2.0, space='entry', decimals=1, optimize=entry_params_16_optimize, load=True)
    entry_ma_offset_16 = DecimalParameter(0.93, 0.97, default=0.95, space='entry', decimals=3, optimize=entry_params_16_optimize, load=True)
    entry_rsi_16 = DecimalParameter(26.0, 50.0, default=38.0, space='entry', decimals=1, optimize=entry_params_16_optimize, load=True)
    entry_ewo_16 = DecimalParameter(4.0, 8.0, default=3.6, space='entry', decimals=1, optimize=entry_params_16_optimize, load=True)
    ...
    exit_rsi_params_optimize = False
    exit_rsi_bb_1 = DecimalParameter(60.0, 80.0, default=79.5, space='exit', decimals=1, optimize=exit_rsi_params_optimize, load=True)
    exit_rsi_bb_2 = DecimalParameter(72.0, 90.0, default=81, space='exit', decimals=1, optimize=exit_rsi_params_optimize, load=True)
    exit_rsi_main_3 = DecimalParameter(77.0, 90.0, default=82, space='exit', decimals=1, optimize=exit_rsi_params_optimize, load=True)
    exit_dual_rsi_params_optimize = False
    exit_dual_rsi_rsi_4 = DecimalParameter(72.0, 84.0, default=73.4, space='exit', decimals=1, optimize=exit_dual_rsi_params_optimize, load=True)
    exit_dual_rsi_rsi_1h_4 = DecimalParameter(78.0, 92.0, default=79.6, space='exit', decimals=1, optimize=exit_dual_rsi_params_optimize, load=True)
    exit_5_params_optimize = False
    exit_ema_relative_5 = DecimalParameter(0.005, 0.05, default=0.024, space='exit', optimize=exit_5_params_optimize, load=True)
    exit_rsi_diff_5 = DecimalParameter(0.0, 20.0, default=4.4, space='exit', optimize=exit_5_params_optimize, load=True)
    ...
    exit_custom_profit_01_params_optimize = False
    exit_custom_profit_23_params_optimize = False
    exit_custom_profit_45_params_optimize = False
    exit_custom_profit_67_params_optimize = False
    exit_custom_profit_89_params_optimize = False
    exit_custom_profit_1011_params_optimize = False
    exit_custom_profit_0 = DecimalParameter(0.01, 0.1, default=0.01, space='exit', decimals=3, optimize=exit_custom_profit_01_params_optimize, load=True)
    exit_custom_rsi_0 = DecimalParameter(30.0, 40.0, default=34.0, space='exit', decimals=3, optimize=exit_custom_profit_01_params_optimize, load=True)
    exit_custom_profit_1 = DecimalParameter(0.01, 0.1, default=0.02, space='exit', decimals=3, optimize=exit_custom_profit_01_params_optimize, load=True)
    exit_custom_rsi_1 = DecimalParameter(30.0, 50.0, default=35.0, space='exit', decimals=2, optimize=exit_custom_profit_01_params_optimize, load=True)
    exit_custom_profit_2 = DecimalParameter(0.01, 0.1, default=0.03, space='exit', decimals=3, optimize=exit_custom_profit_23_params_optimize, load=True)
    exit_custom_rsi_2 = DecimalParameter(30.0, 50.0, default=37.0, space='exit', decimals=2, optimize=exit_custom_profit_23_params_optimize, load=True)
    exit_custom_profit_3 = DecimalParameter(0.01, 0.1, default=0.04, space='exit', decimals=3, optimize=exit_custom_profit_23_params_optimize, load=True)
    exit_custom_rsi_3 = DecimalParameter(30.0, 50.0, default=42.0, space='exit', decimals=2, optimize=exit_custom_profit_23_params_optimize, load=True)
    exit_custom_profit_4 = DecimalParameter(0.01, 0.1, default=0.05, space='exit', decimals=3, optimize=exit_custom_profit_45_params_optimize, load=True)
    exit_custom_rsi_4 = DecimalParameter(35.0, 50.0, default=43.0, space='exit', decimals=2, optimize=exit_custom_profit_45_params_optimize, load=True)
    exit_custom_profit_5 = DecimalParameter(0.01, 0.1, default=0.06, space='exit', decimals=3, optimize=exit_custom_profit_45_params_optimize, load=True)
    exit_custom_rsi_5 = DecimalParameter(35.0, 50.0, default=45.0, space='exit', decimals=2, optimize=exit_custom_profit_45_params_optimize, load=True)
    exit_custom_profit_6 = DecimalParameter(0.01, 0.1, default=0.07, space='exit', decimals=3, optimize=exit_custom_profit_67_params_optimize, load=True)
    exit_custom_rsi_6 = DecimalParameter(38.0, 55.0, default=48.0, space='exit', decimals=2, optimize=exit_custom_profit_67_params_optimize, load=True)
    exit_custom_profit_7 = DecimalParameter(0.01, 0.1, default=0.08, space='exit', decimals=3, optimize=exit_custom_profit_67_params_optimize, load=True)
    exit_custom_rsi_7 = DecimalParameter(40.0, 58.0, default=54.0, space='exit', decimals=2, optimize=exit_custom_profit_67_params_optimize, load=True)
    exit_custom_profit_8 = DecimalParameter(0.06, 0.1, default=0.09, space='exit', decimals=3, optimize=exit_custom_profit_89_params_optimize, load=True)
    exit_custom_rsi_8 = DecimalParameter(40.0, 50.0, default=55.0, space='exit', decimals=2, optimize=exit_custom_profit_89_params_optimize, load=True)
    exit_custom_profit_9 = DecimalParameter(0.05, 0.14, default=0.1, space='exit', decimals=3, optimize=exit_custom_profit_89_params_optimize, load=True)
    exit_custom_rsi_9 = DecimalParameter(40.0, 60.0, default=54.0, space='exit', decimals=2, optimize=exit_custom_profit_89_params_optimize, load=True)
    exit_custom_profit_10 = DecimalParameter(0.1, 0.14, default=0.12, space='exit', decimals=3, optimize=exit_custom_profit_1011_params_optimize, load=True)
    exit_custom_rsi_10 = DecimalParameter(38.0, 50.0, default=42.0, space='exit', decimals=2, optimize=exit_custom_profit_1011_params_optimize, load=True)
    exit_custom_profit_11 = DecimalParameter(0.16, 0.45, default=0.2, space='exit', decimals=3, optimize=exit_custom_profit_1011_params_optimize, load=True)
    exit_custom_rsi_11 = DecimalParameter(28.0, 40.0, default=34.0, space='exit', decimals=2, optimize=exit_custom_profit_1011_params_optimize, load=True)
    # Profit under EMA200
    exit_custom_under_profit_01_optimize = False
    exit_custom_under_profit_23_optimize = False
    exit_custom_under_profit_45_optimize = False
    exit_custom_under_profit_67_optimize = False
    exit_custom_under_profit_89_optimize = False
    exit_custom_under_profit_1011_optimize = False
    exit_custom_under_profit_0 = DecimalParameter(0.01, 0.4, default=0.01, space='exit', decimals=3, optimize=exit_custom_under_profit_01_optimize, load=True)
    exit_custom_under_rsi_0 = DecimalParameter(28.0, 40.0, default=35.0, space='exit', decimals=1, optimize=exit_custom_under_profit_01_optimize, load=True)
    exit_custom_under_profit_1 = DecimalParameter(0.01, 0.1, default=0.02, space='exit', decimals=3, optimize=exit_custom_under_profit_01_optimize, load=True)
    exit_custom_under_rsi_1 = DecimalParameter(36.0, 60.0, default=56.0, space='exit', decimals=1, optimize=exit_custom_under_profit_01_optimize, load=True)
    exit_custom_under_profit_2 = DecimalParameter(0.01, 0.1, default=0.03, space='exit', decimals=3, optimize=exit_custom_under_profit_23_optimize, load=True)
    exit_custom_under_rsi_2 = DecimalParameter(46.0, 66.0, default=57.0, space='exit', decimals=1, optimize=exit_custom_under_profit_23_optimize, load=True)
    exit_custom_under_profit_3 = DecimalParameter(0.01, 0.1, default=0.04, space='exit', decimals=3, optimize=exit_custom_under_profit_23_optimize, load=True)
    exit_custom_under_rsi_3 = DecimalParameter(50.0, 68.0, default=58.0, space='exit', decimals=1, optimize=exit_custom_under_profit_23_optimize, load=True)
    exit_custom_under_profit_4 = DecimalParameter(0.02, 0.1, default=0.05, space='exit', decimals=3, optimize=exit_custom_under_profit_45_optimize, load=True)
    exit_custom_under_rsi_4 = DecimalParameter(50.0, 68.0, default=59.0, space='exit', decimals=1, optimize=exit_custom_under_profit_45_optimize, load=True)
    exit_custom_under_profit_5 = DecimalParameter(0.02, 0.1, default=0.06, space='exit', decimals=3, optimize=exit_custom_under_profit_45_optimize, load=True)
    exit_custom_under_rsi_5 = DecimalParameter(46.0, 62.0, default=60.0, space='exit', decimals=1, optimize=exit_custom_under_profit_45_optimize, load=True)
    exit_custom_under_profit_6 = DecimalParameter(0.03, 0.1, default=0.07, space='exit', decimals=3, optimize=exit_custom_under_profit_67_optimize, load=True)
    exit_custom_under_rsi_6 = DecimalParameter(44.0, 60.0, default=56.0, space='exit', decimals=1, optimize=exit_custom_under_profit_67_optimize, load=True)
    exit_custom_under_profit_7 = DecimalParameter(0.04, 0.1, default=0.08, space='exit', decimals=3, optimize=exit_custom_under_profit_67_optimize, load=True)
    exit_custom_under_rsi_7 = DecimalParameter(46.0, 60.0, default=54.0, space='exit', decimals=1, optimize=exit_custom_under_profit_67_optimize, load=True)
    exit_custom_under_profit_8 = DecimalParameter(0.06, 0.12, default=0.09, space='exit', decimals=3, optimize=exit_custom_under_profit_89_optimize, load=True)
    exit_custom_under_rsi_8 = DecimalParameter(40.0, 58.0, default=55.0, space='exit', decimals=1, optimize=exit_custom_under_profit_89_optimize, load=True)
    exit_custom_under_profit_9 = DecimalParameter(0.08, 0.14, default=0.1, space='exit', decimals=3, optimize=exit_custom_under_profit_89_optimize, load=True)
    exit_custom_under_rsi_9 = DecimalParameter(40.0, 60.0, default=54.0, space='exit', decimals=1, optimize=exit_custom_under_profit_89_optimize, load=True)
    exit_custom_under_profit_10 = DecimalParameter(0.1, 0.16, default=0.12, space='exit', decimals=3, optimize=exit_custom_under_profit_1011_optimize, load=True)
    exit_custom_under_rsi_10 = DecimalParameter(30.0, 50.0, default=42.0, space='exit', decimals=1, optimize=exit_custom_under_profit_1011_optimize, load=True)
    exit_custom_under_profit_11 = DecimalParameter(0.16, 0.3, default=0.2, space='exit', decimals=3, optimize=exit_custom_under_profit_1011_optimize, load=True)
    exit_custom_under_rsi_11 = DecimalParameter(24.0, 40.0, default=34.0, space='exit', decimals=1, optimize=exit_custom_under_profit_1011_optimize, load=True)
    # Profit targets for pumped pairs 48h 1
    exit_custom_pump_profit_123_optimize = False
    exit_custom_pump_profit_45_optimize = False
    exit_custom_pump_profit_1_1 = DecimalParameter(0.01, 0.03, default=0.01, space='exit', decimals=3, optimize=exit_custom_pump_profit_123_optimize, load=True)
    exit_custom_pump_rsi_1_1 = DecimalParameter(26.0, 40.0, default=34.0, space='exit', decimals=1, optimize=exit_custom_pump_profit_123_optimize, load=True)
    exit_custom_pump_profit_1_2 = DecimalParameter(0.01, 0.6, default=0.02, space='exit', decimals=3, optimize=exit_custom_pump_profit_123_optimize, load=True)
    exit_custom_pump_rsi_1_2 = DecimalParameter(36.0, 50.0, default=40.0, space='exit', decimals=1, optimize=exit_custom_pump_profit_123_optimize, load=True)
    exit_custom_pump_profit_1_3 = DecimalParameter(0.02, 0.1, default=0.04, space='exit', decimals=3, optimize=exit_custom_pump_profit_123_optimize, load=True)
    exit_custom_pump_rsi_1_3 = DecimalParameter(38.0, 50.0, default=42.0, space='exit', decimals=1, optimize=exit_custom_pump_profit_123_optimize, load=True)
    exit_custom_pump_profit_1_4 = DecimalParameter(0.06, 0.12, default=0.1, space='exit', decimals=3, optimize=exit_custom_pump_profit_45_optimize, load=True)
    exit_custom_pump_rsi_1_4 = DecimalParameter(36.0, 48.0, default=42.0, space='exit', decimals=1, optimize=exit_custom_pump_profit_45_optimize, load=True)
    exit_custom_pump_profit_1_5 = DecimalParameter(0.14, 0.24, default=0.2, space='exit', decimals=3, optimize=exit_custom_pump_profit_45_optimize, load=True)
    exit_custom_pump_rsi_1_5 = DecimalParameter(20.0, 40.0, default=34.0, space='exit', decimals=1, optimize=exit_custom_pump_profit_45_optimize, load=True)
    ...
    exit_custom_stoploss_under_rsi_diff_1 = DecimalParameter(0.0, 20.0, default=9.0, space='exit', optimize=False, load=True)
    ...
    def custom_exit(self, pair: str, trade: 'Trade', current_time: 'datetime', current_rate: float, current_profit: float, **kwargs):
        ...
        if last_candle is not None:
            ...
            elif (current_profit < -0.0) & (last_candle['close'] < last_candle['ema_200']) & ((last_candle['ema_200'] - last_candle['close']) / last_candle['close'] < self.exit_custom_stoploss_under_rel_1.value) & (last_candle['rsi'] > last_candle['rsi_1h'] + self.exit_custom_stoploss_under_rsi_diff_1.value) & last_candle['sma_200_dec_24']:
