...
class Guacamole(IStrategy):
    ...
    entry_params = {'macd': -0.75454, 'macdhist': -1, 'rmi': 49}
    # Sell hyperspace params:
    exit_params = {}
    # ROI table:
    minimal_roi = {'0': 0.13336, '19': 0.07455, '37': 0.04206, '57': 0.02682, '73': 0.01225, '125': 0.0037, '244': 0.0025}
    stoploss = -0.99
    # Trailing stop:
    trailing_stop = True
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        if active_trade:
            ...
            conditions.append((dataframe['rmi'] < 30) & (current_profit > -0.03) & dataframe['volume'].gt(0))
        if conditions:
