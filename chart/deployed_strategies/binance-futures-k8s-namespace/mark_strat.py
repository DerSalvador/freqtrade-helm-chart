...
class mark_strat(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        dataframe.loc[(dataframe['close'] < dataframe['bb_lowerband']) & (dataframe['volume'] > 0), 'entry'] = 1
        return dataframe
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        :return: DataFrame with entry column
        """
        dataframe.loc[(dataframe['rsi'] > 90) & (dataframe['close'] > dataframe['bb_middleband']) & (dataframe['volume'] > 0), 'exit'] = 1
        return dataframe