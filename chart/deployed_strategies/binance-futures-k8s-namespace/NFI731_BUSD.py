...
class NFI731_BUSD(IStrategy):
    ...
    entry_condition_32_enable = entry_protection_params[32]['enable']
    entry_32_protection__ema_fast = entry_protection_params[32]['ema_fast']
    entry_32_protection__ema_fast_len = entry_protection_params[32]['ema_fast_len']
    entry_32_protection__ema_slow = entry_protection_params[32]['ema_slow']
    entry_32_protection__ema_slow_len = entry_protection_params[32]['ema_slow_len']
    entry_32_protection__close_above_ema_fast = entry_protection_params[32]['close_above_ema_fast']
    entry_32_protection__close_above_ema_fast_len = entry_protection_params[32]['close_above_ema_fast_len']
    entry_32_protection__close_above_ema_slow = entry_protection_params[32]['close_above_ema_slow']
    entry_32_protection__close_above_ema_slow_len = entry_protection_params[32]['close_above_ema_slow_len']
    entry_32_protection__sma200_rising = entry_protection_params[32]['sma200_rising']
    entry_32_protection__sma200_rising_val = entry_protection_params[32]['sma200_rising_val']
    entry_32_protection__sma200_1h_rising = entry_protection_params[32]['sma200_1h_rising']
    entry_32_protection__sma200_1h_rising_val = entry_protection_params[32]['sma200_1h_rising_val']
    entry_32_protection__safe_dips = entry_protection_params[32]['safe_dips']
    entry_32_protection__safe_dips_type = entry_protection_params[32]['safe_dips_type']
    entry_32_protection__safe_pump = entry_protection_params[32]['safe_pump']
    entry_32_protection__safe_pump_type = entry_protection_params[32]['safe_pump_type']
    entry_32_protection__safe_pump_period = entry_protection_params[32]['safe_pump_period']
    entry_32_protection__btc_1h_not_downtrend = entry_protection_params[32]['btc_1h_not_downtrend']
    entry_condition_33_enable = entry_protection_params[33]['enable']
    entry_33_protection__ema_fast = entry_protection_params[33]['ema_fast']
    entry_33_protection__ema_fast_len = entry_protection_params[33]['ema_fast_len']
    entry_33_protection__ema_slow = entry_protection_params[33]['ema_slow']
    entry_33_protection__ema_slow_len = entry_protection_params[33]['ema_slow_len']
    entry_33_protection__close_above_ema_fast = entry_protection_params[33]['close_above_ema_fast']
    entry_33_protection__close_above_ema_fast_len = entry_protection_params[33]['close_above_ema_fast_len']
    entry_33_protection__close_above_ema_slow = entry_protection_params[33]['close_above_ema_slow']
    entry_33_protection__close_above_ema_slow_len = entry_protection_params[33]['close_above_ema_slow_len']
    entry_33_protection__sma200_rising = entry_protection_params[33]['sma200_rising']
    entry_33_protection__sma200_rising_val = entry_protection_params[33]['sma200_rising_val']
    entry_33_protection__sma200_1h_rising = entry_protection_params[33]['sma200_1h_rising']
    entry_33_protection__sma200_1h_rising_val = entry_protection_params[33]['sma200_1h_rising_val']
    entry_33_protection__safe_dips = entry_protection_params[33]['safe_dips']
    entry_33_protection__safe_dips_type = entry_protection_params[33]['safe_dips_type']
    entry_33_protection__safe_pump = entry_protection_params[33]['safe_pump']
    entry_33_protection__safe_pump_type = entry_protection_params[33]['safe_pump_type']
    entry_33_protection__safe_pump_period = entry_protection_params[33]['safe_pump_period']
    entry_33_protection__btc_1h_not_downtrend = entry_protection_params[33]['btc_1h_not_downtrend']
    entry_condition_34_enable = entry_protection_params[34]['enable']
    entry_34_protection__ema_fast = entry_protection_params[34]['ema_fast']
    entry_34_protection__ema_fast_len = entry_protection_params[34]['ema_fast_len']
    entry_34_protection__ema_slow = entry_protection_params[34]['ema_slow']
    entry_34_protection__ema_slow_len = entry_protection_params[34]['ema_slow_len']
    entry_34_protection__close_above_ema_fast = entry_protection_params[34]['close_above_ema_fast']
    entry_34_protection__close_above_ema_fast_len = entry_protection_params[34]['close_above_ema_fast_len']
    entry_34_protection__close_above_ema_slow = entry_protection_params[34]['close_above_ema_slow']
    entry_34_protection__close_above_ema_slow_len = entry_protection_params[34]['close_above_ema_slow_len']
    entry_34_protection__sma200_rising = entry_protection_params[34]['sma200_rising']
    entry_34_protection__sma200_rising_val = entry_protection_params[34]['sma200_rising_val']
    entry_34_protection__sma200_1h_rising = entry_protection_params[34]['sma200_1h_rising']
    entry_34_protection__sma200_1h_rising_val = entry_protection_params[34]['sma200_1h_rising_val']
    entry_34_protection__safe_dips = entry_protection_params[34]['safe_dips']
    entry_34_protection__safe_dips_type = entry_protection_params[34]['safe_dips_type']
    entry_34_protection__safe_pump = entry_protection_params[34]['safe_pump']
    entry_34_protection__safe_pump_type = entry_protection_params[34]['safe_pump_type']
    entry_34_protection__safe_pump_period = entry_protection_params[34]['safe_pump_period']
    entry_34_protection__btc_1h_not_downtrend = entry_protection_params[34]['btc_1h_not_downtrend']
    entry_condition_35_enable = entry_protection_params[35]['enable']
    entry_35_protection__ema_fast = entry_protection_params[35]['ema_fast']
    entry_35_protection__ema_fast_len = entry_protection_params[35]['ema_fast_len']
    entry_35_protection__ema_slow = entry_protection_params[35]['ema_slow']
    entry_35_protection__ema_slow_len = entry_protection_params[35]['ema_slow_len']
    entry_35_protection__close_above_ema_fast = entry_protection_params[35]['close_above_ema_fast']
    entry_35_protection__close_above_ema_fast_len = entry_protection_params[35]['close_above_ema_fast_len']
    entry_35_protection__close_above_ema_slow = entry_protection_params[35]['close_above_ema_slow']
    entry_35_protection__close_above_ema_slow_len = entry_protection_params[35]['close_above_ema_slow_len']
    entry_35_protection__sma200_rising = entry_protection_params[35]['sma200_rising']
    entry_35_protection__sma200_rising_val = entry_protection_params[35]['sma200_rising_val']
    entry_35_protection__sma200_1h_rising = entry_protection_params[35]['sma200_1h_rising']
    entry_35_protection__sma200_1h_rising_val = entry_protection_params[35]['sma200_1h_rising_val']
    entry_35_protection__safe_dips = entry_protection_params[35]['safe_dips']
    entry_35_protection__safe_dips_type = entry_protection_params[35]['safe_dips_type']
    entry_35_protection__safe_pump = entry_protection_params[35]['safe_pump']
    entry_35_protection__safe_pump_type = entry_protection_params[35]['safe_pump_type']
    entry_35_protection__safe_pump_period = entry_protection_params[35]['safe_pump_period']
    entry_35_protection__btc_1h_not_downtrend = entry_protection_params[35]['btc_1h_not_downtrend']
    entry_condition_36_enable = entry_protection_params[36]['enable']
    entry_36_protection__ema_fast = entry_protection_params[36]['ema_fast']
    entry_36_protection__ema_fast_len = entry_protection_params[36]['ema_fast_len']
    entry_36_protection__ema_slow = entry_protection_params[36]['ema_slow']
    entry_36_protection__ema_slow_len = entry_protection_params[36]['ema_slow_len']
    entry_36_protection__close_above_ema_fast = entry_protection_params[36]['close_above_ema_fast']
    entry_36_protection__close_above_ema_fast_len = entry_protection_params[36]['close_above_ema_fast_len']
    entry_36_protection__close_above_ema_slow = entry_protection_params[36]['close_above_ema_slow']
    entry_36_protection__close_above_ema_slow_len = entry_protection_params[36]['close_above_ema_slow_len']
    entry_36_protection__sma200_rising = entry_protection_params[36]['sma200_rising']
    entry_36_protection__sma200_rising_val = entry_protection_params[36]['sma200_rising_val']
    entry_36_protection__sma200_1h_rising = entry_protection_params[36]['sma200_1h_rising']
    entry_36_protection__sma200_1h_rising_val = entry_protection_params[36]['sma200_1h_rising_val']
    entry_36_protection__safe_dips = entry_protection_params[36]['safe_dips']
    entry_36_protection__safe_dips_type = entry_protection_params[36]['safe_dips_type']
    entry_36_protection__safe_pump = entry_protection_params[36]['safe_pump']
    entry_36_protection__safe_pump_type = entry_protection_params[36]['safe_pump_type']
    entry_36_protection__safe_pump_period = entry_protection_params[36]['safe_pump_period']
    entry_36_protection__btc_1h_not_downtrend = entry_protection_params[36]['btc_1h_not_downtrend']
    entry_condition_37_enable = entry_protection_params[37]['enable']
    entry_37_protection__ema_fast = entry_protection_params[37]['ema_fast']
    entry_37_protection__ema_fast_len = entry_protection_params[37]['ema_fast_len']
    entry_37_protection__ema_slow = entry_protection_params[37]['ema_slow']
    entry_37_protection__ema_slow_len = entry_protection_params[37]['ema_slow_len']
    entry_37_protection__close_above_ema_fast = entry_protection_params[37]['close_above_ema_fast']
    entry_37_protection__close_above_ema_fast_len = entry_protection_params[37]['close_above_ema_fast_len']
    entry_37_protection__close_above_ema_slow = entry_protection_params[37]['close_above_ema_slow']
    entry_37_protection__close_above_ema_slow_len = entry_protection_params[37]['close_above_ema_slow_len']
    entry_37_protection__sma200_rising = entry_protection_params[37]['sma200_rising']
    entry_37_protection__sma200_rising_val = entry_protection_params[37]['sma200_rising_val']
    entry_37_protection__sma200_1h_rising = entry_protection_params[37]['sma200_1h_rising']
    entry_37_protection__sma200_1h_rising_val = entry_protection_params[37]['sma200_1h_rising_val']
    entry_37_protection__safe_dips = entry_protection_params[37]['safe_dips']
    entry_37_protection__safe_dips_type = entry_protection_params[37]['safe_dips_type']
    entry_37_protection__safe_pump = entry_protection_params[37]['safe_pump']
    entry_37_protection__safe_pump_type = entry_protection_params[37]['safe_pump_type']
    entry_37_protection__safe_pump_period = entry_protection_params[37]['safe_pump_period']
    entry_37_protection__btc_1h_not_downtrend = entry_protection_params[37]['btc_1h_not_downtrend']
    entry_condition_38_enable = entry_protection_params[38]['enable']
    entry_38_protection__ema_fast = entry_protection_params[38]['ema_fast']
    entry_38_protection__ema_fast_len = entry_protection_params[38]['ema_fast_len']
    entry_38_protection__ema_slow = entry_protection_params[38]['ema_slow']
    entry_38_protection__ema_slow_len = entry_protection_params[38]['ema_slow_len']
    entry_38_protection__close_above_ema_fast = entry_protection_params[38]['close_above_ema_fast']
    entry_38_protection__close_above_ema_fast_len = entry_protection_params[38]['close_above_ema_fast_len']
    entry_38_protection__close_above_ema_slow = entry_protection_params[38]['close_above_ema_slow']
    entry_38_protection__close_above_ema_slow_len = entry_protection_params[38]['close_above_ema_slow_len']
    entry_38_protection__sma200_rising = entry_protection_params[38]['sma200_rising']
    entry_38_protection__sma200_rising_val = entry_protection_params[38]['sma200_rising_val']
    entry_38_protection__sma200_1h_rising = entry_protection_params[38]['sma200_1h_rising']
    entry_38_protection__sma200_1h_rising_val = entry_protection_params[38]['sma200_1h_rising_val']
    entry_38_protection__safe_dips = entry_protection_params[38]['safe_dips']
    entry_38_protection__safe_dips_type = entry_protection_params[38]['safe_dips_type']
    entry_38_protection__safe_pump = entry_protection_params[38]['safe_pump']
    entry_38_protection__safe_pump_type = entry_protection_params[38]['safe_pump_type']
    entry_38_protection__safe_pump_period = entry_protection_params[38]['safe_pump_period']
    entry_38_protection__btc_1h_not_downtrend = entry_protection_params[38]['btc_1h_not_downtrend']
    ...
    entry_min_inc_1 = DecimalParameter(0.01, 0.05, default=0.021, space='entry', decimals=3, optimize=False, load=True)
    ...
    entry_rsi_1 = DecimalParameter(20.0, 40.0, default=35.4, space='entry', decimals=1, optimize=False, load=True)
    entry_mfi_1 = DecimalParameter(20.0, 40.0, default=50.0, space='entry', decimals=1, optimize=False, load=True)
    entry_cti_1 = DecimalParameter(-0.99, -0.5, default=-0.87, space='entry', decimals=2, optimize=False, load=True)
    ...
    entry_bb40_closedelta_close_3 = DecimalParameter(0.01, 0.03, default=0.022, space='entry', optimize=False, load=True)
    ...
    entry_cti_3 = DecimalParameter(-0.99, -0.5, default=-0.9, space='entry', decimals=2, optimize=False, load=True)
    ...
    entry_cti_4 = DecimalParameter(-0.99, -0.5, default=-0.68, space='entry', decimals=2, optimize=False, load=True)
    ...
    entry_ema_rel_5 = DecimalParameter(0.97, 0.999, default=0.938, space='entry', decimals=3, optimize=False, load=True)
    ...
    entry_ema_open_mult_7 = DecimalParameter(0.02, 0.04, default=0.031, space='entry', decimals=3, optimize=False, load=True)
    ...
    entry_min_inc_11 = DecimalParameter(0.005, 0.05, default=0.02, space='entry', decimals=3, optimize=False, load=True)
    ...
    entry_rsi_11 = DecimalParameter(34.0, 50.0, default=44.0, space='entry', decimals=1, optimize=False, load=True)
    entry_mfi_11 = DecimalParameter(30.0, 46.0, default=36.0, space='entry', decimals=1, optimize=False, load=True)
    entry_ma_offset_12 = DecimalParameter(0.93, 0.97, default=0.907, space='entry', decimals=3, optimize=False, load=True)
    entry_rsi_12 = DecimalParameter(26.0, 40.0, default=34.0, space='entry', decimals=1, optimize=False, load=True)
    ...
    entry_cti_13 = DecimalParameter(-0.99, -0.5, default=-0.74, space='entry', decimals=2, optimize=False, load=True)
    entry_ewo_13 = DecimalParameter(-14.0, -7.0, default=-9.6, space='entry', decimals=1, optimize=False, load=True)
    ...
    entry_ma_offset_15 = DecimalParameter(0.93, 0.99, default=0.96, space='entry', decimals=3, optimize=False, load=True)
    entry_rsi_15 = DecimalParameter(20.0, 36.0, default=28.0, space='entry', decimals=1, optimize=False, load=True)
    entry_ema_rel_15 = DecimalParameter(0.97, 0.999, default=0.977, space='entry', decimals=3, optimize=False, load=True)
    ...
    entry_ma_offset_17 = DecimalParameter(0.93, 0.98, default=0.94, space='entry', decimals=3, optimize=False, load=True)
    entry_ewo_17 = DecimalParameter(-18.0, -10.0, default=-12.4, space='entry', decimals=1, optimize=False, load=True)
    entry_cti_17 = DecimalParameter(-0.99, -0.5, default=-0.92, space='entry', decimals=2, optimize=False, load=True)
    entry_volume_17 = DecimalParameter(0.6, 6.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)
    entry_rsi_18 = DecimalParameter(16.0, 32.0, default=30.0, space='entry', decimals=1, optimize=False, load=True)
    entry_bb_offset_18 = DecimalParameter(0.98, 1.0, default=0.985, space='entry', decimals=3, optimize=False, load=True)
    entry_volume_18 = DecimalParameter(0.6, 6.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)
    entry_cti_18 = DecimalParameter(-0.99, -0.5, default=-0.82, space='entry', decimals=2, optimize=False, load=True)
    entry_rsi_1h_min_19 = DecimalParameter(40.0, 70.0, default=30.0, space='entry', decimals=1, optimize=False, load=True)
    entry_chop_min_19 = DecimalParameter(20.0, 60.0, default=23.0, space='entry', decimals=1, optimize=False, load=True)
    ...
    entry_cti_20 = DecimalParameter(-0.99, -0.5, default=-0.9, space='entry', decimals=2, optimize=False, load=True)
    ...
    entry_ma_offset_22 = DecimalParameter(0.93, 0.98, default=0.946, space='entry', decimals=3, optimize=False, load=True)
    entry_ewo_22 = DecimalParameter(2.0, 10.0, default=6.2, space='entry', decimals=1, optimize=False, load=True)
    ...
    entry_26_cti = DecimalParameter(-0.99, -0.4, default=-0.8, space='entry', decimals=2, optimize=False, load=True)
    entry_26_volume = DecimalParameter(0.6, 6.0, default=1.2, space='entry', decimals=1, optimize=False, load=True)
    entry_27_wr_max = DecimalParameter(95, 99, default=99.0, space='entry', decimals=1, optimize=False, load=True)
    ...
    entry_27_cti = DecimalParameter(-0.99, -0.4, default=-0.9, space='entry', decimals=2, optimize=False, load=True)
    entry_27_volume = DecimalParameter(0.6, 6.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)
    entry_28_ma_offset = DecimalParameter(0.9, 0.99, default=0.92, space='entry', optimize=False, load=True)
    entry_28_ewo = DecimalParameter(2.0, 14.0, default=12.4, space='entry', decimals=1, optimize=False, load=True)
    entry_28_rsi = DecimalParameter(24.0, 44.0, default=38.0, space='entry', decimals=1, optimize=False, load=True)
    entry_28_cti = DecimalParameter(-0.99, -0.4, default=-0.6, space='entry', decimals=2, optimize=False, load=True)
    entry_29_ma_offset = DecimalParameter(0.9, 0.99, default=0.91, space='entry', optimize=False, load=True)
    entry_29_ewo = DecimalParameter(-14.0, -2.0, default=-4.0, space='entry', decimals=1, optimize=False, load=True)
    entry_29_cti = DecimalParameter(-0.99, -0.4, default=-0.82, space='entry', decimals=2, optimize=False, load=True)
    entry_30_ma_offset = DecimalParameter(0.9, 0.99, default=0.97, space='entry', optimize=False, load=True)
    entry_30_ewo = DecimalParameter(2.0, 14.0, default=7.8, space='entry', decimals=1, optimize=False, load=True)
    entry_30_rsi = DecimalParameter(24.0, 48.0, default=42.0, space='entry', decimals=1, optimize=False, load=True)
    entry_30_cti = DecimalParameter(-0.99, -0.4, default=-0.8, space='entry', decimals=2, optimize=False, load=True)
    ...
    entry_32_ma_offset = DecimalParameter(0.9, 0.99, default=0.946, space='entry', optimize=False, load=True)
    ...
    entry_33_ma_offset = DecimalParameter(0.9, 0.99, default=0.974, space='entry', optimize=False, load=True)
    ...
    entry_33_ewo = DecimalParameter(2.0, 14.0, default=9.0, space='entry', decimals=1, optimize=False, load=True)
    entry_33_volume = DecimalParameter(0.6, 6.0, default=2.0, space='entry', decimals=1, optimize=False, load=True)
    entry_34_ma_offset = DecimalParameter(0.9, 0.99, default=0.968, space='entry', optimize=False, load=True)
    entry_34_dip = DecimalParameter(0.001, 0.02, default=0.002, space='entry', decimals=3, optimize=False, load=True)
    entry_34_ewo = DecimalParameter(-24.0, -8.0, default=-20.0, space='entry', decimals=1, optimize=False, load=True)
    entry_34_cti = DecimalParameter(-0.99, -0.4, default=-0.88, space='entry', decimals=2, optimize=False, load=True)
    entry_34_volume = DecimalParameter(0.6, 6.0, default=1.1, space='entry', decimals=1, optimize=False, load=True)
    # Sell
    ...
    def exit_trail_main(self, current_profit: float, last_candle, max_profit: float) -> tuple:
        if (self.exit_trail_profit_max_1.value > current_profit > self.exit_trail_profit_min_1.value) & (self.exit_trail_rsi_min_1.value < last_candle['rsi'] < self.exit_trail_rsi_max_1.value) & (max_profit > current_profit + self.exit_trail_down_1.value) & (last_candle['moderi_96'] == False):
    ...
    def exit_under_min(self, current_profit: float, last_candle) -> tuple:
        if last_candle['moderi_96'] == False:
            # Downtrend
            if (self.exit_custom_profit_under_profit_max_1.value > current_profit > self.exit_custom_profit_under_profit_min_1.value) & (last_candle['close'] < last_candle['ema_200']) & ((last_candle['ema_200'] - last_candle['close']) / last_candle['close'] < self.exit_custom_profit_under_rel_1.value) & (last_candle['rsi'] > last_candle['rsi_1h'] + self.exit_custom_profit_under_rsi_diff_1.value):
                return (True, 'signal_profit_u_e_1')
        # Uptrend
        elif (current_profit > self.exit_custom_profit_under_profit_2.value) & (last_candle['close'] < last_candle['ema_200']) & ((last_candle['ema_200'] - last_candle['close']) / last_candle['close'] < self.exit_custom_profit_under_rel_2.value) & (last_candle['rsi'] > last_candle['rsi_1h'] + self.exit_custom_profit_under_rsi_diff_2.value):
    ...
    def exit_quick_mode(self, current_profit: float, max_profit: float, last_candle, previous_candle_1, entry_signal_candle) -> tuple:
        if entry_signal_candle['entry_condition_32'] or entry_signal_candle['entry_condition_33'] or entry_signal_candle['entry_condition_34'] or entry_signal_candle['entry_condition_35'] or entry_signal_candle['entry_condition_36'] or entry_signal_candle['entry_condition_37'] or entry_signal_candle['entry_condition_38']:
    ...
    def custom_exit(self, pair: str, trade: 'Trade', current_time: 'datetime', current_rate: float, current_profit: float, **kwargs):
        ...
        if not entry_signal.empty:
            entry_signal_candle = entry_signal.iloc[-1].squeeze()
        max_profit = (trade.max_rate - trade.open_rate) / trade.open_rate
        max_loss = (trade.open_rate - trade.min_rate) / trade.min_rate
        # Quick exit mode
        if not entry_signal.empty:
            exit, signal_name = self.exit_quick_mode(current_profit, max_profit, last_candle, previous_candle_1, entry_signal_candle)
            if exit and signal_name is not None:
                return signal_name
        # Over EMA200, main profit targets
        exit, signal_name = self.exit_over_main(current_profit, last_candle)
        if exit and signal_name is not None:
            return signal_name
        # Under EMA200, main profit targets
        exit, signal_name = self.exit_under_main(current_profit, last_candle)
        if exit and signal_name is not None:
            return signal_name
        # The pair is pumped
        exit, signal_name = self.exit_pump_main(current_profit, last_candle)
        if exit and signal_name is not None:
            return signal_name
        # The pair is descending
        exit, signal_name = self.exit_dec_main(current_profit, last_candle)
        if exit and signal_name is not None:
            return signal_name
        # Trailing
        exit, signal_name = self.exit_trail_main(current_profit, last_candle, max_profit)
        if exit and signal_name is not None:
            return signal_name
        # Duration based
        exit, signal_name = self.exit_duration_main(current_profit, last_candle, trade, current_time)
        if exit and signal_name is not None:
            return signal_name
        # Under EMA200, exit with any profit
        exit, signal_name = self.exit_under_min(current_profit, last_candle)
        if exit and signal_name is not None:
            return signal_name
        # Stoplosses
        exit, signal_name = self.exit_stoploss(current_profit, last_candle, trade, current_time, max_loss, max_profit)
        if exit and signal_name is not None:
            return signal_name
        # Pumped descending pairs
        exit, signal_name = self.exit_pump_dec(current_profit, last_candle)
        if exit and signal_name is not None:
            return signal_name
        # Extra exits for pumped pairs
        exit, signal_name = self.exit_pump_extra(current_profit, last_candle, max_profit)
        if exit and signal_name is not None:
            return signal_name
        # Extra exits for trades that recovered
        exit, signal_name = self.exit_recover(current_profit, last_candle, max_loss)
        if exit and signal_name is not None:
            return signal_name
        # Williams %R based exit 1
        exit, signal_name = self.exit_r_1(current_profit, last_candle)
        if exit and signal_name is not None:
            return signal_name
        # Williams %R based exit 2
        exit, signal_name = self.exit_r_2(current_profit, last_candle)
        if exit and signal_name is not None:
            return signal_name
        # Williams %R based exit 3
        exit, signal_name = self.exit_r_3(current_profit, last_candle)
        if exit and signal_name is not None:
            return signal_name
        # Williams %R based exit 4, plus CTI
        exit, signal_name = self.exit_r_4(current_profit, last_candle)
        if exit and signal_name is not None:
            return signal_name
        # Sell signal 1
        if self.exit_condition_1_enable.value & (last_candle['rsi'] > self.exit_rsi_bb_1.value) & (last_candle['close'] > last_candle['bb20_2_upp']) & (previous_candle_1['close'] > previous_candle_1['bb20_2_upp']) & (previous_candle_2['close'] > previous_candle_2['bb20_2_upp']) & (previous_candle_3['close'] > previous_candle_3['bb20_2_upp']) & (previous_candle_4['close'] > previous_candle_4['bb20_2_upp']) & (previous_candle_5['close'] > previous_candle_5['bb20_2_upp']):
            if last_candle['close'] > last_candle['ema_200']:
                if current_profit > 0.0:
                    return 'exit_signal_1_1_1'
                elif max_loss > 0.1:
                    return 'exit_signal_1_1_2'
            else:
                return 'exit_signal_1_2'
        # Sell signal 2
            ...
            if last_candle['close'] > last_candle['ema_200']:
                if current_profit > 0.0:
                    return 'exit_signal_2_1_1'
                elif max_loss > 0.07:
                    return 'exit_signal_2_1_2'
            elif current_profit > 0.0:
                return 'exit_signal_2_2_1'
            elif max_loss > 0.07:
                return 'exit_signal_2_2_2'
        # Sell signal 4
        ...
        # Sell signal 6
            ...
            if current_profit > 0.0:
                return 'exit_signal_6_1'
            elif max_loss > 0.08:
                return 'exit_signal_6_2'
        # Sell signal 7
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Buy Condition #1
        dataframe.loc[:, 'entry_condition_1'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_1_enable']:
            ...
            dataframe.loc[item_entry, 'entry_condition_1'] = True
        # Buy Condition #2
        dataframe.loc[:, 'entry_condition_2'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_2_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_2'] = True
        # Buy Condition #3
        dataframe.loc[:, 'entry_condition_3'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_3_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_3'] = True
        # Buy Condition #4
        dataframe.loc[:, 'entry_condition_4'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_4_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_4'] = True
        # Buy Condition #5
        dataframe.loc[:, 'entry_condition_5'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_5_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_5'] = True
        # Buy Condition #6
        dataframe.loc[:, 'entry_condition_6'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_6_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_6'] = True
        # Buy Condition #7
        dataframe.loc[:, 'entry_condition_7'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_7_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_7'] = True
        # Buy Condition #8
        dataframe.loc[:, 'entry_condition_8'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_8_enable']:
            ...
            item_entry_logic.append(dataframe['rsi_1h'] < self.entry_rsi_1h_8.value)
            item_entry_logic.append(dataframe['volume'] < dataframe['volume_mean_4'] * self.entry_volume_8.value)
            item_entry_logic.append(dataframe['volume'] > 0)
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_8'] = True
        # Buy Condition #9
        dataframe.loc[:, 'entry_condition_9'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_9_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_9'] = True
        # Buy Condition #10
        dataframe.loc[:, 'entry_condition_10'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_10_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_10'] = True
        # Buy Condition #11
        dataframe.loc[:, 'entry_condition_11'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_11_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_11'] = True
        # Buy Condition #12
        dataframe.loc[:, 'entry_condition_12'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_12_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_12'] = True
        # Buy Condition #13
        dataframe.loc[:, 'entry_condition_13'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_13_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_13'] = True
        # Buy Condition #14
        dataframe.loc[:, 'entry_condition_14'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_14_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_14'] = True
        # Buy Condition #15
        dataframe.loc[:, 'entry_condition_15'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_15_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_15'] = True
        # Buy Condition #16
        dataframe.loc[:, 'entry_condition_16'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_16_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_16'] = True
        # Buy Condition #17
        dataframe.loc[:, 'entry_condition_17'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_17_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_17'] = True
        # Buy Condition #18
        dataframe.loc[:, 'entry_condition_18'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_18_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_18'] = True
        # Buy Condition #19
        dataframe.loc[:, 'entry_condition_19'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_19_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_19'] = True
        # Buy Condition #20
        dataframe.loc[:, 'entry_condition_20'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_20_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_20'] = True
        # Buy Condition #21
        dataframe.loc[:, 'entry_condition_21'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_21_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_21'] = True
        # Buy Condition #22
        dataframe.loc[:, 'entry_condition_22'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_22_enable']:
            ...
            item_entry_logic.append(dataframe['safe_dump_20_1h'])
            item_entry_logic.append(dataframe['volume'] > 0)
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_22'] = True
        # Buy Condition #23
        dataframe.loc[:, 'entry_condition_23'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_23_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_23'] = True
        # Buy Condition #24
        dataframe.loc[:, 'entry_condition_24'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_24_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_24'] = True
        # Buy Condition #25
        dataframe.loc[:, 'entry_condition_25'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_25_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_25'] = True
        # Buy Condition #26
        dataframe.loc[:, 'entry_condition_26'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_26_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_26'] = True
        # Buy Condition #27
        dataframe.loc[:, 'entry_condition_27'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_27_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_27'] = True
        # Buy Condition #28
        dataframe.loc[:, 'entry_condition_28'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_28_enable']:
            ...
            item_entry_logic.append(dataframe['rsi'] < self.entry_28_rsi.value)
            item_entry_logic.append(dataframe['cti'] < self.entry_28_cti.value)
            item_entry_logic.append(dataframe['volume'] > 0)
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_28'] = True
        # Buy Condition #29
        dataframe.loc[:, 'entry_condition_29'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_29_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_29'] = True
        # Buy Condition #30
        dataframe.loc[:, 'entry_condition_30'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_30_enable']:
            ...
            item_entry_logic.append(dataframe['rsi'] < self.entry_30_rsi.value)
            item_entry_logic.append(dataframe['cti'] < self.entry_30_cti.value)
            item_entry_logic.append(dataframe['volume'] > 0)
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_30'] = True
        # Buy Condition #31
        dataframe.loc[:, 'entry_condition_31'] = False
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_31_enable']:
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_31'] = True
        # Buy Condition #32
        dataframe.loc[:, 'entry_condition_32'] = False
        # Quick mode entry
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_32_enable']:
            # Non-Standard protections (add below)
            item_entry_logic = []
            item_entry_logic.append(reduce(lambda x, y: x & y, entry_protection_list[31]))
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_32'] = True
        # Buy Condition #33
        dataframe.loc[:, 'entry_condition_33'] = False
        # Quick mode entry
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_33_enable']:
            # Non-Standard protections (add below)
            item_entry_logic = []
            item_entry_logic.append(reduce(lambda x, y: x & y, entry_protection_list[32]))
            item_entry_logic.append(dataframe['moderi_96'])
            ...
            item_entry_logic.append(dataframe['rsi'] < self.entry_33_rsi.value)
            item_entry_logic.append(dataframe['volume'] < dataframe['volume_mean_4'] * self.entry_33_volume.value)
            item_entry_logic.append(dataframe['volume'] > 0)
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_33'] = True
        # Buy Condition #34
        dataframe.loc[:, 'entry_condition_34'] = False
        # Quick mode entry
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_34_enable']:
            # Non-Standard protections (add below)
            item_entry_logic = []
            item_entry_logic.append(reduce(lambda x, y: x & y, entry_protection_list[33]))
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_34'] = True
        # Buy Condition #35
        # PMAX0 entry
        # -----------------------------------------------------------------------------------------
        dataframe.loc[:, 'entry_condition_35'] = False
        if self.entry_params['entry_condition_35_enable']:
            # Non-Standard protections (add below)
            item_entry_logic = []
            item_entry_logic.append(reduce(lambda x, y: x & y, entry_protection_list[34]))
            ...
            item_entry_logic.append(dataframe['rsi'] < 32.0)
            item_entry_logic.append(dataframe['cti'] < -0.5)
            item_entry_logic.append(dataframe['volume'] > 0)
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_35'] = True
        # Buy Condition #36
        dataframe.loc[:, 'entry_condition_36'] = False
        # PMAX1 entry
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_36_enable']:
            # Non-Standard protections (add below)
            item_entry_logic = []
            item_entry_logic.append(reduce(lambda x, y: x & y, entry_protection_list[35]))
            item_entry_logic.append(dataframe['pm'] <= dataframe['pmax_thresh'])
            item_entry_logic.append(dataframe['close'] < dataframe['sma_75'] * 0.98)
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_36'] = True
        # Buy Condition #37
        dataframe.loc[:, 'entry_condition_37'] = False
        # PMAX2 entry
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_37_enable']:
            # Non-Standard protections (add below)
            item_entry_logic = []
            item_entry_logic.append(reduce(lambda x, y: x & y, entry_protection_list[36]))
            item_entry_logic.append(dataframe['pm'] > dataframe['pmax_thresh'])
            item_entry_logic.append(dataframe['close'] < dataframe['sma_75'] * 0.93)
            item_entry_logic.append(dataframe['ewo'] > 8.0)
            item_entry_logic.append(dataframe['rsi'] < 56.0)
            item_entry_logic.append(dataframe['cti'] < -0.84)
            item_entry_logic.append(dataframe['safe_dump_50_1h'])
            item_entry_logic.append(dataframe['volume'] > 0)
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_37'] = True
        # Buy Condition #38
        dataframe.loc[:, 'entry_condition_38'] = False
        # PMAX3 entry
        # -----------------------------------------------------------------------------------------
        if self.entry_params['entry_condition_38_enable']:
            # Non-Standard protections (add below)
            item_entry_logic = []
            item_entry_logic.append(reduce(lambda x, y: x & y, entry_protection_list[37]))
            item_entry_logic.append(dataframe['pm'] > dataframe['pmax_thresh'])
            ...
            item_entry = reduce(lambda x, y: x & y, item_entry_logic)
            conditions.append(item_entry)
            dataframe.loc[item_entry, 'entry_condition_38'] = True
        if conditions:
