...
class thetank3(IStrategy):
    ...
    filterlength = IntParameter(low=25, high=35, default=25, space='entry', optimize=True)
    # trading
    ...
    def populate_entry_trend(self, df: DataFrame, metadata: dict) -> DataFrame:  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df[f'zema_{self.filterlength.value}'], df['s3']) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, 'S3 - XO')  # Make sure Volume is not 0
        df.loc[qtpylib.crossed_above(df[f'zema_{self.filterlength.value}'], df['s2']) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, 'S2 - XO')
        # Signal: RSI crosses above 30
        # Guard: Wave 1 is raising
        # Make sure Volume is not 0
        df.loc[(df['close'] > df[f'zema_{self.filterlength.value}']) & (df['close'] < df['r2']) & (df['squeeze_ON'] == 1) & (df['rsi_ma'] > df['rsi_ma'].shift(1)) & (df['200_SMA'] < df['200_SMA'].shift(1)) & (df['rsi'] < self.entry_rsi_bear.value) & (df[f'wave_t1{self.wavelength.value}'] < self.entry_wt_bear.value) & (df[f'wave_t1{self.wavelength.value}'] > df[f'wave_t1{self.wavelength.value}'].shift(1)) & qtpylib.crossed_above(df[f'wave_t1{self.wavelength.value}'], df[f'wave_t2{self.crosslength.value}_{self.wavelength.value}']) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, 'ttm_Squeeze/WT - bear')  # Guard: Wave 1 is raising
        # Make sure Volume is not 0
        df.loc[(df['close'] > df[f'zema_{self.filterlength.value}']) & (df['close'] < df['r2']) & (df['squeeze_ON'] == 1) & (df['rsi_ma'] > df['rsi_ma'].shift(1)) & (df['rsi'] < self.entry_rsi_bear.value) & (df['200_SMA'] < df['200_SMA'].shift(1)) & (df[f'wave_t1{self.wavelength.value}'] < self.entry_wt_bear.value) & (df[f'wave_t1{self.wavelength.value}'] > df[f'wave_t1{self.wavelength.value}'].shift(1)) & (df[f'wave_t1{self.wavelength.value}'].shift(2) > df[f'wave_t1{self.wavelength.value}'].shift(1)) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, 'ttm_Squeeze/WTT - bear')  # Guard: Wave 1 is raising
        # Make sure Volume is not 0
        df.loc[(df['close'] > df[f'zema_{self.filterlength.value}']) & (df['close'] < df['r2']) & (df['rsi_ma'] > df['rsi_ma'].shift(1)) & (df['rsi'] < self.entry_rsi_bear.value) & (df['200_SMA'] < df['200_SMA'].shift(1)) & (df[f'wave_t1{self.wavelength.value}'] < self.entry_wt_bear.value) & (df[f'wave_t1{self.wavelength.value}'] > df[f'wave_t1{self.wavelength.value}'].shift(1)) & (df[f'wave_t1{self.wavelength.value}'].shift(2) > df[f'wave_t1{self.wavelength.value}'].shift(1)) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, 'WT transition - bear')  # Guard: Wave 1 is raising
        # Make sure Volume is not 0
        df.loc[(df['close'] > df[f'zema_{self.filterlength.value}']) & (df['close'] < df['r2']) & (df['200_SMA'] < df['200_SMA'].shift(1)) & (df[f'wave_t1{self.wavelength.value}'] > df[f'wave_t1{self.wavelength.value}'].shift(1)) & (df[f'wave_t1{self.wavelength.value}'] < self.entry_wt_bear.value) & (df[f'wave_t1{self.wavelength.value}'].shift(2) > df[f'wave_t1{self.wavelength.value}'].shift(1)) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, 'WT - bear')  # Guard: Wave 1 is raising
        # Make sure Volume is not 0
        df.loc[(df['close'] > df[f'zema_{self.filterlength.value}']) & (df['close'] < df['r2']) & (df['squeeze_ON'] == 1) & (df['rsi_ma'] > df['rsi_ma'].shift(1)) & (df['rsi'] < self.entry_rsi_bull.value) & (df['200_SMA'] > df['200_SMA'].shift(1)) & (df[f'wave_t1{self.wavelength.value}'] > df[f'wave_t1{self.wavelength.value}'].shift(1)) & qtpylib.crossed_above(df[f'wave_t1{self.wavelength.value}'], df[f'wave_t2{self.crosslength.value}_{self.wavelength.value}']) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, 'ttm_Squeeze/WT - bull')  # Make sure Volume is not 0
        df.loc[(df['close'] > df[f'zema_{self.filterlength.value}']) & (df['close'] < df['r2']) & (df['squeeze_ON'] == 1) & (df['rsi_ma'] > df['rsi_ma'].shift(1)) & (df['rsi'] < self.entry_rsi_bull.value) & (df['200_SMA'] > df['200_SMA'].shift(1)) & (df[f'wave_t1{self.wavelength.value}'] > df[f'wave_t1{self.wavelength.value}'].shift(1)) & (df[f'wave_t1{self.wavelength.value}'] < self.entry_wt_bull.value) & (df[f'wave_t1{self.wavelength.value}'].shift(2) > df[f'wave_t1{self.wavelength.value}'].shift(1)) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, 'ttm_Squeeze/WTT - bull')  # Guard: Wave 1 is raising
        # Make sure Volume is not 0
        df.loc[(df['close'] > df[f'zema_{self.filterlength.value}']) & (df['close'] < df['r2']) & (df['rsi_ma'] > df['rsi_ma'].shift(1)) & (df['rsi'] < self.entry_rsi_bull.value) & (df['200_SMA'] > df['200_SMA'].shift(1)) & (df[f'wave_t1{self.wavelength.value}'] > df[f'wave_t1{self.wavelength.value}'].shift(1)) & (df[f'wave_t1{self.wavelength.value}'] < self.entry_wt_bull.value) & (df[f'wave_t1{self.wavelength.value}'].shift(2) > df[f'wave_t1{self.wavelength.value}'].shift(1)) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, 'WT transition - bull')  # Guard: Wave 1 is raising
        # Make sure Volume is not 0
        df.loc[(df['close'] > df[f'zema_{self.filterlength.value}']) & (df['close'] < df['r2']) & (df['200_SMA'] > df['200_SMA'].shift(1)) & (df[f'wave_t1{self.wavelength.value}'] > df[f'wave_t1{self.wavelength.value}'].shift(1)) & (df[f'wave_t1{self.wavelength.value}'] < self.entry_wt_bull.value) & (df[f'wave_t1{self.wavelength.value}'].shift(2) > df[f'wave_t1{self.wavelength.value}'].shift(1)) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, 'WT - bull')  # Make sure Volume is not 0
        df.loc[(df['close'] > df[f'zema_{self.filterlength.value}']) & (df['close'] < df['r2']) & (df['rsi'] > self.entry_rsi.value) & (df['rsi_ma'] > df['rsi_ma'].shift(1)) & (df['rsi'] < self.entry_rsi_bear.value) & (df['200_SMA'] < df['200_SMA'].shift(1)) & qtpylib.crossed_above(df['rsi'], df['rsi_ma']) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, 'RSI-XO bear')  # Make sure Volume is not 0
        df.loc[(df['close'] > df[f'zema_{self.filterlength.value}']) & (df['close'] < df['r2']) & (df['rsi'] > self.entry_rsi.value) & (df['rsi_ma'] > df['rsi_ma'].shift(1)) & (df['rsi'] < self.entry_rsi_bull.value) & (df['200_SMA'] > df['200_SMA'].shift(1)) & qtpylib.crossed_above(df['rsi'], df['rsi_ma']) & (df['volume'] > 0), ['enter_long', 'enter_tag']] = (1, 'RSI-XO bull')
        return df
    ### EXIT CONDITIONS ###
...
# 2023-02-21 16:43:47,577 - freqtrade.resolvers.strategy_resolver - INFO - Strategy using ignore_entrying_expired_candle_after: 0
...
# 2023-02-21 16:43:53,378 - freqtrade.strategy.hyper - INFO - Strategy Parameter: entry_rsi = 29
# 2023-02-21 16:43:53,378 - freqtrade.strategy.hyper - INFO - Strategy Parameter: entry_rsi_bear = 53
# 2023-02-21 16:43:53,378 - freqtrade.strategy.hyper - INFO - Strategy Parameter: entry_rsi_bull = 67
# 2023-02-21 16:43:53,378 - freqtrade.strategy.hyper - INFO - Strategy Parameter: entry_wt_bear = 23
# 2023-02-21 16:43:53,378 - freqtrade.strategy.hyper - INFO - Strategy Parameter: entry_wt_bull = 65
...
# 2023-02-21 16:43:53,379 - freqtrade.strategy.hyper - INFO - Strategy Parameter: exit_rsi = 54
