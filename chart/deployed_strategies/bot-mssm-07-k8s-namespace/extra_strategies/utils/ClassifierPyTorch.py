kubectl --context=gke_vaulted-gift-406223_europe-west1-b_private-cluster-3 -n bot-mssm-07 exec -it pod/freqtrade-bot-mssm-07-5f8db6bb7-hmcvw -c freqtrade -- cat /extra_strategies/utils/ClassifierPyTorch.py
