...
def transfer_spot_to_funding(asset, amount):
    ...
    params = {
        # for types look at https://binance-docs.github.io/apidocs/spot/en/#trade-fee-user_data
        'type': 'FUNDING_MAIN',  # Change this accordingly if necessary. MAIN_UMFUTURE is for transferring from Funding Wallet to Spot Wallet
        'asset': asset,
        'amount': amount,
